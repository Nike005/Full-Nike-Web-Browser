...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C3446R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C3446R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C3446R.dimen.cardview_compat_inset_shadow);
