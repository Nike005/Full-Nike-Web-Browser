...
final class zzar extends RemoteMediaClient.zzc {
    ...
    public final void zzb(com.google.android.gms.internal.cast.zzcn r6) {
        /*
            ...
            monitor-enter(r6)
            com.google.android.gms.cast.framework.media.RemoteMediaClient r0 = r5.zzns     // Catch:{ zzdk | IllegalArgumentException | IllegalStateException -> 0x0019 }
            com.google.android.gms.internal.cast.zzdh r0 = r0.zzeu     // Catch:{ zzdk | IllegalArgumentException | IllegalStateException -> 0x0019 }
            com.google.android.gms.internal.cast.zzdm r1 = r5.zzgc     // Catch:{ zzdk | IllegalArgumentException | IllegalStateException -> 0x0019 }
            double r2 = r5.zzfw     // Catch:{ zzdk | IllegalArgumentException | IllegalStateException -> 0x0019 }
            org.json.JSONObject r4 = r5.zzfi     // Catch:{ zzdk | IllegalArgumentException | IllegalStateException -> 0x0019 }
            r0.zza((com.google.android.gms.internal.cast.zzdm) r1, (double) r2, (org.json.JSONObject) r4)     // Catch:{ zzdk | IllegalArgumentException | IllegalStateException -> 0x0019 }
            goto L_0x0029
        L_0x0017:
            r0 = move-exception
            goto L_0x002b
