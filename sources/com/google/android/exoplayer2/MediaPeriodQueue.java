...
final class MediaPeriodQueue {
    ...
    public boolean shouldLoadNextMediaPeriod() {
        MediaPeriodHolder mediaPeriodHolder = this.loading;
        return mediaPeriodHolder == null || (!mediaPeriodHolder.f5150info.isFinal && this.loading.isFullyBuffered() && this.loading.f5150info.durationUs != -9223372036854775807L && this.length < 100);
    }
    ...
    public MediaPeriodHolder enqueueNextMediaPeriodHolder(RendererCapabilities[] rendererCapabilitiesArr, TrackSelector trackSelector, Allocator allocator, MediaSource mediaSource, MediaPeriodInfo mediaPeriodInfo, TrackSelectorResult trackSelectorResult) {
        ...
        MediaPeriodHolder mediaPeriodHolder = this.loading;
        if (mediaPeriodHolder == null) {
            j = (!mediaPeriodInfo2.f5057id.isAd() || mediaPeriodInfo2.contentPositionUs == -9223372036854775807L) ? 0 : mediaPeriodInfo2.contentPositionUs;
        } else {
            j = (mediaPeriodHolder.getRendererOffset() + this.loading.f5150info.durationUs) - mediaPeriodInfo2.startPositionUs;
        }
    ...
    public MediaPeriodHolder advancePlayingPeriod() {
        ...
        if (i == 0) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = this.playing.f5150info.f5057id.windowSequenceNumber;
        }
    ...
    public void clear(boolean z) {
        ...
        if (mediaPeriodHolder != null) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = mediaPeriodHolder.f5150info.f5057id.windowSequenceNumber;
    ...
    public boolean updateQueuedPeriods(long j, long j2) {
        ...
        while (mediaPeriodHolder != null) {
            MediaPeriodInfo mediaPeriodInfo2 = mediaPeriodHolder.f5150info;
            ...
            mediaPeriodHolder.f5150info = mediaPeriodInfo.copyWithContentPositionUs(mediaPeriodInfo2.contentPositionUs);
    ...
    public MediaPeriodInfo getUpdatedMediaPeriodInfo(MediaPeriodInfo mediaPeriodInfo) {
        long durationUs;
        MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodInfo.f5057id;
        ...
        this.timeline.getPeriodByUid(mediaPeriodInfo.f5057id.periodUid, this.period);
    ...
    private long resolvePeriodIndexToWindowSequenceNumber(Object obj) {
        ...
        for (MediaPeriodHolder mediaPeriodHolder = this.playing; mediaPeriodHolder != null; mediaPeriodHolder = mediaPeriodHolder.getNext()) {
            if (mediaPeriodHolder.uid.equals(obj)) {
                return mediaPeriodHolder.f5150info.f5057id.windowSequenceNumber;
            }
        }
        for (MediaPeriodHolder mediaPeriodHolder2 = this.playing; mediaPeriodHolder2 != null; mediaPeriodHolder2 = mediaPeriodHolder2.getNext()) {
            ...
            if (indexOfPeriod2 != -1 && this.timeline.getPeriod(indexOfPeriod2, this.period).windowIndex == i) {
                return mediaPeriodHolder2.f5150info.f5057id.windowSequenceNumber;
            }
        }
    ...
    private boolean canKeepMediaPeriodHolder(MediaPeriodInfo mediaPeriodInfo, MediaPeriodInfo mediaPeriodInfo2) {
        return mediaPeriodInfo.startPositionUs == mediaPeriodInfo2.startPositionUs && mediaPeriodInfo.f5057id.equals(mediaPeriodInfo2.f5057id);
    }
    ...
    private boolean updateForPlaybackModeChange() {
        ...
        while (true) {
            ...
            while (mediaPeriodHolder.getNext() != null && !mediaPeriodHolder.f5150info.isLastInTimelinePeriod) {
                mediaPeriodHolder = mediaPeriodHolder.getNext();
            }
            ...
            if (indexOfPeriod == -1 || next == null || this.timeline.getIndexOfPeriod(next.uid) != indexOfPeriod) {
                ...
                mediaPeriodHolder.f5150info = getUpdatedMediaPeriodInfo(mediaPeriodHolder.f5150info);
            } else {
    ...
    private MediaPeriodInfo getFollowingMediaPeriodInfo(MediaPeriodHolder mediaPeriodHolder, long j) {
        ...
        Object obj;
        long j5;
        MediaPeriodInfo mediaPeriodInfo = mediaPeriodHolder.f5150info;
        long rendererOffset = (mediaPeriodHolder.getRendererOffset() + mediaPeriodInfo.durationUs) - j;
        long j6 = 0;
        if (mediaPeriodInfo.isLastInTimelinePeriod) {
            int nextPeriodIndex = this.timeline.getNextPeriodIndex(this.timeline.getIndexOfPeriod(mediaPeriodInfo.f5057id.periodUid), this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
            if (nextPeriodIndex == -1) {
                return null;
            }
            int i = this.timeline.getPeriod(nextPeriodIndex, this.period, true).windowIndex;
            Object obj2 = this.period.uid;
            long j7 = mediaPeriodInfo.f5057id.windowSequenceNumber;
            if (this.timeline.getWindow(i, this.window).firstPeriodIndex == nextPeriodIndex) {
                ...
                if (next == null || !next.uid.equals(obj3)) {
                    ...
                    j5 = next.f5150info.f5057id.windowSequenceNumber;
                }
                j3 = longValue;
