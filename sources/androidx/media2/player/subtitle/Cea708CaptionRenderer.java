    ...
    class Cea708CCWidget extends ClosedCaptionWidget implements Cea708CCParser.DisplayListener {
        ...
        class CCHandler implements Handler.Callback {
            ...
            private void defineWindow(Cea708CCParser.CaptionWindow captionWindow) {
                int i;
                if (captionWindow != null && (i = captionWindow.f4110id) >= 0) {
                    CCWindowLayout[] cCWindowLayoutArr = this.mCaptionWindowLayouts;
        ...
        private class CCWindowLayout extends RelativeLayout implements View.OnLayoutChangeListener {
            ...
            public void setPenLocation(int i, int i2) {
                ...
                if (i3 >= 0) {
                    while (i3 < i) {
                        appendText(StringUtils.f3949LF);
                        i3++;
                    }
                }
                this.mRow = i;
            ...
            public void initWindow(androidx.media2.player.subtitle.Cea708CaptionRenderer.Cea708CCWidget.CCLayout r19, androidx.media2.player.subtitle.Cea708CCParser.CaptionWindow r20) {
                /*
                    r18 = this;
                    r0 = r18
                    r1 = r19
                    r2 = r20
                    androidx.media2.player.subtitle.Cea708CaptionRenderer$Cea708CCWidget$CCLayout r3 = r0.mCCLayout
                ...
                L_0x00bf:
                    ...
                    androidx.media2.player.subtitle.Cea708CaptionRenderer$Cea708CCWidget$CCLayout r12 = r0.mCCLayout
                ...
                L_0x00f4:
                    ...
                    if (r12 >= 0) goto L_0x0105
                    androidx.media2.player.subtitle.Cea708CaptionRenderer$Cea708CCWidget$CCView r4 = r0.mCCView
                    android.text.Layout$Alignment r12 = android.text.Layout.Alignment.ALIGN_NORMAL
                    r4.setAlignment(r12)
                    float r3 = r3 - r7
                    goto L_0x011c
                L_0x0105:
                    androidx.media2.player.subtitle.Cea708CaptionRenderer$Cea708CCWidget$CCView r7 = r0.mCCView
                ...
                L_0x013e:
                    ...
                    goto L_0x0128
                L_0x0142:
                    androidx.media2.player.subtitle.Cea708CaptionRenderer$Cea708CCWidget$CCLayout r1 = r0.mCCLayout
                    androidx.media2.player.subtitle.Cea708CaptionRenderer$Cea708CCWidget$ScaledLayout$ScaledLayoutParams r3 = new androidx.media2.player.subtitle.Cea708CaptionRenderer$Cea708CCWidget$ScaledLayout$ScaledLayoutParams
                    androidx.media2.player.subtitle.Cea708CaptionRenderer$Cea708CCWidget$CCLayout r13 = r0.mCCLayout
                    r13.getClass()
                    r12 = r3
            ...
            private void updateText(String str, boolean z) {
                ...
                String[] split = TextUtils.split(this.mBuilder.toString(), StringUtils.f3949LF);
                String join = TextUtils.join(StringUtils.f3949LF, Arrays.copyOfRange(split, Math.max(0, split.length - (this.mRowLimit + 1)), split.length));
