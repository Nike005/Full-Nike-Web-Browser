...
public class StartAppCustomEvent implements CustomEventBanner, CustomEventInterstitial {
    ...
    public void showInterstitial() {
        this.f397ad.showAd((AdDisplayListener) new AdDisplayListener() {
    ...
    public View getBanner(String str, Object obj, Activity activity, AdPreferences adPreferences, BannerListener bannerListener, AdSize adSize) {
        ...
        if (mrec == null && (obj instanceof StartAppBannerExtras)) {
            int i = C08404.f398x510b0b9b[((StartAppBannerExtras) obj).getBannerMode().ordinal()];
            if (i == 1) {
                mrec = new Banner(activity, adPreferences, bannerListener);
            } else if (i == 2) {
                mrec = new BannerStandard(activity, adPreferences, bannerListener);
    ...
    /* renamed from: com.startapp.android.mediation.admob.StartAppCustomEvent$4 */
    static /* synthetic */ class C08404 {

        /* renamed from: $SwitchMap$com$startapp$android$mediation$admob$StartAppBannerExtras$BannerMode */
        static final /* synthetic */ int[] f398x510b0b9b;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f398x510b0b9b     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f398x510b0b9b     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.startapp.android.mediation.admob.StartAppCustomEvent.C08404.<clinit>():void");
        }
    }
