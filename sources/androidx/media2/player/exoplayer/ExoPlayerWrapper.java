...
final class ExoPlayerWrapper {
    ...
    public int getAudioSessionId() {
        if (Build.VERSION.SDK_INT >= 21 && this.mAudioSessionId == 0) {
            setAudioSessionId(C3875C.generateAudioSessionIdV21(this.mContext));
        }
        int i = this.mAudioSessionId;
        if (i == 0) {
            return 0;
    ...
    public MediaTimestamp getTimestamp() {
        ...
        if (this.mPlayer.getPlaybackState() == 1) {
            ...
            j = C3875C.msToUs(getCurrentPosition());
        }
    ...
    private static final class MediaItemQueue {
        ...
        public long getCurrentMediaItemPlayingTimeMs() {
            return C3875C.usToMs(this.mCurrentMediaItemPlayingTimeUs);
        }
        ...
        private void appendMediaItem(androidx.media2.common.MediaItem r21, java.util.Collection<androidx.media2.player.exoplayer.ExoPlayerWrapper.MediaItemInfo> r22, java.util.Collection<androidx.media2.exoplayer.external.source.MediaSource> r23) {
            ...
            L_0x0048:
                ...
                long r13 = androidx.media2.exoplayer.external.C3875C.msToUs(r4)
                long r15 = androidx.media2.exoplayer.external.C3875C.msToUs(r6)
                r17 = 0
                r18 = 0
                r19 = 1
                r11 = r2
        ...
        private void releaseMediaItem(MediaItemInfo mediaItemInfo) {
            ...
            try {
                ...
                Log.w(ExoPlayerWrapper.TAG, "Error releasing media item " + mediaItem, e);
            }
        }
    }
}
