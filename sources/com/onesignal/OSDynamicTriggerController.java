...
class OSDynamicTriggerController {
    ...
    public boolean dynamicTriggerShouldFire(final com.onesignal.OSTrigger r15) {
        ...
        L_0x0006:
            ...
            return r1
        L_0x0011:
            int[] r2 = com.onesignal.OSDynamicTriggerController.C06872.$SwitchMap$com$onesignal$OSTrigger$OSTriggerKind     // Catch:{ all -> 0x009d }
    ...
    static /* synthetic */ class C06872 {
        ...
        static {
            ...
            L_0x0064:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.onesignal.OSDynamicTriggerController.C06872.<clinit>():void");
        }
    }

    private static boolean evaluateTimeIntervalWithOperator(double d, double d2, OSTrigger.OSTriggerOperator oSTriggerOperator) {
        switch (C06872.$SwitchMap$com$onesignal$OSTrigger$OSTriggerOperator[oSTriggerOperator.ordinal()]) {
            case 1:
                if (d2 < d) {
                    return true;
                }
