...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    String mName;
    ArrayList<C3531Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C3531Op {
        ...
        C3531Op(int i, Fragment fragment2) {
            this.cmd = i;
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C3531Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C3531Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C3531Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C3531Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C3531Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C3531Op(8, fragment));
        return this;
    }
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        C3531Op op2 = backStackRecord.mOps.get(i7);
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                        ...
                        if (fragment4.mContainerId == i3) {
                            if (fragment4 == fragment3) {
                                ...
                                if (fragment4 == fragment2) {
                                    this.mOps.add(i, new C3531Op(9, fragment4));
                                    i++;
                                    fragment2 = null;
                                }
                                C3531Op op2 = new C3531Op(3, fragment4);
                    ...
                    if (op.fragment == fragment2) {
                        this.mOps.add(i, new C3531Op(9, op.fragment));
                        i++;
                        fragment2 = null;
                    }
                } else if (i2 != 7) {
                    if (i2 == 8) {
                        this.mOps.add(i, new C3531Op(9, fragment2));
                        i++;
    ...
    private static boolean isFragmentPostponed(C3531Op op) {
        Fragment fragment = op.fragment;
