...
public class BasicNetwork implements Network {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x00fe, code lost:
        com.android.volley.VolleyLog.m6229e("Unexpected response code %d for %s", java.lang.Integer.valueOf(r1), r25.getUrl());
     */
    /* JADX WARNING: Code restructure failed: missing block: B:58:0x0112, code lost:
        com.android.volley.VolleyLog.m6229e("Request at %s has been redirected to %s", r25.getOriginUrl(), r25.getUrl());
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:71:0x0168, code lost:
        throw new com.android.volley.NetworkError((java.lang.Throwable) r0);
     */
    ...
    public com.android.volley.NetworkResponse performRequest(com.android.volley.Request<?> r25) throws com.android.volley.VolleyError {
        ...
        L_0x00fe:
            ...
            com.android.volley.VolleyLog.m6229e(r2, r3)
            goto L_0x0125
        L_0x0112:
            java.lang.Object[] r3 = new java.lang.Object[r3]
        ...
        L_0x014b:
            ...
            r1.<init>((com.android.volley.NetworkResponse) r0)
    ...
    private void logSlowRequests(long j, Request<?> request, byte[] bArr, StatusLine statusLine) {
        if (DEBUG || j > ((long) SLOW_REQUEST_THRESHOLD_MS)) {
            ...
            VolleyLog.m6228d("HTTP response for request=<%s> [lifetime=%d], [size=%s], [rc=%d], [retryCount=%s]", objArr);
        }
    }
    ...
    public void logError(String str, String str2, long j) {
        VolleyLog.m6231v("HTTP ERROR(%s) %d ms to fetch %s", str, Long.valueOf(SystemClock.elapsedRealtime() - j), str2);
    }
    ...
    private byte[] entityToBytes(HttpEntity httpEntity) throws IOException, ServerError {
        ...
        try {
            ...
            try {
                ...
                VolleyLog.m6231v("Error occured when calling consumingContent", new Object[0]);
            }
