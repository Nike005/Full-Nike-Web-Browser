...
public final class HttpMediaDrmCallback implements MediaDrmCallback {
    ...
    public byte[] executeKeyRequest(UUID uuid, ExoMediaDrm.KeyRequest keyRequest) throws Exception {
        ...
        if (C3875C.PLAYREADY_UUID.equals(uuid)) {
            str = "text/xml";
        } else {
            str = C3875C.CLEARKEY_UUID.equals(uuid) ? "application/json" : "application/octet-stream";
        }
    ...
    private static byte[] executePost(androidx.media2.exoplayer.external.upstream.HttpDataSource.Factory r17, java.lang.String r18, byte[] r19, java.util.Map<java.lang.String, java.lang.String> r20) throws java.io.IOException {
        /*
            androidx.media2.exoplayer.external.upstream.HttpDataSource r1 = r17.createDataSource()
        ...
        L_0x002a:
            ...
            r3 = 0
        L_0x002e:
            androidx.media2.exoplayer.external.upstream.DataSpec r15 = new androidx.media2.exoplayer.external.upstream.DataSpec
            ...
            androidx.media2.exoplayer.external.upstream.DataSourceInputStream r4 = new androidx.media2.exoplayer.external.upstream.DataSourceInputStream
            r4.<init>(r1, r15)
            byte[] r0 = androidx.media2.exoplayer.external.util.Util.toByteArray(r4)     // Catch:{ InvalidResponseCodeException -> 0x0051 }
            androidx.media2.exoplayer.external.util.Util.closeQuietly((java.io.Closeable) r4)
            return r0
        L_0x004f:
            r0 = move-exception
            goto L_0x007d
