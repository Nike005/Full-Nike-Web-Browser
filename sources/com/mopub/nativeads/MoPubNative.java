...
public class MoPubNative {
    ...
    public void onAdLoad(final AdResponse adResponse) {
        Context contextOrDestroy = getContextOrDestroy();
        if (contextOrDestroy != null) {
            C06023 r1 = new CustomEventNative.CustomEventNativeListener() {
    ...
    public void onAdError(VolleyError volleyError) {
        ...
        if (volleyError instanceof MoPubNetworkError) {
            int i = C06034.$SwitchMap$com$mopub$network$MoPubNetworkError$Reason[((MoPubNetworkError) volleyError).getReason().ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C06034 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.nativeads.MoPubNative.C06034.<clinit>():void");
        }
    }
