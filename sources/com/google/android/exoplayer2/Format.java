...
public final class Format implements Parcelable {
    ...
    public static Format createVideoContainerFormat(String str, String str2, String str3, String str4, int i, int i2, int i3, float f, List<byte[]> list, int i4) {
        return createVideoContainerFormat(str, (String) null, str2, str3, str4, (Metadata) null, i, i2, i3, f, list, i4, 0);
    }
    ...
    public static Format createAudioContainerFormat(String str, String str2, String str3, String str4, int i, int i2, int i3, List<byte[]> list, int i4, String str5) {
        return createAudioContainerFormat(str, (String) null, str2, str3, str4, (Metadata) null, i, i2, i3, list, i4, 0, str5);
    }
    ...
    Format(Parcel parcel) {
        this.f5056id = parcel.readString();
    ...
    public com.google.android.exoplayer2.Format copyWithManifestFormatInfo(com.google.android.exoplayer2.Format r35) {
        ...
        L_0x0007:
            ...
            java.lang.String r4 = r1.f5056id
    ...
    public String toString() {
        return "Format(" + this.f5056id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }

    public int hashCode() {
        if (this.hashCode == 0) {
            String str = this.f5056id;
            int i = 0;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f5056id);
