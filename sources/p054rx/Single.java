...
import p054rx.internal.operators.CompletableFlatMapSingleToCompletable;
import p054rx.internal.operators.SingleDelay;
import p054rx.internal.operators.SingleDoAfterTerminate;
import p054rx.internal.operators.SingleDoOnEvent;
import p054rx.internal.operators.SingleDoOnSubscribe;
import p054rx.internal.operators.SingleDoOnUnsubscribe;
import p054rx.internal.operators.SingleFromCallable;
import p054rx.internal.operators.SingleFromEmitter;
import p054rx.internal.operators.SingleFromFuture;
import p054rx.internal.operators.SingleFromObservable;
import p054rx.internal.operators.SingleLiftObservableOperator;
import p054rx.internal.operators.SingleObserveOn;
import p054rx.internal.operators.SingleOnErrorReturn;
import p054rx.internal.operators.SingleOnSubscribeDelaySubscriptionOther;
import p054rx.internal.operators.SingleOnSubscribeMap;
import p054rx.internal.operators.SingleOnSubscribeUsing;
import p054rx.internal.operators.SingleOperatorCast;
import p054rx.internal.operators.SingleOperatorOnErrorResumeNext;
import p054rx.internal.operators.SingleOperatorZip;
import p054rx.internal.operators.SingleTakeUntilCompletable;
import p054rx.internal.operators.SingleTakeUntilObservable;
import p054rx.internal.operators.SingleTakeUntilSingle;
import p054rx.internal.operators.SingleTimeout;
import p054rx.internal.operators.SingleToObservable;
import p054rx.internal.util.ScalarSynchronousSingle;
...
import p054rx.singles.BlockingSingle;
...
public class Single<T> {
    ...
    public static <T> Single<T> merge(Single<? extends Single<? extends T>> single) {
        ...
        return create(new OnSubscribe<T>(single) {
            ...
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                C26091 r0 = new SingleSubscriber<Single<? extends T>>() {
        ...
        return create(new OnSubscribe<T>() {
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                ...
                createWorker.schedule(new Action0() {
                    public void call() {
                        C25981 r0 = new SingleSubscriber<T>() {
                            public void onSuccess(T t) {
                                try {
    ...
    /* renamed from: to */
    public final <R> R mo23820to(Func1<? super Single<T>, R> func1) {
    ...
    public final Single<T> unsubscribeOn(final Scheduler scheduler) {
        return create(new OnSubscribe<T>() {
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                final C26051 r0 = new SingleSubscriber<T>() {
                    public void onSuccess(T t) {
                        singleSubscriber.onSuccess(t);
                    }
