...
class OSOutcomeEventsController {
    ...
    private void sendAndCreateOutcomeEvent(String str, float f, List<OSInfluence> list, OneSignal.OutcomeCallback outcomeCallback) {
        ...
        for (OSInfluence next : list) {
            int i = C07055.$SwitchMap$com$onesignal$influence$model$OSInfluenceType[next.getInfluenceType().ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C07055 {
        ...
        static {
            ...
            L_0x004e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.onesignal.OSOutcomeEventsController.C07055.<clinit>():void");
        }
    }

    private OSOutcomeSourceBody setSourceChannelIds(OSInfluence oSInfluence, OSOutcomeSourceBody oSOutcomeSourceBody) {
        int i = C07055.$SwitchMap$com$onesignal$influence$model$OSInfluenceChannel[oSInfluence.getInfluenceChannel().ordinal()];
        if (i == 1) {
