...
public class C0962i {
    ...
    /* renamed from: com.startapp.android.publish.ads.splash.i$1 */
    /* compiled from: StartAppSDK */
    static /* synthetic */ class C09631 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f674a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f674a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f674a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f674a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f674a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.startapp.android.publish.ads.splash.C0962i.C09631.<clinit>():void");
        }
    }

    /* renamed from: a */
    public static View m813a(Context context, SplashConfig splashConfig) {
        switch (C09631.f674a[splashConfig.getTheme().ordinal()]) {
            case 1:
                return m819g(context, splashConfig);
            case 2:
                return m818f(context, splashConfig);
            case 3:
                return m817e(context, splashConfig);
            case 4:
                return m816d(context, splashConfig);
            case 5:
                return m815c(context, splashConfig);
            case 6:
                return m814b(context, splashConfig);
            default:
                return null;
        }
    }
    ...
    /* renamed from: b */
    private static View m814b(Context context, SplashConfig splashConfig) {
        View h = m820h(context, splashConfig);
    ...
    /* renamed from: c */
    private static View m815c(Context context, SplashConfig splashConfig) {
        View h = m820h(context, splashConfig);
    ...
    /* renamed from: d */
    private static View m816d(Context context, SplashConfig splashConfig) {
        View h = m820h(context, splashConfig);
    ...
    /* renamed from: e */
    private static View m817e(Context context, SplashConfig splashConfig) {
        View h = m820h(context, splashConfig);
    ...
    /* renamed from: f */
    private static View m818f(Context context, SplashConfig splashConfig) {
        View h = m820h(context, splashConfig);
        int i = context.getResources().getDisplayMetrics().widthPixels;
    ...
    /* renamed from: g */
    private static View m819g(Context context, SplashConfig splashConfig) {
        View h = m820h(context, splashConfig);
    ...
    /* renamed from: h */
    private static View m820h(Context context, SplashConfig splashConfig) {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        Point point = new Point(C1060h.m1162a(context2, (int) DrawableConstants.CtaButton.WIDTH_DIPS), C1060h.m1162a(context2, 28));
        if (splashConfig.getOrientation() == SplashConfig.Orientation.PORTRAIT) {
            i4 = C1060h.m1162a(context2, 5);
            i3 = C1060h.m1162a(context2, 8);
            i2 = C1060h.m1162a(context2, 75);
            i = C1060h.m1162a(context2, 130);
        } else {
            i4 = C1060h.m1162a(context2, 5);
            i3 = C1060h.m1162a(context2, 8);
            i2 = C1060h.m1162a(context2, 40);
            i = C1060h.m1162a(context2, 100);
        }
        ...
        try {
            ...
            C1132f.m1527a(context2, C1130d.EXCEPTION, "TemplatesLayout.getBaseTemplate - webview failed", e.getMessage(), "");
        }
