...
public class zzpd implements zzoz {
    ...
    private final JSONObject zzb(Rect rect) throws JSONException {
        ...
        jSONObject.put("relative_to", CleanerProperties.BOOL_ATT_SELF);
        return jSONObject;
    }
    ...
    public final void performClick(Bundle bundle) {
        if (bundle == null) {
            ...
            zzakb.m44e("The ad slot cannot handle external click events. You must be whitelisted to be able to report your click events.");
        } else {
    ...
    public final boolean recordImpression(Bundle bundle) {
        if (!zzaq("impression_reporting")) {
            zzakb.m44e("The ad slot cannot handle external impression events. You must be whitelisted to whitelisted to be able to report your impression events.");
            return false;
        }
    ...
    public final void reportTouchEvent(Bundle bundle) {
        if (bundle == null) {
            ...
            zzakb.m44e("The ad slot cannot handle external touch events. You must be whitelisted to be able to report your touch events.");
        } else {
