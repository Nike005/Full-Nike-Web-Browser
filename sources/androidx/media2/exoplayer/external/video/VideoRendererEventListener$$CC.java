...
public abstract /* synthetic */ class VideoRendererEventListener$$CC {
    public static void onDroppedFrames$$dflt$$(VideoRendererEventListener videoRendererEventListener, int i, long j) {
    }
    ...
    public static void onVideoSizeChanged$$dflt$$(VideoRendererEventListener videoRendererEventListener, int i, int i2, int i3, float f) {
    }
}
