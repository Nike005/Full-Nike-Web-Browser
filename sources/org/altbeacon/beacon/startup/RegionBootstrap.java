...
public class RegionBootstrap {
    ...
    public RegionBootstrap(BootstrapNotifier bootstrapNotifier, Region region) {
        if (bootstrapNotifier.getApplicationContext() != null) {
            ...
            LogManager.m6046d(TAG, "Waiting for BeaconService connection", new Object[0]);
            return;
        }
    ...
    public void disable() {
        if (!this.disabled) {
            ...
            try {
                ...
                LogManager.m6049e(e, TAG, "Can't stop bootstrap regions", new Object[0]);
            }
        ...
        if (!this.regions.contains(region)) {
            if (this.serviceConnected) {
                try {
                    ...
                    LogManager.m6049e(e, TAG, "Can't add bootstrap region", new Object[0]);
                }
            } else {
                LogManager.m6054w(TAG, "Adding a region: service not yet Connected", new Object[0]);
            }
        ...
        if (this.regions.contains(region)) {
            if (this.serviceConnected) {
                try {
                    ...
                    LogManager.m6049e(e, TAG, "Can't stop bootstrap region", new Object[0]);
                }
            } else {
                LogManager.m6054w(TAG, "Removing a region: service not yet Connected", new Object[0]);
            }
    ...
    private class InternalBeaconConsumer implements BeaconConsumer {
        ...
        public void onBeaconServiceConnect() {
            LogManager.m6046d(RegionBootstrap.TAG, "Activating background region monitoring", new Object[0]);
            ...
            try {
                for (Region region : RegionBootstrap.this.regions) {
                    LogManager.m6046d(RegionBootstrap.TAG, "Background region monitoring activated for region %s", region);
                ...
                LogManager.m6049e(e, RegionBootstrap.TAG, "Can't set up bootstrap regions", new Object[0]);
            }
        }
