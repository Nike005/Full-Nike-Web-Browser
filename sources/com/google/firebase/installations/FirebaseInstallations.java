...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    FirebaseInstallations(FirebaseApp firebaseApp2, UserAgentPublisher userAgentPublisher, HeartBeatInfo heartBeatInfo) {
        this(new ThreadPoolExecutor(0, 1, 30, TimeUnit.SECONDS, new LinkedBlockingQueue(), THREAD_FACTORY), firebaseApp2, new FirebaseInstallationServiceClient(firebaseApp2.getApplicationContext(), userAgentPublisher, heartBeatInfo), new PersistedInstallation(firebaseApp2), new C0191Utils(), new IidStore(firebaseApp2), new RandomFidGenerator());
    }

    FirebaseInstallations(ExecutorService executorService, FirebaseApp firebaseApp2, FirebaseInstallationServiceClient firebaseInstallationServiceClient, PersistedInstallation persistedInstallation2, C0191Utils utils2, IidStore iidStore2, RandomFidGenerator randomFidGenerator) {
    ...
    private void preConditionChecks() {
        ...
        Preconditions.checkArgument(C0191Utils.isValidAppIdFormat(getApplicationId()), APP_ID_VALIDATION_MSG);
        Preconditions.checkArgument(C0191Utils.isValidApiKeyFormat(getApiKey()), API_KEY_VALIDATION_MSG);
    }
    ...
    private PersistedInstallationEntry registerFidWithServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C01872.f34xc38d2559[createFirebaseInstallation.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C01872.f35xe5baa01a[generateAuthToken.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C01872 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f35xe5baa01a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r2 = f35xe5baa01a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0039:
                int[] r1 = f34xc38d2559     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0043:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.FirebaseInstallations.C01872.<clinit>():void");
        }
    }
