...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
    ...
    public MediaCodecAudioRenderer(Context context2, MediaCodecSelector mediaCodecSelector, boolean z, Handler handler, AudioRendererEventListener audioRendererEventListener, AudioSink audioSink2) {
        this(context2, mediaCodecSelector, (DrmSessionManager<FrameworkMediaCrypto>) null, false, z, handler, audioRendererEventListener, audioSink2);
    }
    ...
    public void onStreamChanged(Format[] formatArr, long j) throws ExoPlaybackException {
        ...
        if (this.lastInputTimeUs != -9223372036854775807L) {
            ...
            if (i == this.pendingStreamChangeTimesUs.length) {
                Log.m9w(TAG, "Too many stream changes, so dropping change at " + this.pendingStreamChangeTimesUs[this.pendingStreamChangeCount - 1]);
            } else {
