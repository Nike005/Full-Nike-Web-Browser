...
public final class NativeAdViewHolder {
    ...
    public NativeAdViewHolder(View view, Map<String, View> map, Map<String, View> map2) {
        ...
        if ((view instanceof NativeAdView) || (view instanceof UnifiedNativeAdView)) {
            zzane.m44e("The provided containerView is of type of NativeAdView, which cannot be usedwith NativeAdViewHolder.");
        } else if (zzvk.get(view) != null) {
            zzane.m44e("The provided containerView is already in use with another NativeAdViewHolder.");
        } else {
            zzvk.put(view, this);
