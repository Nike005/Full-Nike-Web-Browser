...
public final class DashMediaSource extends BaseMediaSource {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public DashMediaSource createMediaSource(DashManifest dashManifest) {
            ...
            return new DashMediaSource(dashManifest, (Uri) null, (DataSource.Factory) null, (ParsingLoadable.Parser) null, this.chunkSourceFactory, this.compositeSequenceableLoaderFactory, this.drmSessionManager, this.loadErrorHandlingPolicy, this.livePresentationDelayMs, this.livePresentationDelayOverridesManifest, this.tag);
        }
    ...
    public DashMediaSource(DashManifest dashManifest, DashChunkSource.Factory factory, int i, Handler handler2, MediaSourceEventListener mediaSourceEventListener) {
        this(dashManifest, (Uri) null, (DataSource.Factory) null, (ParsingLoadable.Parser<? extends DashManifest>) null, factory, new DefaultCompositeSequenceableLoaderFactory(), DrmSessionManager.CC.getDummyDrmSessionManager(), new DefaultLoadErrorHandlingPolicy(i), 30000, false, (Object) null);
    ...
    public DashMediaSource(Uri uri, DataSource.Factory factory, ParsingLoadable.Parser<? extends DashManifest> parser, DashChunkSource.Factory factory2, int i, long j, Handler handler2, MediaSourceEventListener mediaSourceEventListener) {
        this((DashManifest) null, uri, factory, parser, factory2, new DefaultCompositeSequenceableLoaderFactory(), DrmSessionManager.CC.getDummyDrmSessionManager(), new DefaultLoadErrorHandlingPolicy(i), j == -1 ? 30000 : j, j != -1, (Object) null);
        Handler handler3 = handler2;
        MediaSourceEventListener mediaSourceEventListener2 = mediaSourceEventListener;
        if (handler3 == null || mediaSourceEventListener2 == null) {
            return;
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j) {
        ...
        this.periodsById.put(dashMediaPeriod.f1id, dashMediaPeriod);
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        this.periodsById.remove(dashMediaPeriod.f1id);
    }
    ...
    public void onManifestLoadCompleted(com.google.android.exoplayer2.upstream.ParsingLoadable<com.google.android.exoplayer2.source.dash.manifest.DashManifest> r16, long r17, long r19) {
        ...
        L_0x0047:
            ...
            com.google.android.exoplayer2.util.Log.m9w(r5, r8)
        L_0x005b:
            r5 = 1
            goto L_0x0098
        L_0x005d:
    ...
    private void onUtcTimestampResolutionError(IOException iOException) {
        Log.m6e(TAG, "Failed to resolve UtcTiming element.", iOException);
        processManifest(true);
    }
    ...
    private void processManifest(boolean z) {
        ...
        if (!this.manifest.dynamic || createPeriodSeekInfo2.isIndexExplicit) {
            ...
            j5 = Math.min((getNowUnixTimeUs() - C5211C.msToUs(this.manifest.availabilityStartTimeMs)) - C5211C.msToUs(this.manifest.getPeriod(periodCount).startMs), j5);
            if (this.manifest.timeShiftBufferDepthMs != -9223372036854775807L) {
                long msToUs = j5 - C5211C.msToUs(this.manifest.timeShiftBufferDepthMs);
        ...
        if (this.manifest.dynamic) {
            ...
            long msToUs2 = j6 - C5211C.msToUs(j7);
        ...
        refreshSourceInfo(new DashTimeline(this.manifest.availabilityStartTimeMs, this.manifest.availabilityStartTimeMs + this.manifest.getPeriod(0).startMs + C5211C.usToMs(j), this.firstPeriodId, j, j6, j2, this.manifest, this.tag));
        if (!this.sideloadedManifest) {
            this.handler.removeCallbacks(this.simulateManifestRefreshRunnable);
            long j8 = 5000;
            if (z2) {
    ...
    private long getNowUnixTimeUs() {
        if (this.elapsedRealtimeOffsetMs != 0) {
            return C5211C.msToUs(SystemClock.elapsedRealtime() + this.elapsedRealtimeOffsetMs);
        }
        return C5211C.msToUs(System.currentTimeMillis());
    }
    ...
    private static final class DashTimeline extends Timeline {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            Integer num = null;
            String str = z ? this.manifest.getPeriod(i).f4id : null;
            if (z) {
                num = Integer.valueOf(this.firstPeriodId + i);
            }
            return period.set(str, num, 0, this.manifest.getPeriodDurationUs(i), C5211C.msToUs(this.manifest.getPeriod(i).startMs - this.manifest.getPeriod(0).startMs) - this.offsetInFirstPeriodUs);
        }
