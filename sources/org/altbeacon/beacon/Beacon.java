...
public class Beacon implements Parcelable, Serializable {
    ...
    public double getDistance() {
        if (this.mDistance == null) {
            ...
            if (d2 != null) {
                ...
                LogManager.m6046d(TAG, "Not using running average RSSI because it is null", new Object[0]);
            }
    ...
    protected static Double calculateDistance(int i, double d) {
        ...
        LogManager.m6048e(TAG, "Distance calculator not set.  Distance will bet set to -1", new Object[0]);
