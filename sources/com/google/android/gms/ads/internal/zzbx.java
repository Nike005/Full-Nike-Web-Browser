...
public final class zzbx extends ViewSwitcher {
    ...
    public final void zzfs() {
        zzakb.m43v("Disable position monitoring on adFrame.");
        zzamt zzamt = this.zzaee;
        if (zzamt != null) {
            zzamt.zzsd();
        }
    ...
    public final void zzft() {
        zzakb.m43v("Enable debug gesture detector on adFrame.");
        this.zzaef = true;
    }

    public final void zzfu() {
        zzakb.m43v("Disable debug gesture detector on adFrame.");
        this.zzaef = false;
    }
}
