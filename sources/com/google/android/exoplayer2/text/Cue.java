...
public class Cue {
    ...
    public Cue(Bitmap bitmap2, float f, int i, float f2, int i2, float f3, float f4) {
        this((CharSequence) null, (Layout.Alignment) null, bitmap2, f2, 0, i2, f, i, Integer.MIN_VALUE, -3.4028235E38f, f3, f4, false, -16777216);
    }
    ...
    public Cue(CharSequence charSequence, Layout.Alignment alignment, float f, int i, int i2, float f2, int i3, float f3, int i4, float f4) {
        this(charSequence, alignment, (Bitmap) null, f, i, i2, f2, i3, i4, f4, f3, -3.4028235E38f, false, -16777216);
    }
