...
public class LocationService {
    ...
    public enum ValidLocationProvider {
        ...
        public boolean hasRequiredPermissions(Context context) {
            int i = C03801.f259x78705711[ordinal()];
            if (i != 1) {
                if (i != 2) {
                    return false;
                }
    ...
    static /* synthetic */ class C03801 {
        ...
        static final /* synthetic */ int[] f259x78705711;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f259x78705711     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.common.LocationService.C03801.<clinit>():void");
        }
    }
