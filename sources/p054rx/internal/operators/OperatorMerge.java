...
import p054rx.exceptions.MissingBackpressureException;
...
import p054rx.internal.util.atomic.SpscAtomicArrayQueue;
import p054rx.internal.util.atomic.SpscExactAtomicArrayQueue;
import p054rx.internal.util.atomic.SpscUnboundedAtomicArrayQueue;
import p054rx.internal.util.unsafe.Pow2;
import p054rx.internal.util.unsafe.SpscArrayQueue;
import p054rx.internal.util.unsafe.UnsafeAccess;
...
public final class OperatorMerge<T> implements Observable.Operator<T, Observable<? extends T>> {
    ...
    static final class MergeSubscriber<T> extends Subscriber<Observable<? extends T>> {
        ...
        /*  JADX ERROR: IndexOutOfBoundsException in pass: RegionMakerVisitor
            ...
            */
        protected void emitScalar(p054rx.internal.operators.OperatorMerge.InnerSubscriber<T> r5, T r6, long r7) {
            /*
                r4 = this;
                r0 = 1
                r1 = 0
            ...
            L_0x0008:
                ...
                p054rx.exceptions.Exceptions.throwIfFatal(r6)     // Catch:{ all -> 0x0046 }
            ...
            L_0x0052:
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: p054rx.internal.operators.OperatorMerge.MergeSubscriber.emitScalar(rx.internal.operators.OperatorMerge$InnerSubscriber, java.lang.Object, long):void");
        }
        ...
        protected void emitScalar(T r5, long r6) {
            ...
            L_0x0008:
                ...
                if (r2 != 0) goto L_0x0019
                p054rx.exceptions.Exceptions.throwIfFatal(r5)     // Catch:{ all -> 0x0051 }
            ...
            L_0x005d:
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: p054rx.internal.operators.OperatorMerge.MergeSubscriber.emitScalar(java.lang.Object, long):void");
        }
        ...
        public void emitLoop() {
            /*
                ...
                r1 = r22
                r3 = 0
                rx.Subscriber<? super T> r4 = r1.child     // Catch:{ all -> 0x0199 }
            L_0x0005:
                boolean r0 = r22.checkTerminate()     // Catch:{ all -> 0x0199 }
                if (r0 == 0) goto L_0x000c
                return
            L_0x000c:
                java.util.Queue<java.lang.Object> r5 = r1.queue     // Catch:{ all -> 0x0199 }
                rx.internal.operators.OperatorMerge$MergeProducer<T> r0 = r1.producer     // Catch:{ all -> 0x0199 }
            ...
            L_0x003b:
                ...
                goto L_0x0071
            L_0x0040:
                java.lang.Object r0 = p054rx.internal.operators.NotificationLite.getValue(r18)     // Catch:{ all -> 0x0199 }
                r4.onNext(r0)     // Catch:{ all -> 0x0048 }
                goto L_0x0068
            L_0x0048:
                r0 = move-exception
                r19 = r0
                boolean r0 = r1.delayErrors     // Catch:{ all -> 0x0199 }
                if (r0 != 0) goto L_0x005f
                p054rx.exceptions.Exceptions.throwIfFatal(r19)     // Catch:{ all -> 0x0199 }
            ...
            L_0x005f:
                r2 = r19
                java.util.Queue r0 = r22.getOrCreateErrorQueue()     // Catch:{ all -> 0x0199 }
            ...
            L_0x0071:
                ...
                goto L_0x007e
            L_0x0078:
                rx.internal.operators.OperatorMerge$MergeProducer<T> r2 = r1.producer     // Catch:{ all -> 0x0199 }
                long r16 = r2.produced(r7)     // Catch:{ all -> 0x0199 }
            L_0x007e:
            ...
            L_0x0089:
                ...
                r6 = 0
            L_0x008c:
                boolean r0 = r1.done     // Catch:{ all -> 0x0199 }
                java.util.Queue<java.lang.Object> r2 = r1.queue     // Catch:{ all -> 0x0199 }
                rx.internal.operators.OperatorMerge$InnerSubscriber<?>[] r5 = r1.innerSubscribers     // Catch:{ all -> 0x0199 }
            ...
            L_0x009d:
                ...
                java.util.concurrent.ConcurrentLinkedQueue<java.lang.Throwable> r0 = r1.errors     // Catch:{ all -> 0x0199 }
                if (r0 == 0) goto L_0x00ae
                boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x0199 }
                if (r0 == 0) goto L_0x00aa
                goto L_0x00ae
            L_0x00aa:
                r22.reportError()     // Catch:{ all -> 0x0199 }
                goto L_0x00b1
            L_0x00ae:
            ...
            L_0x00b2:
                ...
                long r8 = r1.lastId     // Catch:{ all -> 0x0199 }
                int r0 = r1.lastIndex     // Catch:{ all -> 0x0199 }
                if (r7 <= r0) goto L_0x00c2
                r2 = r5[r0]     // Catch:{ all -> 0x0199 }
                long r11 = r2.f3988id     // Catch:{ all -> 0x0199 }
            ...
            L_0x00c6:
                ...
                long r11 = r11.f3988id     // Catch:{ all -> 0x0199 }
            ...
            L_0x00d6:
                ...
                goto L_0x00c6
            L_0x00d9:
                r1.lastIndex = r0     // Catch:{ all -> 0x0199 }
                r2 = r5[r0]     // Catch:{ all -> 0x0199 }
                long r8 = r2.f3988id     // Catch:{ all -> 0x0199 }
                r1.lastId = r8     // Catch:{ all -> 0x0199 }
            L_0x00e1:
                r2 = 0
                r8 = 0
            L_0x00e3:
                if (r2 >= r7) goto L_0x016c
                boolean r9 = r22.checkTerminate()     // Catch:{ all -> 0x0199 }
            ...
            L_0x00f0:
                ...
                boolean r18 = r22.checkTerminate()     // Catch:{ all -> 0x0199 }
                if (r18 == 0) goto L_0x00fb
                return
            L_0x00fb:
                rx.internal.util.RxRingBuffer r13 = r9.queue     // Catch:{ all -> 0x0199 }
                if (r13 != 0) goto L_0x0100
                goto L_0x0106
            L_0x0100:
                java.lang.Object r11 = r13.poll()     // Catch:{ all -> 0x0199 }
                if (r11 != 0) goto L_0x0109
            L_0x0106:
                r20 = 1
                goto L_0x0129
            L_0x0109:
                java.lang.Object r13 = p054rx.internal.operators.NotificationLite.getValue(r11)     // Catch:{ all -> 0x0199 }
            ...
            L_0x0117:
                r0 = move-exception
                r2 = r0
                p054rx.exceptions.Exceptions.throwIfFatal(r2)     // Catch:{ all -> 0x005b }
            ...
            L_0x0129:
                ...
                rx.internal.operators.OperatorMerge$MergeProducer<T> r13 = r1.producer     // Catch:{ all -> 0x0199 }
                long r16 = r13.produced(r12)     // Catch:{ all -> 0x0199 }
                goto L_0x0139
            L_0x0134:
                r16 = 9223372036854775807(0x7fffffffffffffff, double:NaN)
            L_0x0139:
                long r12 = (long) r12     // Catch:{ all -> 0x0199 }
                r9.requestMore(r12)     // Catch:{ all -> 0x0199 }
            L_0x013d:
                int r12 = (r16 > r14 ? 1 : (r16 == r14 ? 0 : -1))
                if (r12 == 0) goto L_0x0143
                if (r11 != 0) goto L_0x00ef
            L_0x0143:
                boolean r11 = r9.done     // Catch:{ all -> 0x0199 }
                rx.internal.util.RxRingBuffer r12 = r9.queue     // Catch:{ all -> 0x0199 }
                if (r11 == 0) goto L_0x015e
                if (r12 == 0) goto L_0x0151
                boolean r11 = r12.isEmpty()     // Catch:{ all -> 0x0199 }
                if (r11 == 0) goto L_0x015e
            L_0x0151:
                r1.removeInner(r9)     // Catch:{ all -> 0x0199 }
                boolean r8 = r22.checkTerminate()     // Catch:{ all -> 0x0199 }
            ...
            L_0x016c:
                ...
                long r9 = r0.f3988id     // Catch:{ all -> 0x0199 }
                r1.lastId = r9     // Catch:{ all -> 0x0199 }
                goto L_0x0176
            L_0x0175:
                r8 = 0
            L_0x0176:
            ...
            L_0x0180:
                ...
                boolean r0 = r1.missed     // Catch:{ all -> 0x0191 }
                if (r0 != 0) goto L_0x018c
                r1.emitting = r3     // Catch:{ all -> 0x0189 }
            ...
            L_0x019b:
                ...
                monitor-enter(r22)
                r1.emitting = r3     // Catch:{ all -> 0x01a2 }
            ...
            L_0x01a7:
                goto L_0x01a6
            */
            throw new UnsupportedOperationException("Method not decompiled: p054rx.internal.operators.OperatorMerge.MergeSubscriber.emitLoop():void");
        }
