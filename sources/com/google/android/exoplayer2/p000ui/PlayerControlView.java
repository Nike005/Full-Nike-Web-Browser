...
import com.google.android.exoplayer2.p000ui.TimeBar;
...
public class PlayerControlView extends FrameLayout {
    ...
    public PlayerControlView(Context context, AttributeSet attributeSet, int i, AttributeSet attributeSet2) {
        ...
        int i2 = C0034R.layout.exo_player_control_view;
        this.rewindMs = 5000;
        ...
        if (attributeSet2 != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet2, C0034R.styleable.PlayerControlView, 0, 0);
            try {
                this.rewindMs = obtainStyledAttributes.getInt(C0034R.styleable.PlayerControlView_rewind_increment, this.rewindMs);
                this.fastForwardMs = obtainStyledAttributes.getInt(C0034R.styleable.PlayerControlView_fastforward_increment, this.fastForwardMs);
                this.showTimeoutMs = obtainStyledAttributes.getInt(C0034R.styleable.PlayerControlView_show_timeout, this.showTimeoutMs);
                i2 = obtainStyledAttributes.getResourceId(C0034R.styleable.PlayerControlView_controller_layout_id, i2);
                this.repeatToggleModes = getRepeatToggleModes(obtainStyledAttributes, this.repeatToggleModes);
                this.showShuffleButton = obtainStyledAttributes.getBoolean(C0034R.styleable.PlayerControlView_show_shuffle_button, this.showShuffleButton);
                setTimeBarMinUpdateInterval(obtainStyledAttributes.getInt(C0034R.styleable.PlayerControlView_time_bar_min_update_interval, this.timeBarMinUpdateIntervalMs));
            } finally {
        ...
        TimeBar timeBar2 = (TimeBar) findViewById(C0034R.C0036id.exo_progress);
        View findViewById = findViewById(C0034R.C0036id.exo_progress_placeholder);
        if (timeBar2 != null) {
            this.timeBar = timeBar2;
        } else if (findViewById != null) {
            DefaultTimeBar defaultTimeBar = new DefaultTimeBar(context, (AttributeSet) null, 0, attributeSet2);
            defaultTimeBar.setId(C0034R.C0036id.exo_progress);
        ...
        this.durationView = (TextView) findViewById(C0034R.C0036id.exo_duration);
        this.positionView = (TextView) findViewById(C0034R.C0036id.exo_position);
        TimeBar timeBar3 = this.timeBar;
        if (timeBar3 != null) {
            timeBar3.addListener(this.componentListener);
        }
        View findViewById2 = findViewById(C0034R.C0036id.exo_play);
        this.playButton = findViewById2;
        if (findViewById2 != null) {
            findViewById2.setOnClickListener(this.componentListener);
        }
        View findViewById3 = findViewById(C0034R.C0036id.exo_pause);
        this.pauseButton = findViewById3;
        if (findViewById3 != null) {
            findViewById3.setOnClickListener(this.componentListener);
        }
        View findViewById4 = findViewById(C0034R.C0036id.exo_prev);
        this.previousButton = findViewById4;
        if (findViewById4 != null) {
            findViewById4.setOnClickListener(this.componentListener);
        }
        View findViewById5 = findViewById(C0034R.C0036id.exo_next);
        this.nextButton = findViewById5;
        if (findViewById5 != null) {
            findViewById5.setOnClickListener(this.componentListener);
        }
        View findViewById6 = findViewById(C0034R.C0036id.exo_rew);
        this.rewindButton = findViewById6;
        if (findViewById6 != null) {
            findViewById6.setOnClickListener(this.componentListener);
        }
        View findViewById7 = findViewById(C0034R.C0036id.exo_ffwd);
        this.fastForwardButton = findViewById7;
        if (findViewById7 != null) {
            findViewById7.setOnClickListener(this.componentListener);
        }
        ImageView imageView = (ImageView) findViewById(C0034R.C0036id.exo_repeat_toggle);
        this.repeatToggleButton = imageView;
        if (imageView != null) {
            imageView.setOnClickListener(this.componentListener);
        }
        ImageView imageView2 = (ImageView) findViewById(C0034R.C0036id.exo_shuffle);
        this.shuffleButton = imageView2;
        if (imageView2 != null) {
            imageView2.setOnClickListener(this.componentListener);
        }
        this.vrButton = findViewById(C0034R.C0036id.exo_vr);
        setShowVrButton(false);
        Resources resources = context.getResources();
        this.buttonAlphaEnabled = ((float) resources.getInteger(C0034R.integer.exo_media_button_opacity_percentage_enabled)) / 100.0f;
        this.buttonAlphaDisabled = ((float) resources.getInteger(C0034R.integer.exo_media_button_opacity_percentage_disabled)) / 100.0f;
        this.repeatOffButtonDrawable = resources.getDrawable(C0034R.C0035drawable.exo_controls_repeat_off);
        this.repeatOneButtonDrawable = resources.getDrawable(C0034R.C0035drawable.exo_controls_repeat_one);
        this.repeatAllButtonDrawable = resources.getDrawable(C0034R.C0035drawable.exo_controls_repeat_all);
        this.shuffleOnButtonDrawable = resources.getDrawable(C0034R.C0035drawable.exo_controls_shuffle_on);
        this.shuffleOffButtonDrawable = resources.getDrawable(C0034R.C0035drawable.exo_controls_shuffle_off);
        this.repeatOffButtonContentDescription = resources.getString(C0034R.string.exo_controls_repeat_off_description);
        this.repeatOneButtonContentDescription = resources.getString(C0034R.string.exo_controls_repeat_one_description);
        this.repeatAllButtonContentDescription = resources.getString(C0034R.string.exo_controls_repeat_all_description);
        this.shuffleOnContentDescription = resources.getString(C0034R.string.exo_controls_shuffle_on_description);
        this.shuffleOffContentDescription = resources.getString(C0034R.string.exo_controls_shuffle_off_description);
    }

    private static int getRepeatToggleModes(TypedArray typedArray, int i) {
        return typedArray.getInt(C0034R.styleable.PlayerControlView_repeat_toggle_modes, i);
    }
    ...
    public void updateNavigation() {
        ...
        L_0x0082:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p000ui.PlayerControlView.updateNavigation():void");
    }
            ...
            if (!currentTimeline.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (i2 == currentWindowIndex) {
                        this.currentWindowOffset = C5211C.usToMs(j2);
                    }
                    ...
                    for (int i3 = this.window.firstPeriodIndex; i3 <= this.window.lastPeriodIndex; i3++) {
                        ...
                        for (int i4 = 0; i4 < adGroupCount; i4++) {
                            ...
                            if (positionInWindowUs >= 0 && positionInWindowUs <= this.window.durationUs) {
                                ...
                                this.adGroupTimesMs[i] = C5211C.usToMs(j2 + positionInWindowUs);
    ...
    public void previous(Player player2) {
        ...
        if (!currentTimeline.isEmpty() && !player2.isPlayingAd()) {
            ...
            if (previousWindowIndex == -1 || (player2.getCurrentPosition() > MAX_POSITION_FOR_SEEK_TO_PREVIOUS && (!this.window.isDynamic || this.window.isSeekable))) {
                ...
                seekTo(player2, previousWindowIndex, -9223372036854775807L);
            }
        }
    }
    ...
    public void next(Player player2) {
        ...
        if (!currentTimeline.isEmpty() && !player2.isPlayingAd()) {
            ...
            if (nextWindowIndex != -1) {
                seekTo(player2, nextWindowIndex, -9223372036854775807L);
            } else if (currentTimeline.getWindow(currentWindowIndex, this.window).isDynamic) {
                seekTo(player2, currentWindowIndex, -9223372036854775807L);
            }
        }
    }
            ...
            if (access$500 != null) {
                if (PlayerControlView.this.nextButton == view) {
                    ...
                    if (access$500.getPlaybackState() == 1) {
                        ...
                        boolean unused = PlayerControlView.this.seekTo(access$500, access$500.getCurrentWindowIndex(), -9223372036854775807L);
                    }
