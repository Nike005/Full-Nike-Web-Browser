...
public class BluetoothMedic {
    ...
    public BroadcastReceiver mBluetoothEventReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            LogManager.m6046d(BluetoothMedic.TAG, "Broadcast notification received.", new Object[0]);
            ...
            if (action.equalsIgnoreCase("onScanFailed")) {
                if (intent.getIntExtra("errorCode", -1) == 2) {
                    ...
                    LogManager.m6046d(BluetoothMedic.TAG, "Detected a SCAN_FAILED_APPLICATION_REGISTRATION_FAILED.  We need to cycle bluetooth to recover", new Object[0]);
                ...
                LogManager.m6046d(BluetoothMedic.TAG, "Unknown event.", new Object[0]);
    ...
    public void enablePowerCycleOnFailures(Context context) {
        ...
        if (localBroadcastManager != null) {
            ...
            String str = TAG;
            LogManager.m6046d(str, "Medic monitoring for transmission and scan failure notifications with receiver: " + this.mBluetoothEventReceiver, new Object[0]);
        }
    }
    ...
    public void enablePeriodicTests(Context context, int i) {
        ...
        this.mTestType = i;
        String str = TAG;
        LogManager.m6046d(str, "Medic scheduling periodic tests of types " + i, new Object[0]);
    ...
    public boolean runScanTest(final android.content.Context r10) {
        /*
            ...
            org.altbeacon.beacon.logging.LogManager.m6050i(r0, r3, r2)
        ...
        L_0x0026:
            ...
            org.altbeacon.beacon.logging.LogManager.m6046d(r10, r6, r5)
        ...
        L_0x003a:
            ...
            org.altbeacon.beacon.logging.LogManager.m6046d(r10, r3, r2)
        L_0x004e:
        ...
        L_0x0054:
            ...
            org.altbeacon.beacon.logging.LogManager.m6046d(r10, r2, r0)
        L_0x005d:
            java.lang.String r10 = TAG
            java.lang.Object[] r0 = new java.lang.Object[r1]
    ...
    public boolean runTransmitterTest(final Context context) {
        ...
        if (bluetoothAdapter != null) {
            ...
            if (bluetoothLeAdvertiser != null) {
                ...
                LogManager.m6050i(TAG, "Starting transmitter test", new Object[0]);
                bluetoothLeAdvertiser.startAdvertising(build, build2, new AdvertiseCallback() {
                    public void onStartSuccess(AdvertiseSettings advertiseSettings) {
                        super.onStartSuccess(advertiseSettings);
                        LogManager.m6050i(BluetoothMedic.TAG, "Transmitter test succeeded", new Object[0]);
                    ...
                    public void onStartFailure(int i) {
                        ...
                        LogManager.m6046d(access$000, "Sending onStartFailure broadcast with " + BluetoothMedic.this.mLocalBroadcastManager, new Object[0]);
                        ...
                        if (i == 4) {
                            ...
                            LogManager.m6054w(BluetoothMedic.TAG, "Transmitter test failed in a way we consider a test failure", new Object[0]);
                        ...
                        LogManager.m6050i(BluetoothMedic.TAG, "Transmitter test failed, but not in a way we consider a test failure", new Object[0]);
                    }
                });
            } else {
                LogManager.m6046d(TAG, "Cannot get advertiser", new Object[0]);
            }
            while (true) {
                if (this.mTransmitterTestResult != null) {
                    break;
                }
                LogManager.m6046d(TAG, "Waiting for transmitter test to complete...", new Object[0]);
                try {
                    Thread.sleep(1000);
                } catch (InterruptedException unused) {
                }
                if (System.currentTimeMillis() - currentTimeMillis > 5000) {
                    LogManager.m6046d(TAG, "Timeout running transmitter test", new Object[0]);
                    break;
                }
            }
        }
        LogManager.m6046d(TAG, "transmitter test complete", new Object[0]);
    ...
    public boolean cycleBluetoothIfNotTooSoon() {
        ...
        if (currentTimeMillis < 60000) {
            String str = TAG;
            LogManager.m6046d(str, "Not cycling bluetooth because we just did so " + currentTimeMillis + " milliseconds ago.", new Object[0]);
            return false;
        }
        this.mLastBluetoothPowerCycleTime = System.currentTimeMillis();
        LogManager.m6046d(TAG, "Power cycling bluetooth", new Object[0]);
        cycleBluetooth();
        return true;
    }
    ...
    private void cycleBluetooth() {
        LogManager.m6046d(TAG, "Power cycling bluetooth", new Object[0]);
        LogManager.m6046d(TAG, "Turning Bluetooth off.", new Object[0]);
        BluetoothAdapter bluetoothAdapter = this.mAdapter;
        if (bluetoothAdapter != null) {
            bluetoothAdapter.disable();
            this.mHandler.postDelayed(new Runnable() {
                public void run() {
                    LogManager.m6046d(BluetoothMedic.TAG, "Turning Bluetooth back on.", new Object[0]);
        ...
        LogManager.m6054w(TAG, "Cannot cycle bluetooth.  Manager is null.", new Object[0]);
    }
