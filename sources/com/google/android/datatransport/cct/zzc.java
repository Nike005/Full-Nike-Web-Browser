...
import com.google.android.datatransport.cct.p103a.zzaa;
import com.google.android.datatransport.cct.p103a.zzo;
import com.google.android.datatransport.cct.p103a.zzq;
import com.google.android.datatransport.cct.p103a.zzs;
import com.google.android.datatransport.cct.p103a.zzt;
import com.google.android.datatransport.cct.p103a.zzv;
import com.google.android.datatransport.cct.p103a.zzx;
import com.google.android.datatransport.cct.p103a.zzy;
...
final class zzc implements TransportBackend {
    ...
    zzc(Context context, Clock clock, Clock clock2) {
        ...
        this.zzd = clock2;
        this.zze = clock;
        this.zzf = SessionCommand.COMMAND_CODE_SESSION_FAST_FORWARD;
    }
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        for (Map.Entry entry : hashMap.entrySet()) {
            ...
            for (EventInternal eventInternal2 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.m7231of("proto"))) {
                    zza2 = zzt.zza(encodedPayload.getBytes());
                } else if (encoding.equals(Encoding.m7231of(AdType.STATIC_NATIVE))) {
                    zza2 = zzt.zza(new String(encodedPayload.getBytes(), Charset.forName("UTF-8")));
                } else {
                    Logging.m7239w("CctTransportBackend", "Received event of unsupported encoding %s. Skipping...", encoding);
                }
        ...
        try {
            ...
            if (zzb2.zza == 200) {
                return BackendResponse.m7232ok(zzb2.zzc);
            }
            int i = zzb2.zza;
            if (i < 500) {
                if (i != 404) {
            ...
            Logging.m7237e("CctTransportBackend", "Could not make request to the backend", e);
            return BackendResponse.transientError();
        }
    }
    ...
    public zzb zza(zza zza2) throws IOException {
        ...
        Logging.m7234d("CctTransportBackend", "Making request to: %s", (Object) zza2.zza);
        ...
        try {
            ...
            try {
                ...
                Logging.m7238i("CctTransportBackend", sb.toString());
                StringBuilder sb2 = new StringBuilder();
                sb2.append("Content-Type: ");
                sb2.append(httpURLConnection.getHeaderField("Content-Type"));
                Logging.m7238i("CctTransportBackend", sb2.toString());
                StringBuilder sb3 = new StringBuilder();
                sb3.append("Content-Encoding: ");
                sb3.append(httpURLConnection.getHeaderField(HttpConnection.CONTENT_ENCODING));
                Logging.m7238i("CctTransportBackend", sb3.toString());
                ...
                Logging.m7237e("CctTransportBackend", "Couldn't encode request, returning with 400", e);
    ...
    static /* synthetic */ zza zza(zza zza2, zzb zzb2) {
        ...
        Logging.m7234d("CctTransportBackend", "Following redirect to: %s", (Object) url);
