package com.google.android.datatransport.cct.p103a;

import com.google.android.datatransport.cct.p103a.zza;
...
final class zzd extends zza {
    ...
    /* compiled from: com.google.android.datatransport:transport-backend-cct@@2.2.0 */
    static final class zza extends zza.C5312zza {
        private Integer zza;
        private String zzb;
        private String zzc;
        private String zzd;
        ...
        public zza.C5312zza zza(int i) {
            this.zza = Integer.valueOf(i);
            return this;
        }

        public zza.C5312zza zzb(String str) {
            this.zzh = str;
            return this;
        }

        public zza.C5312zza zzc(String str) {
            this.zzc = str;
            return this;
        }

        public zza.C5312zza zzd(String str) {
            this.zzg = str;
            return this;
        }

        public zza.C5312zza zze(String str) {
            this.zzb = str;
            return this;
        }

        public zza.C5312zza zzf(String str) {
            this.zzf = str;
            return this;
        }

        public zza.C5312zza zzg(String str) {
            this.zze = str;
            return this;
        }

        public zza.C5312zza zza(String str) {
            this.zzd = str;
            return this;
        }
