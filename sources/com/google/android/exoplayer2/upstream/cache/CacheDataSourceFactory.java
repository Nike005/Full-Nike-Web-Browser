...
public final class CacheDataSourceFactory implements DataSource.Factory {
    ...
    public CacheDataSourceFactory(Cache cache2, DataSource.Factory factory, int i) {
        this(cache2, factory, new FileDataSource.Factory(), new CacheDataSinkFactory(cache2, CacheDataSink.DEFAULT_FRAGMENT_SIZE), i, (CacheDataSource.EventListener) null);
    }
