...
public class zzaqx extends WebViewClient implements zzasc {
    ...
    private final void zzi(Uri uri) {
        ...
        if (list != null) {
            ...
            if (zzakb.isLoggable(2)) {
                ...
                zzakb.m43v(valueOf.length() != 0 ? "Received GMSG: ".concat(valueOf) : new String("Received GMSG: "));
    ...
    public final void onLoadResource(WebView webView, String str) {
        ...
        zzakb.m43v(valueOf.length() != 0 ? "Loading resource: ".concat(valueOf) : new String("Loading resource: "));
    ...
    public final void onPageFinished(android.webkit.WebView r1, java.lang.String r2) {
        /*
            ...
            com.google.android.gms.internal.ads.zzakb.m43v(r2)     // Catch:{ all -> 0x0029 }
            com.google.android.gms.internal.ads.zzaqw r2 = r0.zzbnd     // Catch:{ all -> 0x0029 }
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        String valueOf = String.valueOf(str);
        zzakb.m43v(valueOf.length() != 0 ? "AdWebView shouldOverrideUrlLoading: ".concat(valueOf) : new String("AdWebView shouldOverrideUrlLoading: "));
        Uri parse = Uri.parse(str);
        if (!"gmsg".equalsIgnoreCase(parse.getScheme()) || !"mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
