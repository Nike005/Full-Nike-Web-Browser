...
public final class zzos extends zzqt implements zzpb {
    ...
    public final void performClick(String str) {
        synchronized (this.mLock) {
            if (this.zzbij == null) {
                zzane.m44e("#001 Attempt to perform click before app native ad initialized.");
            } else {
    ...
    public final void recordImpression() {
        synchronized (this.mLock) {
            if (this.zzbij == null) {
                zzane.m44e("#002 Attempt to record impression before native ad initialized.");
            } else {
    ...
    public final boolean zzh(IObjectWrapper iObjectWrapper) {
        if (this.zzbij == null) {
            zzane.m44e("Attempt to call renderVideoInMediaView before ad initialized.");
            return false;
