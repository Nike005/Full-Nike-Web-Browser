...
public class zzaf {
    ...
    static class zza {
        ...
        public final void finalize() throws Throwable {
            if (!this.zzbm) {
                ...
                zzaf.m41e("Marker log finalized without finish() - uncaught exit point for request", new Object[0]);
            }
        }
        ...
        public final synchronized void zzc(String str) {
            ...
            if (j > 0) {
                ...
                zzaf.m40d("(%-4d ms) %s", Long.valueOf(j), str);
                for (zzag next : this.zzbl) {
                    long j3 = next.time;
                    zzaf.m40d("(+%-4d) [%2d] %s", Long.valueOf(j3 - j2), Long.valueOf(next.zzbn), next.name);
                    j2 = j3;
                }
            }
        }
    ...
    /* renamed from: d */
    public static void m40d(String str, Object... objArr) {
        Log.d(TAG, zza(str, objArr));
    }

    /* renamed from: e */
    public static void m41e(String str, Object... objArr) {
        Log.e(TAG, zza(str, objArr));
    }

    /* renamed from: v */
    public static void m42v(String str, Object... objArr) {
        if (DEBUG) {
