...
class TrackFirebaseAnalytics {
            ...
            if (currentTimeMillis - lastReceivedTime.get() <= 120000) {
                ...
                if (atomicLong == null || currentTimeMillis - atomicLong.get() >= 30000) {
                    try {
                        ...
                        bundle.putString(Constants.ScionAnalytics.PARAM_CAMPAIGN, getCampaignNameFromPayload(lastReceivedPayload));
    ...
    public void trackOpenedEvent(OSNotificationOpenResult oSNotificationOpenResult) {
        ...
        try {
            ...
            bundle.putString(Constants.ScionAnalytics.PARAM_CAMPAIGN, getCampaignNameFromPayload(oSNotificationOpenResult.notification.payload));
