...
public final class DefaultDataSource implements DataSource {
    ...
    public DefaultDataSource(Context context2, String str, int i, int i2, boolean z) {
        this(context2, new DefaultHttpDataSource(str, i, i2, z, (HttpDataSource.RequestProperties) null));
    }
    ...
    private DataSource getRtmpDataSource() {
        if (this.rtmpDataSource == null) {
            try {
                ...
                Log.m9w(TAG, "Attempting to play RTMP stream without depending on the RTMP extension");
            } catch (Exception e) {
