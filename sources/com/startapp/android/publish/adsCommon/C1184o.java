...
public class C1184o {
    ...
    /* renamed from: a */
    public boolean mo15042a(View view, int i) {
        if (view == null || !view.hasWindowFocus() || !view.isShown() || m1750a(view) || view.getRootView() == null || view.getRootView().getParent() == null || !view.getGlobalVisibleRect(this.f1305a)) {
            return false;
        }
        if (view.getParent() instanceof ViewGroup) {
            ...
            for (int indexOfChild = viewGroup.indexOfChild(view) + 1; indexOfChild < viewGroup.getChildCount(); indexOfChild++) {
                ...
                if (childAt.getVisibility() == 0 && m1751a(view, childAt, 0)) {
                    return false;
                }
            }
        }
        long height = ((long) this.f1305a.height()) * ((long) this.f1305a.width());
    ...
    /* renamed from: a */
    private static boolean m1751a(View view, View view2, int i) {
        int[] iArr = new int[2];
        int[] iArr2 = new int[2];
