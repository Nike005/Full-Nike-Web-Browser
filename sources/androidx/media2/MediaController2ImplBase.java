...
class MediaController2ImplBase implements MediaController2.MediaController2Impl {
    ...
    public void close() {
        ...
        L_0x001c:
            ...
            monitor-enter(r0)
            androidx.media2.IMediaSession2 r1 = r5.mISession2     // Catch:{ all -> 0x005c }
        ...
        L_0x0027:
            ...
            androidx.media2.MediaController2ImplBase$SessionServiceConnection r2 = r5.mServiceConnection     // Catch:{ all -> 0x005c }
            r3 = 0
            if (r2 == 0) goto L_0x0038
            android.content.Context r2 = r5.mContext     // Catch:{ all -> 0x005c }
            androidx.media2.MediaController2ImplBase$SessionServiceConnection r4 = r5.mServiceConnection     // Catch:{ all -> 0x005c }
            r2.unbindService(r4)     // Catch:{ all -> 0x005c }
            r5.mServiceConnection = r3     // Catch:{ all -> 0x005c }
        L_0x0038:
            r5.mISession2 = r3     // Catch:{ all -> 0x005c }
            androidx.media2.MediaController2Stub r2 = r5.mControllerStub     // Catch:{ all -> 0x005c }
            ...
            androidx.media2.MediaController2Stub r0 = r5.mControllerStub     // Catch:{ RemoteException -> 0x0051 }
    ...
    public long getDuration() {
        /*
            ...
            monitor-enter(r0)
            androidx.media2.MediaItem2 r1 = r3.mCurrentMediaItem     // Catch:{ all -> 0x0025 }
            if (r1 != 0) goto L_0x0009
            r1 = 0
            goto L_0x000f
        L_0x0009:
            androidx.media2.MediaItem2 r1 = r3.mCurrentMediaItem     // Catch:{ all -> 0x0025 }
            androidx.media2.MediaMetadata2 r1 = r1.getMetadata()     // Catch:{ all -> 0x0025 }
        L_0x000f:
    ...
    private class SessionServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            if (MediaController2ImplBase.DEBUG) {
                Log.d(MediaController2ImplBase.TAG, "onServiceConnected " + componentName + StringUtils.SPACE + this);
            }
