...
class AvidViewabilitySession implements ExternalViewabilitySession {
    ...
    public Boolean recordVideoEvent(ExternalViewabilitySession.VideoEvent videoEvent, int i) {
        ...
        try {
            switch (C03711.f253x203bc3a[videoEvent.ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
    ...
    static /* synthetic */ class C03711 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f253x203bc3a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f253x203bc3a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f253x203bc3a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f253x203bc3a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f253x203bc3a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f253x203bc3a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f253x203bc3a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f253x203bc3a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f253x203bc3a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f253x203bc3a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f253x203bc3a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f253x203bc3a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.common.AvidViewabilitySession.C03711.<clinit>():void");
        }
    }
