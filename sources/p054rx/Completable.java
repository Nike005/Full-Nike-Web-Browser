...
import p054rx.internal.operators.CompletableFromEmitter;
import p054rx.internal.operators.CompletableOnSubscribeConcat;
import p054rx.internal.operators.CompletableOnSubscribeConcatArray;
import p054rx.internal.operators.CompletableOnSubscribeConcatIterable;
import p054rx.internal.operators.CompletableOnSubscribeMerge;
import p054rx.internal.operators.CompletableOnSubscribeMergeArray;
import p054rx.internal.operators.CompletableOnSubscribeMergeDelayErrorArray;
import p054rx.internal.operators.CompletableOnSubscribeMergeDelayErrorIterable;
import p054rx.internal.operators.CompletableOnSubscribeMergeIterable;
import p054rx.internal.operators.CompletableOnSubscribeTimeout;
...
import p054rx.observers.SafeCompletableSubscriber;
...
import p054rx.subscriptions.MultipleAssignmentSubscription;
...
public class Completable {
    ...
    public static Completable amb(final Completable... completableArr) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                C25731 r2 = new CompletableSubscriber() {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                try {
                    ...
                    final AtomicBoolean atomicBoolean = new AtomicBoolean();
                    C25861 r3 = new CompletableSubscriber() {
                        public void onCompleted() {
                            if (atomicBoolean.compareAndSet(false, true)) {
                                compositeSubscription.unsubscribe();
                                completableSubscriber.onCompleted();
    ...
    public static Completable fromObservable(final Observable<?> observable) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                C25361 r0 = new Subscriber<Object>() {
    ...
    public static Completable fromSingle(final Single<?> single) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                C25381 r0 = new SingleSubscriber<Object>() {
                    public void onError(Throwable th) {
                        completableSubscriber.onError(th);
                    }
    ...
    public final Completable compose(Transformer transformer) {
        return (Completable) mo23430to(transformer);
    }
    ...
    /* renamed from: to */
    public final <R> R mo23430to(Func1<? super Completable, R> func1) {
