...
public final class zzaf implements zzv<Object> {
    ...
    public final void zza(Object obj, Map<String, String> map) {
        ...
        if (TextUtils.isEmpty(str5)) {
            ...
            str = valueOf.length() != 0 ? StringUtils.f3949LF.concat(valueOf) : new String(StringUtils.f3949LF);
        }
            ...
            if (remove == null) {
                ...
                try {
                    ...
                    if (zzakb.zzqp()) {
                        ...
                        zzakb.m43v(valueOf5.length() != 0 ? "Result GMSG: ".concat(valueOf5) : new String("Result GMSG: "));
                    }
