...
final class zzaa extends RemoteMediaClient.zzc {
    ...
    public final void zzb(com.google.android.gms.internal.cast.zzcn r5) {
        /*
            ...
            int[] r2 = r4.zzfn     // Catch:{ zzdk | IllegalStateException -> 0x0019 }
            org.json.JSONObject r3 = r4.zzfi     // Catch:{ zzdk | IllegalStateException -> 0x0019 }
            r0.zza((com.google.android.gms.internal.cast.zzdm) r1, (int[]) r2, (org.json.JSONObject) r3)     // Catch:{ zzdk | IllegalStateException -> 0x0019 }
            goto L_0x0029
        L_0x0017:
            r0 = move-exception
            goto L_0x002b
