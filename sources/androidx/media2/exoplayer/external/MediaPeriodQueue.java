...
final class MediaPeriodQueue {
    ...
    public boolean shouldLoadNextMediaPeriod() {
        MediaPeriodHolder mediaPeriodHolder = this.loading;
        return mediaPeriodHolder == null || (!mediaPeriodHolder.f5125info.isFinal && this.loading.isFullyBuffered() && this.loading.f5125info.durationUs != -9223372036854775807L && this.length < 100);
    }
    ...
    public MediaPeriod enqueueNextMediaPeriod(RendererCapabilities[] rendererCapabilitiesArr, TrackSelector trackSelector, Allocator allocator, MediaSource mediaSource, MediaPeriodInfo mediaPeriodInfo) {
        ...
        if (mediaPeriodHolder == null) {
            ...
            j = mediaPeriodHolder.getRendererOffset() + this.loading.f5125info.durationUs;
        }
    ...
    public MediaPeriodHolder advancePlayingPeriod() {
        ...
        if (mediaPeriodHolder != null) {
            ...
            if (i == 0) {
                ...
                this.oldFrontPeriodWindowSequenceNumber = this.playing.f5125info.f4079id.windowSequenceNumber;
            }
    ...
    public void clear(boolean z) {
        ...
        if (frontPeriod != null) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = frontPeriod.f5125info.f4079id.windowSequenceNumber;
            frontPeriod.release();
    ...
    public boolean updateQueuedPeriods(long j, long j2) {
        ...
        while (frontPeriod != null) {
            MediaPeriodInfo mediaPeriodInfo2 = frontPeriod.f5125info;
            if (mediaPeriodHolder == null) {
            ...
            frontPeriod.f5125info = mediaPeriodInfo.copyWithContentPositionUs(mediaPeriodInfo2.contentPositionUs);
    ...
    public MediaPeriodInfo getUpdatedMediaPeriodInfo(MediaPeriodInfo mediaPeriodInfo) {
        long durationUs;
        MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodInfo.f4079id;
        ...
        this.timeline.getPeriodByUid(mediaPeriodInfo.f4079id.periodUid, this.period);
    ...
    private long resolvePeriodIndexToWindowSequenceNumber(Object obj) {
        ...
        for (MediaPeriodHolder frontPeriod = getFrontPeriod(); frontPeriod != null; frontPeriod = frontPeriod.getNext()) {
            if (frontPeriod.uid.equals(obj)) {
                return frontPeriod.f5125info.f4079id.windowSequenceNumber;
            }
        }
        for (MediaPeriodHolder frontPeriod2 = getFrontPeriod(); frontPeriod2 != null; frontPeriod2 = frontPeriod2.getNext()) {
            ...
            if (indexOfPeriod2 != -1 && this.timeline.getPeriod(indexOfPeriod2, this.period).windowIndex == i) {
                return frontPeriod2.f5125info.f4079id.windowSequenceNumber;
            }
        }
    ...
    private boolean canKeepMediaPeriodHolder(MediaPeriodInfo mediaPeriodInfo, MediaPeriodInfo mediaPeriodInfo2) {
        return mediaPeriodInfo.startPositionUs == mediaPeriodInfo2.startPositionUs && mediaPeriodInfo.f4079id.equals(mediaPeriodInfo2.f4079id);
    }
    ...
    private boolean updateForPlaybackModeChange() {
        ...
        while (true) {
            ...
            while (frontPeriod.getNext() != null && !frontPeriod.f5125info.isLastInTimelinePeriod) {
                frontPeriod = frontPeriod.getNext();
            }
            ...
            if (indexOfPeriod == -1 || next == null || this.timeline.getIndexOfPeriod(next.uid) != indexOfPeriod) {
                ...
                frontPeriod.f5125info = getUpdatedMediaPeriodInfo(frontPeriod.f5125info);
            } else {
                frontPeriod = next;
            }
        }
    ...
    private MediaPeriodInfo getFollowingMediaPeriodInfo(MediaPeriodHolder mediaPeriodHolder, long j) {
        ...
        Object obj;
        long j4;
        MediaPeriodInfo mediaPeriodInfo = mediaPeriodHolder.f5125info;
        long rendererOffset = (mediaPeriodHolder.getRendererOffset() + mediaPeriodInfo.durationUs) - j;
        long j5 = 0;
        if (mediaPeriodInfo.isLastInTimelinePeriod) {
            int indexOfPeriod = this.timeline.getIndexOfPeriod(mediaPeriodInfo.f4079id.periodUid);
            ...
            long j6 = mediaPeriodInfo.f4079id.windowSequenceNumber;
            if (this.timeline.getWindow(i, this.window).firstPeriodIndex == nextPeriodIndex) {
                ...
                if (next == null || !next.uid.equals(obj3)) {
                    ...
                    j4 = next.f5125info.f4079id.windowSequenceNumber;
                }
                j5 = longValue;
                j3 = j4;
                obj = obj3;
