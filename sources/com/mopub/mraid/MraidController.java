...
public class MraidController {
    ...
    public void onShow(Activity activity) {
        ...
        try {
            ...
            MoPubLog.m332d("Failed to apply orientation.");
        }
    }
    ...
    public boolean shouldAllowForceOrientation(MraidOrientation mraidOrientation) {
        ...
        try {
            ...
            if (i != -1) {
                ...
                return false;
            } else if (!C0421Utils.bitMaskContainsFlag(activityInfo.configChanges, 128) || !C0421Utils.bitMaskContainsFlag(activityInfo.configChanges, 1024)) {
                return false;
            } else {
                return true;
            }
