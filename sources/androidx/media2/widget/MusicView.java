...
class MusicView extends ViewGroup {
    ...
    public void setAlbumDrawable(Drawable drawable) {
        ...
        for (int i = 0; i < childCount; i++) {
            ImageView imageView = (ImageView) getChildAt(i).findViewById(C4412R.C4415id.album);
            if (imageView != null) {
    ...
    public void setTitleText(String str) {
        int childCount = getChildCount();
        for (int i = 0; i < childCount; i++) {
            TextView textView = (TextView) getChildAt(i).findViewById(C4412R.C4415id.title);
            if (textView != null) {
    ...
    public void setArtistText(String str) {
        int childCount = getChildCount();
        for (int i = 0; i < childCount; i++) {
            TextView textView = (TextView) getChildAt(i).findViewById(C4412R.C4415id.artist);
            if (textView != null) {
                textView.setText(str);
            }
        }
    ...
    private void inflateLayout() {
        ...
        this.mWithTitleLandscape = layoutInflater.inflate(C4412R.layout.music_with_title_landscape, (ViewGroup) null);
        this.mWithTitlePortrait = layoutInflater.inflate(C4412R.layout.music_with_title_portrait, (ViewGroup) null);
        this.mWithoutTitle = layoutInflater.inflate(C4412R.layout.music_without_title, (ViewGroup) null);
