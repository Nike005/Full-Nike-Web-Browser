...
abstract class MemberUtils {
    ...
    static int compareConstructorFit(Constructor<?> constructor, Constructor<?> constructor2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m6091of(constructor), Executable.m6091of(constructor2), clsArr);
    }

    static int compareMethodFit(Method method, Method method2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m6092of(method), Executable.m6092of(method2), clsArr);
    }
    ...
    static boolean isMatchingMethod(Method method, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m6092of(method), clsArr);
    }

    static boolean isMatchingConstructor(Constructor<?> constructor, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m6091of(constructor), clsArr);
    }
    ...
    private static final class Executable {
        ...
        /* renamed from: of */
        public static Executable m6092of(Method method) {
            return new Executable(method);
        }

        /* access modifiers changed from: private */
        /* renamed from: of */
        public static Executable m6091of(Constructor<?> constructor) {
