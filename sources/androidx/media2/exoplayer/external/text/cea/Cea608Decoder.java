...
public final class Cea608Decoder extends CeaDecoder {
    ...
    public Cea608Decoder(String str, int i) {
        ...
        if (i == 1) {
            ...
            Log.m6210w(TAG, "Invalid channel. Defaulting to CC1.");
            this.selectedChannel = 0;
            this.selectedField = 0;
        } else {
            this.selectedChannel = 1;
                        ...
                        if (!zArr[readUnsignedByte] || !zArr[readUnsignedByte2]) {
                            ...
                            if (this.isInCaptionService) {
                                if ((b2 & 247) == 17 && (b3 & 240) == 48) {
                                    if (getChannel(b2) == this.selectedChannel) {
    ...
    private void handleCtrl(byte b, byte b2, boolean z) {
        ...
        if (this.currentChannel == this.selectedChannel) {
            if (isMidrowCtrlCode(b, b2)) {
                ...
                int unused = this.currentCueBuilder.tabOffset = b2 - 32;
