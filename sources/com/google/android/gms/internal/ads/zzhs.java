...
public final class zzhs {
    ...
    private final synchronized void zzb(zzhu.zza.zzb zzb) {
        ...
        zzakb.m43v(valueOf.length() != 0 ? "Logging Event with event code : ".concat(valueOf) : new String("Logging Event with event code : "));
    }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        zzakb.m43v("Could not close Clearcut output stream.");
                    }
                } catch (IOException unused2) {
                    zzakb.m43v("Could not write Clearcut to file.");
                    try {
                        fileOutputStream.close();
                ...
                zzakb.m43v("Could not find file for Clearcut");
            } catch (Throwable th) {
                try {
                    fileOutputStream.close();
        ...
        while (true) {
            ...
            while (i < length) {
                try {
                    ...
                    zzakb.m43v("Experiment ID is not a number");
                }
                i++;
            }
        }
