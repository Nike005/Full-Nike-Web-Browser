        ...
        for (int i = 0; i < this.numCues; i++) {
            ...
            if (jArr[i2] <= j && j < jArr[i2 + 1]) {
                ...
                if (!webvttCue2.isNormalCue()) {
                    ...
                    spannableStringBuilder.append(webvttCue.text).append(StringUtils.f3949LF).append(webvttCue2.text);
                } else {
                    spannableStringBuilder.append(StringUtils.f3949LF).append(webvttCue2.text);
                }
            }
        }
