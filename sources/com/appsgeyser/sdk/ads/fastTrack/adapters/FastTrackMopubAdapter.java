...
public class FastTrackMopubAdapter extends FastTrackBaseAdapter {
    ...
    public void initBannerView(final ViewGroup viewGroup, String str) {
        ...
        if (str2 != null && !str2.isEmpty() && bannerViewRefreshRate.intValue() != 0) {
            ...
            this.noFillPlaceholder.setImageResource(C5051R.C5053drawable.appsgeysersdk_banner_placeholder);
                ...
                public void onBannerClicked(MoPubView moPubView) {
                    if (!FastTrackMopubAdapter.this.bannerClickReportedRecently) {
                        ...
                        FastTrackMopubAdapter.this.handler.postDelayed(new Runnable() {
                            public final void run() {
                                FastTrackMopubAdapter.C50672.this.lambda$onBannerClicked$0$FastTrackMopubAdapter$2();
                            }
                        }, 1000);
        ...
        if (str != null && !str.isEmpty()) {
            ...
            this.interstitialAd.setInterstitialAdListener(new MoPubInterstitial.InterstitialAdListener() {
                public void onInterstitialLoaded(MoPubInterstitial moPubInterstitial) {
                    if (FastTrackMopubAdapter.this.pendingFullscreenRequest && FastTrackMopubAdapter.this.isInForeground) {
                        ...
                        FastTrackMopubAdapter.this.handler.postDelayed(new Runnable(appsgeyserProgressDialog) {
                            ...
                            public final void run() {
                                FastTrackMopubAdapter.C50705.this.lambda$onInterstitialLoaded$0$FastTrackMopubAdapter$5(this.f$1);
                            }
                        }, 2000);
                    }
                ...
                public void onInterstitialFailed(MoPubInterstitial moPubInterstitial, MoPubErrorCode moPubErrorCode) {
                    ...
                    FastTrackMopubAdapter.this.handler.postDelayed(new Runnable() {
                        public final void run() {
                            FastTrackMopubAdapter.C50705.this.lambda$onInterstitialFailed$1$FastTrackMopubAdapter$5();
                        }
                    }, 30000);
    ...
    public void showFullscreen(String str, String str2, boolean z) {
        if (!z || System.currentTimeMillis() - this.preferencesCoder.getPrefLong(Constants.PREFS_APPSGEYSER_FULLSCREEN_LAST_REQUEST_TIMING, 0) > ((long) getFullscreenFrequencyTimerValue().intValue())) {
            ...
            Log.d(FastTrackAdsController.fastTrackLogTag, "mopub fullscreen show request was cancelled due to frequency timing settings");
        }
    }
                ...
                public void onRewardedVideoLoadFailure(String str, MoPubErrorCode moPubErrorCode) {
                    ...
                    if (FastTrackMopubAdapter.this.rewardedVideoListener != null) {
                        if (FastTrackMopubAdapter.this.videoShowRequested) {
                            FastTrackMopubAdapter.this.rewardedVideoListener.onVideoError(FastTrackMopubAdapter.this.context.getResources().getString(C5051R.string.appsgeysersdk_fasttrack_no_rew_video));
                    ...
                    FastTrackMopubAdapter.this.handler.postDelayed(new Runnable() {
                        public final void run() {
                            FastTrackMopubAdapter.C50716.this.lambda$onRewardedVideoLoadFailure$0$FastTrackMopubAdapter$6();
                        }
                    }, 30000);
