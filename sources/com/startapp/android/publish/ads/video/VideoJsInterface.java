...
public class VideoJsInterface extends JsInterface {
    ...
    public VideoJsInterface(Context context, Runnable runnable, Runnable runnable2, Runnable runnable3, Runnable runnable4, Runnable runnable5, C1117b bVar, boolean z) {
    ...
    public void replayVideo() {
        C1270g.m2078a(TAG, 3, "replayVideo called");
    ...
    public void skipVideo() {
        C1270g.m2078a(TAG, 3, "skipVideo called");
    ...
    public void toggleSound() {
        C1270g.m2078a(TAG, 3, "toggleSound called");
