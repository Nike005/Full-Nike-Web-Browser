...
public abstract class AppnextAdMobCustomEvent implements CustomEventInterstitial {
    ...
    public abstract C4924Ad createAd(Context context, String str, Bundle bundle);
    ...
    public void requestInterstitialAd(Context context, CustomEventInterstitialListener customEventInterstitialListener, String str, MediationAdRequest mediationAdRequest, Bundle bundle) {
        try {
            C4924Ad createAd = createAd(context, str, bundle);
            this.mAd = createAd;
            if (createAd == null) {
            ...
            this.mAd.setOnAdErrorCallback(new OnAdError() {
                ...
                public void adError(java.lang.String r6) {
                    ...
                    L_0x004d:
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.appnext.sdk.adapters.admob.ads.AppnextAdMobCustomEvent.C50235.adError(java.lang.String):void");
                }
            });
            this.mAd.loadAd();
        } catch (Throwable th) {
