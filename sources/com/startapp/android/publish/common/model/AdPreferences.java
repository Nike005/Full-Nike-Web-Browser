...
public class AdPreferences implements Serializable {
    ...
    /* renamed from: ai */
    private Boolean f1417ai = null;

    /* renamed from: as */
    private Boolean f1418as = null;
    ...
    private boolean hardwareAccelerated = C1174m.m1649a().mo14993d();
    ...
    protected C1040Ad.AdType type = null;
    ...
    public AdPreferences(AdPreferences adPreferences) {
        ...
        this.f1417ai = adPreferences.f1417ai;
        this.f1418as = adPreferences.f1418as;
    ...
    public SDKAdPreferences.Gender getGender(Context context) {
        ...
        return gender2 == null ? C1174m.m1649a().mo15000g(context).getGender() : gender2;
    }
    ...
    public String getAge(Context context) {
        String str = this.age;
        return str == null ? C1174m.m1649a().mo15000g(context).getAge() : str;
    }
    ...
    public boolean equals(Object obj) {
        ...
        Boolean bool = this.f1417ai;
        if (bool == null ? adPreferences.f1417ai != null : !bool.equals(adPreferences.f1417ai)) {
            return false;
        }
        Boolean bool2 = this.f1418as;
        if (bool2 == null ? adPreferences.f1418as != null : !bool2.equals(adPreferences.f1418as)) {
            return false;
        }
