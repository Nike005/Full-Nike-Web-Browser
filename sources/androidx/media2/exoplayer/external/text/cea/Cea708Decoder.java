...
public final class Cea708Decoder extends CeaDecoder {
            ...
            if ((i == 2 || i == 3) && z2) {
                if (i == 3) {
                    ...
                    if (dtvCcPacket3 == null) {
                        Log.m6206e(TAG, "Encountered DTVCC_PACKET_DATA before DTVCC_PACKET_START");
                    } else {
    ...
    private void handleC1Command(int r5) {
        ...
        L_0x0022:
            ...
            r4.currentWindow = r5
            androidx.media2.exoplayer.external.text.cea.Cea708Decoder$CueBuilder[] r0 = r4.cueBuilders
            r5 = r0[r5]
            r4.currentCueBuilder = r5
            goto L_0x0119
        L_0x0035:
            androidx.media2.exoplayer.external.text.cea.Cea708Decoder$CueBuilder r5 = r4.currentCueBuilder
            boolean r5 = r5.isDefined()
            if (r5 != 0) goto L_0x0046
            androidx.media2.exoplayer.external.util.ParsableBitArray r5 = r4.serviceBlockPacket
            r0 = 32
            r5.skipBits(r0)
            goto L_0x0119
        L_0x0046:
        ...
        L_0x0095:
            ...
            androidx.media2.exoplayer.external.text.cea.Cea708Decoder$CueBuilder[] r5 = r4.cueBuilders
            int r0 = 8 - r2
            r5 = r5[r0]
            r5.reset()
        L_0x00a8:
        ...
        L_0x00ac:
            ...
            androidx.media2.exoplayer.external.util.ParsableBitArray r0 = r4.serviceBlockPacket
        ...
        L_0x0119:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.exoplayer.external.text.cea.Cea708Decoder.handleC1Command(int):void");
    }
    ...
    private void handleG2Character(int i) {
        if (i == 32) {
            ...
            this.currentCueBuilder.append(Typography.f3942tm);
        } else if (i == 58) {
    ...
    private static final class CueBuilder {
        ...
        public androidx.media2.exoplayer.external.text.cea.Cea708Cue build() {
            ...
            L_0x00a9:
                ...
                r0 = 1
            L_0x00b0:
                androidx.media2.exoplayer.external.text.cea.Cea708Cue r13 = new androidx.media2.exoplayer.external.text.cea.Cea708Cue
                r5 = 0
                r11 = 1
        ...
        public static int getArgbColorFromCeaColor(int r4, int r5, int r6, int r7) {
            /*
                r0 = 0
                r1 = 4
                androidx.media2.exoplayer.external.util.Assertions.checkIndex(r4, r0, r1)
                androidx.media2.exoplayer.external.util.Assertions.checkIndex(r5, r0, r1)
                androidx.media2.exoplayer.external.util.Assertions.checkIndex(r6, r0, r1)
                androidx.media2.exoplayer.external.util.Assertions.checkIndex(r7, r0, r1)
                r1 = 1
