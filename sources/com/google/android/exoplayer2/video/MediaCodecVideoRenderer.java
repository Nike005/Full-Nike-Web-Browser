...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
    ...
    public MediaCodecVideoRenderer(Context context2, MediaCodecSelector mediaCodecSelector, long j, boolean z, Handler handler, VideoRendererEventListener videoRendererEventListener, int i) {
        this(context2, mediaCodecSelector, j, (DrmSessionManager<FrameworkMediaCrypto>) null, false, z, handler, videoRendererEventListener, i);
    }
    ...
    public void onStreamChanged(Format[] formatArr, long j) throws ExoPlaybackException {
        if (this.outputStreamOffsetUs == -9223372036854775807L) {
            ...
            if (i == this.pendingOutputStreamOffsetsUs.length) {
                Log.m9w(TAG, "Too many stream changes, so dropping offset: " + this.pendingOutputStreamOffsetsUs[this.pendingOutputStreamOffsetCount - 1]);
            } else {
    ...
    public CodecMaxValues getCodecMaxValues(MediaCodecInfo mediaCodecInfo, Format format, Format[] formatArr) {
        ...
        if (z) {
            Log.m9w(TAG, "Resolutions unknown. Codec max resolution: " + i + AvidJSONUtil.KEY_X + i2);
            ...
            if (codecMaxSize != null) {
                ...
                Log.m9w(TAG, "Codec max resolution adjusted to: " + i + AvidJSONUtil.KEY_X + i2);
            }
        }
        return new CodecMaxValues(i, i2, maxInputSize);
    }
