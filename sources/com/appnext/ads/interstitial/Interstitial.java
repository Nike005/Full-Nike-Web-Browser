...
import com.appnext.core.webview.C5018a;
import java.io.IOException;
import java.util.ArrayList;
import java.util.HashMap;

public class Interstitial extends C4924Ad {
    ...
    private void init() {
        loadConfig();
        AppnextWebView.m6957u(this.context).mo41343a(getPageUrl(), (AppnextWebView.C5017c) null);
        super.setOnAdErrorCallback(new OnAdError() {
            ...
            public final void adError(java.lang.String r11) {
                ...
                L_0x006b:
                    ...
                    java.lang.String r8 = ""
                    java.lang.String r9 = ""
                    com.appnext.core.C4967f.m6822a((java.lang.String) r1, (java.lang.String) r2, (java.lang.String) r3, (java.lang.String) r4, (java.lang.String) r5, (java.lang.String) r6, (java.lang.String) r7, (java.lang.String) r8, (java.lang.String) r9)
                    com.appnext.ads.interstitial.Interstitial r0 = com.appnext.ads.interstitial.Interstitial.this
                ...
                L_0x00a3:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.appnext.ads.interstitial.Interstitial.C47651.adError(java.lang.String):void");
            }
        });
    }
    ...
    public void loadAd() {
        ...
        } else if (C4967f.m6823a(this.context, "android.permission.INTERNET")) {
            new Thread(new Runnable() {
                public final void run() {
                    try {
                        ...
                        Interstitial.this.getConfig().mo41298a(Interstitial.this.context, (C4986p.C4988a) new C4986p.C4988a() {
                            /* renamed from: b */
    ...
    /* access modifiers changed from: private */
    public void load() {
        C4793a.m6403G().mo40777a(this.context, this, getPlacementID(), new C4948d.C4955a() {
            /* renamed from: a */
            public final <T> void mo40599a(T t) {
                AppnextAd appnextAd;
                try {
                    appnextAd = C4793a.m6403G().mo40775a(Interstitial.this.context, (ArrayList<AppnextAd>) (ArrayList) t, Interstitial.this.getCreative(), (C4924Ad) Interstitial.this);
                } catch (Throwable unused) {
                    if (Interstitial.this.getOnAdErrorCallback() != null) {
    ...
    public void showAd() {
        if (getPlacementID().equals("")) {
            ...
            int Z = C4967f.m6810Z(getConfig().get("min_internet_connection"));
            int Z2 = C4967f.m6810Z(C4967f.m6849o(this.context));
            if (Z2 == -1) {
                ...
                currentAd = this;
                if (C4793a.m6403G().mo40779d(this)) {
    ...
    public void getECPM(final OnECPMLoaded onECPMLoaded) {
        if (onECPMLoaded != null) {
            C4793a.m6403G().mo41239a(this.context, (C4924Ad) this, getPlacementID(), (C4948d.C4955a) new C4948d.C4955a() {
                /* renamed from: a */
                public final <T> void mo40599a(T t) {
                    AppnextAd a = C4793a.m6403G().mo40775a(Interstitial.this.context, (ArrayList<AppnextAd>) (ArrayList) t, Interstitial.this.getCreative(), (C4924Ad) Interstitial.this);
                    if (a != null) {
    ...
    public String getCreative() {
        int Z = C4967f.m6810Z(getConfig().get("min_internet_connection"));
        int Z2 = C4967f.m6810Z(getConfig().get("min_internet_connection_video"));
        int Z3 = C4967f.m6810Z(C4967f.m6849o(this.context));
        if (Z3 < Z || Z3 >= Z2) {
    ...
    public boolean isAdLoaded() {
        return !getPlacementID().equals("") && C4793a.m6403G().mo40779d(this);
    }

    /* access modifiers changed from: protected */
    public C4986p getConfig() {
        return C4795c.m6424K();
    }

    private void loadConfig() {
        getConfig().mo41305q("tid", getTID());
        getConfig().mo41298a(this.context, (C4986p.C4988a) new C4986p.C4988a() {
            /* renamed from: b */
            public final void mo40595b(HashMap<String, Object> hashMap) {
                boolean unused = Interstitial.this.configLoaded = true;
                C4975j.m6859bj().mo41286b(Integer.parseInt(Interstitial.this.getConfig().get("banner_expiration_time")));
