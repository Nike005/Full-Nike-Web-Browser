...
public class BluetoothCrashResolver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("android.bluetooth.adapter.action.DISCOVERY_FINISHED")) {
                if (BluetoothCrashResolver.this.recoveryInProgress) {
                    LogManager.m6046d(BluetoothCrashResolver.TAG, "Bluetooth discovery finished", new Object[0]);
                    BluetoothCrashResolver.this.finishRecovery();
                } else {
                    LogManager.m6046d(BluetoothCrashResolver.TAG, "Bluetooth discovery finished (external)", new Object[0]);
                }
            }
            if (action.equals("android.bluetooth.adapter.action.DISCOVERY_STARTED")) {
                if (BluetoothCrashResolver.this.recoveryInProgress) {
                    boolean unused = BluetoothCrashResolver.this.discoveryStartConfirmed = true;
                    LogManager.m6046d(BluetoothCrashResolver.TAG, "Bluetooth discovery started", new Object[0]);
                } else {
                    LogManager.m6046d(BluetoothCrashResolver.TAG, "Bluetooth discovery started (external)", new Object[0]);
                }
            }
            if (action.equals("android.bluetooth.adapter.action.STATE_CHANGED")) {
                ...
                if (intExtra != Integer.MIN_VALUE) {
                    switch (intExtra) {
                        case 10:
                            LogManager.m6046d(BluetoothCrashResolver.TAG, "Bluetooth state is OFF", new Object[0]);
                        ...
                        case 11:
                            ...
                            LogManager.m6046d(BluetoothCrashResolver.TAG, "Bluetooth state is TURNING_ON", new Object[0]);
                            return;
                        case 12:
                            LogManager.m6046d(BluetoothCrashResolver.TAG, "Bluetooth state is ON", new Object[0]);
                            LogManager.m6046d(BluetoothCrashResolver.TAG, "Bluetooth was turned off for %s milliseconds", Long.valueOf(BluetoothCrashResolver.this.lastBluetoothTurningOnTime - BluetoothCrashResolver.this.lastBluetoothOffTime));
                    ...
                    LogManager.m6046d(BluetoothCrashResolver.TAG, "Bluetooth state is ERROR", new Object[0]);
                }
            }
        }
    };
    ...
    public BluetoothCrashResolver(Context context2) {
        ...
        LogManager.m6046d(TAG, "constructed", new Object[0]);
        loadState();
    }
    ...
    public void start() {
        ...
        LogManager.m6046d(TAG, "started listening for BluetoothAdapter events", new Object[0]);
    }

    public void stop() {
        this.context.unregisterReceiver(this.receiver);
        LogManager.m6046d(TAG, "stopped listening for BluetoothAdapter events", new Object[0]);
        saveState();
    }
    ...
    public void notifyScannedDevice(BluetoothDevice bluetoothDevice, BluetoothAdapter.LeScanCallback leScanCallback) {
        ...
        if (size != size2 && size2 % 100 == 0) {
            LogManager.m6046d(TAG, "Distinct Bluetooth devices seen: %s", Integer.valueOf(this.distinctBluetoothAddresses.size()));
        }
        if (this.distinctBluetoothAddresses.size() > getCrashRiskDeviceCount() && !this.recoveryInProgress) {
            LogManager.m6054w(TAG, "Large number of Bluetooth devices detected: %s Proactively attempting to clear out address list to prevent a crash", Integer.valueOf(this.distinctBluetoothAddresses.size()));
            LogManager.m6054w(TAG, "Stopping LE Scan", new Object[0]);
    ...
    public void crashDetected() {
        if (Build.VERSION.SDK_INT < 18) {
            LogManager.m6046d(TAG, "Ignoring crashes before API 18, because BLE is unsupported.", new Object[0]);
            return;
        }
        LogManager.m6054w(TAG, "BluetoothService crash detected", new Object[0]);
        if (this.distinctBluetoothAddresses.size() > 0) {
            LogManager.m6046d(TAG, "Distinct Bluetooth devices seen at crash: %s", Integer.valueOf(this.distinctBluetoothAddresses.size()));
        }
        this.lastBluetoothCrashDetectionTime = SystemClock.elapsedRealtime();
        this.detectedCrashCount++;
        if (this.recoveryInProgress) {
            LogManager.m6046d(TAG, "Ignoring Bluetooth crash because recovery is already in progress.", new Object[0]);
        } else {
            startRecovery();
        }
        processStateChange();
    ...
    private void startRecovery() {
        ...
        LogManager.m6046d(TAG, "about to check if discovery is active", new Object[0]);
        if (!defaultAdapter.isDiscovering()) {
            LogManager.m6054w(TAG, "Recovery attempt started", new Object[0]);
            this.recoveryInProgress = true;
            this.discoveryStartConfirmed = false;
            LogManager.m6046d(TAG, "about to command discovery", new Object[0]);
            if (!defaultAdapter.startDiscovery()) {
                LogManager.m6054w(TAG, "Can't start discovery.  Is Bluetooth turned on?", new Object[0]);
            }
            LogManager.m6046d(TAG, "startDiscovery commanded.  isDiscovering()=%s", Boolean.valueOf(defaultAdapter.isDiscovering()));
            LogManager.m6046d(TAG, "We will be cancelling this discovery in %s milliseconds.", 5000);
            cancelDiscovery();
            return;
        }
        LogManager.m6054w(TAG, "Already discovering.  Recovery attempt abandoned.", new Object[0]);
    }

    /* access modifiers changed from: private */
    public void finishRecovery() {
        LogManager.m6054w(TAG, "Recovery attempt finished", new Object[0]);
        synchronized (this.distinctBluetoothAddresses) {
    ...
    private void saveState() {
        ...
        L_0x0091:
            ...
            org.altbeacon.beacon.logging.LogManager.m6054w(r3, r4, r5)     // Catch:{ all -> 0x008f }
        ...
        L_0x00a3:
            ...
            r0[r1] = r4
            org.altbeacon.beacon.logging.LogManager.m6046d(r2, r3, r0)
            return
        L_0x00b9:
    ...
    private void loadState() {
        ...
        L_0x0066:
            ...
            org.altbeacon.beacon.logging.LogManager.m6054w(r0, r5, r6)     // Catch:{ all -> 0x0064 }
        ...
        L_0x0081:
            ...
            org.altbeacon.beacon.logging.LogManager.m6046d(r0, r2, r1)
            return
        L_0x0095:
    ...
    private void cancelDiscovery() {
        try {
            ...
            if (!this.discoveryStartConfirmed) {
                LogManager.m6054w(TAG, "BluetoothAdapter.ACTION_DISCOVERY_STARTED never received.  Recovery may fail.", new Object[0]);
            }
            BluetoothAdapter defaultAdapter = BluetoothAdapter.getDefaultAdapter();
            if (defaultAdapter.isDiscovering()) {
                LogManager.m6046d(TAG, "Cancelling discovery", new Object[0]);
                defaultAdapter.cancelDiscovery();
                return;
            }
            LogManager.m6046d(TAG, "Discovery not running.  Won't cancel it", new Object[0]);
        } catch (InterruptedException unused) {
            LogManager.m6046d(TAG, "DiscoveryCanceller sleep interrupted.", new Object[0]);
        }
    }
}
