...
class C0330n extends Exception {

    /* renamed from: a */
    private static final Long f165a = 60000L;

    /* renamed from: b */
    private static Long f166b;

    /* renamed from: c */
    private static Exception f167c = null;
    ...
    /* renamed from: a */
    static String m212a(String str, Exception exc) {
        if (exc instanceof C0330n) {
    ...
    /* renamed from: a */
    static void m214a(Exception exc) {
    ...
    private static void m215b(java.lang.Exception r13) {
        /*
            java.lang.String r0 = ""
            com.moat.analytics.mobile.mpub.w r1 = com.moat.analytics.mobile.mpub.C0351w.m264a()     // Catch:{ Exception -> 0x01b0 }
            com.moat.analytics.mobile.mpub.w$d r1 = r1.f197a     // Catch:{ Exception -> 0x01b0 }
            com.moat.analytics.mobile.mpub.w$d r2 = com.moat.analytics.mobile.mpub.C0351w.C0359d.ON     // Catch:{ Exception -> 0x01b0 }
            if (r1 != r2) goto L_0x01ae
            com.moat.analytics.mobile.mpub.w r1 = com.moat.analytics.mobile.mpub.C0351w.m264a()     // Catch:{ Exception -> 0x01b0 }
            int r1 = r1.f201e     // Catch:{ Exception -> 0x01b0 }
        ...
        L_0x0029:
            ...
            boolean r4 = r13 instanceof com.moat.analytics.mobile.mpub.C0330n     // Catch:{ Exception -> 0x01b0 }
            r5 = 1
            r6 = 0
        ...
        L_0x00b4:
            ...
            com.moat.analytics.mobile.mpub.s$a r2 = com.moat.analytics.mobile.mpub.C0339s.m241c()     // Catch:{ Exception -> 0x00e4 }
            ...
            java.lang.String r7 = r2.mo10460a()     // Catch:{ Exception -> 0x00e4 }
            r4.append(r7)     // Catch:{ Exception -> 0x00e4 }
            java.lang.String r4 = r4.toString()     // Catch:{ Exception -> 0x00e4 }
            r3.append(r4)     // Catch:{ Exception -> 0x00e4 }
            java.lang.String r2 = r2.mo10461b()     // Catch:{ Exception -> 0x00e4 }
        ...
        L_0x00eb:
            ...
            r3.append(r0)     // Catch:{ Exception -> 0x01b0 }
            java.lang.Long r0 = f166b     // Catch:{ Exception -> 0x01b0 }
            if (r0 == 0) goto L_0x01a4
            long r0 = r13.longValue()     // Catch:{ Exception -> 0x01b0 }
            java.lang.Long r2 = f166b     // Catch:{ Exception -> 0x01b0 }
            long r4 = r2.longValue()     // Catch:{ Exception -> 0x01b0 }
            long r0 = r0 - r4
            java.lang.Long r2 = f165a     // Catch:{ Exception -> 0x01b0 }
            long r4 = r2.longValue()     // Catch:{ Exception -> 0x01b0 }
            int r2 = (r0 > r4 ? 1 : (r0 == r4 ? 0 : -1))
            if (r2 <= 0) goto L_0x01b0
        L_0x01a4:
            java.lang.String r0 = r3.toString()     // Catch:{ Exception -> 0x01b0 }
            com.moat.analytics.mobile.mpub.C0337q.m235b(r0)     // Catch:{ Exception -> 0x01b0 }
            f166b = r13     // Catch:{ Exception -> 0x01b0 }
            goto L_0x01b0
        L_0x01ae:
            f167c = r13     // Catch:{ Exception -> 0x01b0 }
        L_0x01b0:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.moat.analytics.mobile.mpub.C0330n.m215b(java.lang.Exception):void");
    }
}
