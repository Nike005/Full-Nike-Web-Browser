...
class VastResource implements Serializable {
    ...
    /* renamed from: com.mopub.mobileads.VastResource$1 */
    static /* synthetic */ class C04871 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.mobileads.VastResource.C04871.<clinit>():void");
        }
    }

    public String getCorrectClickThroughUrl(String str, String str2) {
        int i = C04871.$SwitchMap$com$mopub$mobileads$VastResource$Type[this.mType.ordinal()];
        if (i != 1) {
            if (i == 2 || i == 3) {
                return str2;
            }
