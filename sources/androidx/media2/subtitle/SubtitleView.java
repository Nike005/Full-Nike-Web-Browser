...
class SubtitleView extends View {
    ...
    SubtitleView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mCornerRadius = (float) resources.getDimensionPixelSize(C3861R.dimen.subtitle_corner_radius);
        ...
        float dimensionPixelSize = (float) resources.getDimensionPixelSize(C3861R.dimen.subtitle_shadow_offset);
