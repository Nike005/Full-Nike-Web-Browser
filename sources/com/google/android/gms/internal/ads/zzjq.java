...
import com.google.android.gms.ads.C0058R;
...
public final class zzjq {
    ...
    public zzjq(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0058R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C0058R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C0058R.styleable.AdsAttrs_adSizes);
        ...
        String string3 = obtainAttributes.getString(C0058R.styleable.AdsAttrs_adUnitId);
        this.zzye = string3;
