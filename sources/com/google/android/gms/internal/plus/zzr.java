...
public final class zzr extends FastSafeParcelableJsonResponse implements Person {
    ...
    public static final class zzb extends FastSafeParcelableJsonResponse implements Person.Cover {
        ...
        public static final class C5311zzb extends FastSafeParcelableJsonResponse implements Person.Cover.CoverPhoto {
            public static final Parcelable.Creator<C5311zzb> CREATOR = new zzw();
            private static final HashMap<String, FastJsonResponse.Field<?, ?>> zzao;
            private final Set<Integer> zzap;
            private int zzbu;
            private int zzbv;
            ...
            C5311zzb(Set<Integer> set, int i, int i2, String str, int i3) {
                this.zzap = set;
                this.zzw = i;
                this.zzbu = i2;
                this.zzk = str;
            ...
            public final boolean equals(Object obj) {
                if (!(obj instanceof C5311zzb)) {
                    return false;
                }
                if (this == obj) {
                    return true;
                }
                C5311zzb zzb = (C5311zzb) obj;
                for (FastJsonResponse.Field next : zzao.values()) {
                    if (isFieldSet(next)) {
        ...
        static {
            ...
            zzao.put("coverPhoto", FastJsonResponse.Field.forConcreteType("coverPhoto", 3, C5311zzb.class));
        ...
        zzb(Set<Integer> set, int i, zza zza2, C5311zzb zzb, int i2) {
            this.zzap = set;
            this.zzw = i;
            this.zzbp = zza2;
            this.zzbq = zzb;
