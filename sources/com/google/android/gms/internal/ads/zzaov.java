...
public final class zzaov extends zzapg implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, TextureView.SurfaceTextureListener {
    ...
    private final void zzag(boolean z) {
        zzakb.m43v("AdMediaPlayerView release");
    ...
    private final void zzsq() {
        zzakb.m43v("AdMediaPlayerView init MediaPlayer");
    ...
    private final void zzsr() {
        ...
        L_0x0005:
            ...
            com.google.android.gms.internal.ads.zzakb.m43v(r0)
            r0 = 0
            r8.zza((float) r0)
            android.media.MediaPlayer r0 = r8.zzcwt
            r0.start()
    ...
    public final void onCompletion(MediaPlayer mediaPlayer) {
        zzakb.m43v("AdMediaPlayerView completion");
        zzag(5);
        this.zzcws = 5;
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        zzakb.m43v("AdMediaPlayerView prepared");
        zzag(2);
        this.zzcwp.zzsv();
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        zzakb.m43v("AdMediaPlayerView surface created");
        zzsq();
        zzakk.zzcrm.post(new zzapa(this));
    }

    public final boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        zzakb.m43v("AdMediaPlayerView surface destroyed");
        MediaPlayer mediaPlayer = this.zzcwt;
    ...
    public final void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
        zzakb.m43v("AdMediaPlayerView surface changed");
        boolean z = true;
    ...
    public final void pause() {
        zzakb.m43v("AdMediaPlayerView pause");
    ...
    public final void play() {
        zzakb.m43v("AdMediaPlayerView play");
        if (zzss()) {
            this.zzcwt.start();
            zzag(3);
            this.zzcxk.zzsw();
    ...
    public final void stop() {
        zzakb.m43v("AdMediaPlayerView stop");
        MediaPlayer mediaPlayer = this.zzcwt;
        if (mediaPlayer != null) {
            mediaPlayer.stop();
            this.zzcwt.release();
