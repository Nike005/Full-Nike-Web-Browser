...
public final class Util {
    ...
    static final /* synthetic */ void lambda$getRendererCapabilities$1$Util(List list) {
    }
    ...
    public static boolean checkCleartextTrafficPermitted(Uri... uriArr) {
        ...
        for (Uri uri : uriArr) {
            if (Constants.HTTP.equals(uri.getScheme()) && !NetworkSecurityPolicy.getInstance().isCleartextTrafficPermitted((String) Assertions.checkNotNull(uri.getHost()))) {
                return false;
            }
        }
        return true;
    ...
    public static int binarySearchCeil(int[] r2, int r3, boolean r4, boolean r5) {
        ...
        L_0x0022:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.exoplayer.external.util.Util.binarySearchCeil(int[], int, boolean, boolean):int");
    }
    ...
    public static <T extends java.lang.Comparable<? super T>> int binarySearchCeil(java.util.List<? extends java.lang.Comparable<? super T>> r3, T r4, boolean r5, boolean r6) {
        ...
        L_0x0030:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.exoplayer.external.util.Util.binarySearchCeil(java.util.List, java.lang.Comparable, boolean, boolean):int");
    }
    ...
    public static long parseXsDateTime(String str) throws ParserException {
        ...
        return i != 0 ? timeInMillis - ((long) (i * BrowserActivity.ONE_MINUTE_BY_MILLISECONDS)) : timeInMillis;
    }
    ...
    public static java.util.UUID getDrmUuid(java.lang.String r5) {
        ...
        L_0x0044:
            ...
            return r5
        L_0x0046:
            java.util.UUID r5 = androidx.media2.exoplayer.external.C3875C.CLEARKEY_UUID
            return r5
        L_0x0049:
            java.util.UUID r5 = androidx.media2.exoplayer.external.C3875C.PLAYREADY_UUID
            return r5
        L_0x004c:
            java.util.UUID r5 = androidx.media2.exoplayer.external.C3875C.WIDEVINE_UUID
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.exoplayer.external.util.Util.getDrmUuid(java.lang.String):java.util.UUID");
    }
    ...
    public static int getDefaultBufferSize(int i) {
        switch (i) {
            ...
            case 1:
                return 3538944;
            case 2:
                return C3875C.DEFAULT_VIDEO_BUFFER_SIZE;
            case 3:
            case 4:
            case 5:
                return 131072;
    ...
    public static Point getPhysicalDisplaySize(Context context, Display display) {
        ...
        if (SDK_INT <= 28 && display.getDisplayId() == 0 && isTv(context)) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                String valueOf = String.valueOf(str);
                Log.m6206e(TAG, valueOf.length() != 0 ? "Invalid display size: ".concat(valueOf) : new String("Invalid display size: "));
            }
        }
    ...
    private static String getSystemProperty(String str) {
        try {
            ...
            String valueOf = String.valueOf(str);
            Log.m6207e(TAG, valueOf.length() != 0 ? "Failed to read system property ".concat(valueOf) : new String("Failed to read system property "), e);
            return null;
        }
    }
