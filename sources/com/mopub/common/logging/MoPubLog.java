...
public class MoPubLog {
    ...
    @Deprecated
    /* renamed from: c */
    public static void m330c(String str) {
        m331c(str, (Throwable) null);
    }

    @Deprecated
    /* renamed from: v */
    public static void m338v(String str) {
        m339v(str, (Throwable) null);
    }

    @Deprecated
    /* renamed from: d */
    public static void m332d(String str) {
        m333d(str, (Throwable) null);
    }

    @Deprecated
    /* renamed from: i */
    public static void m336i(String str) {
        m337i(str, (Throwable) null);
    }

    @Deprecated
    /* renamed from: w */
    public static void m340w(String str) {
        m341w(str, (Throwable) null);
    }

    @Deprecated
    /* renamed from: e */
    public static void m334e(String str) {
        m335e(str, (Throwable) null);
    }

    @Deprecated
    /* renamed from: c */
    public static void m331c(String str, Throwable th) {
        logDeprecated(str, th);
    }

    @Deprecated
    /* renamed from: v */
    public static void m339v(String str, Throwable th) {
        logDeprecated(str, th);
    }

    @Deprecated
    /* renamed from: d */
    public static void m333d(String str, Throwable th) {
        logDeprecated(str, th);
    }

    @Deprecated
    /* renamed from: i */
    public static void m337i(String str, Throwable th) {
        logDeprecated(str, th);
    }

    @Deprecated
    /* renamed from: w */
    public static void m341w(String str, Throwable th) {
        logDeprecated(str, th);
    }

    @Deprecated
    /* renamed from: e */
    public static void m335e(String str, Throwable th) {
        logDeprecated(str, th);
    }
    ...
    public enum SdkLogEvent implements MPLogEventType {
        ...
        public String getMessage(Object... objArr) {
            if (this == INIT_FINISHED && objArr.length > 0) {
                String delimitedString = Strings.getDelimitedString(objArr[0], StringUtils.f3949LF);
