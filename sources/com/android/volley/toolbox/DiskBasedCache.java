...
public class DiskBasedCache implements Cache {
    ...
    public synchronized void clear() {
        ...
        this.mEntries.clear();
        this.mTotalSize = 0;
        VolleyLog.m6228d("Cache cleared.", new Object[0]);
    }
    ...
    public synchronized com.android.volley.Cache.Entry get(java.lang.String r12) {
        ...
        L_0x004a:
            ...
            com.android.volley.VolleyLog.m6228d(r7, r5)     // Catch:{ all -> 0x008c }
    ...
    public synchronized void initialize() {
        /*
            ...
            com.android.volley.VolleyLog.m6229e(r0, r2)     // Catch:{ all -> 0x006f }
        L_0x0022:
            monitor-exit(r8)
            return
        L_0x0024:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x004b, code lost:
        com.android.volley.VolleyLog.m6228d("Could not clean up file %s", r0.getAbsolutePath());
     */
    ...
    public synchronized void put(java.lang.String r7, com.android.volley.Cache.Entry r8) {
        ...
        L_0x002f:
            ...
            com.android.volley.VolleyLog.m6228d(r7, r8)     // Catch:{ IOException -> 0x0045 }
        ...
        L_0x0045:
            ...
            com.android.volley.VolleyLog.m6228d(r7, r8)     // Catch:{ all -> 0x005a }
        L_0x0058:
            monitor-exit(r6)
            return
        L_0x005a:
    ...
    public synchronized void remove(String str) {
        ...
        removeEntry(str);
        if (!delete) {
            VolleyLog.m6228d("Could not delete cache entry for key=%s, filename=%s", str, getFilenameForKey(str));
        }
    }
    ...
    private void pruneIfNeeded(int i) {
        ...
        if (this.mTotalSize + j2 >= ((long) this.mMaxCacheSizeInBytes)) {
            if (VolleyLog.DEBUG) {
                VolleyLog.m6231v("Pruning old cache entries.", new Object[0]);
            }
            ...
            while (it.hasNext()) {
                ...
                if (getFileForKey(cacheHeader.key).delete()) {
                    ...
                    j = j2;
                    VolleyLog.m6228d("Could not delete cache entry for key=%s, filename=%s", cacheHeader.key, getFilenameForKey(cacheHeader.key));
                }
                it.remove();
                i2++;
            ...
            if (VolleyLog.DEBUG) {
                VolleyLog.m6231v("pruned %d files, %d bytes, %d ms", Integer.valueOf(i2), Long.valueOf(this.mTotalSize - j3), Long.valueOf(SystemClock.elapsedRealtime() - elapsedRealtime));
            }
        }
    }
    ...
    static class CacheHeader {
        ...
        public boolean writeHeader(OutputStream outputStream) {
            try {
                ...
                VolleyLog.m6228d(UrlUtils.QUERY_PLACE_HOLDER, e.toString());
                return false;
            }
        }
    }
