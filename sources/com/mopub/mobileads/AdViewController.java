...
public class AdViewController {
    ...
    public AdViewController(Context context, MoPubView moPubView) {
        ...
        this.mBroadcastIdentifier = C0421Utils.generateUniqueId();
    ...
    static MoPubErrorCode getErrorCodeFromVolleyError(VolleyError volleyError, Context context) {
        ...
        if (volleyError instanceof MoPubNetworkError) {
            int i = C04264.$SwitchMap$com$mopub$network$MoPubNetworkError$Reason[((MoPubNetworkError) volleyError).getReason().ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C04264 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.mobileads.AdViewController.C04264.<clinit>():void");
        }
    }
