...
public final class CertificatePinner {
    ...
    static ByteString sha1(X509Certificate x509Certificate) {
        return ByteString.m7280of(x509Certificate.getPublicKey().getEncoded()).sha1();
    }

    static ByteString sha256(X509Certificate x509Certificate) {
        return ByteString.m7280of(x509Certificate.getPublicKey().getEncoded()).sha256();
    }
    ...
    static final class Pin {
        ...
        Pin(String str, String str2) {
            ...
            if (str.startsWith(WILDCARD)) {
                str3 = HttpUrl.get(Constants.HTTP + str.substring(2)).host();
            } else {
                str3 = HttpUrl.get(Constants.HTTP + str).host();
            }
