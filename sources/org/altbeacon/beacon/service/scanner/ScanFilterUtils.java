            ...
            for (ScanFilterData next : createScanFilterDataForBeaconParser(createScanFilterDataForBeaconParser)) {
                ...
                if (next.serviceUuid != null) {
                    ...
                    if (LogManager.isVerboseLoggingEnabled()) {
                        LogManager.m6046d(TAG, "making scan filter for service: " + format + StringUtils.SPACE + fromString, new Object[0]);
                        LogManager.m6046d(TAG, "making scan filter with service mask: " + "FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF" + StringUtils.SPACE + fromString2, new Object[0]);
                    }
                ...
                if (LogManager.isVerboseLoggingEnabled()) {
                    LogManager.m6046d(TAG, "Set up a scan filter: " + build, new Object[0]);
                }
                arrayList.add(build);
            }
        }
