...
public class CycledLeScannerForJellyBeanMr2 extends CycledLeScanner {
    ...
    public boolean deferScanIfNeeded() {
        ...
        LogManager.m6046d(TAG, "Waiting to start next Bluetooth scan for another %s milliseconds", Long.valueOf(elapsedRealtime));
        if (this.mBackgroundFlag) {
            setWakeUpAlarm();
        }
        Handler handler = this.mHandler;
        C23291 r4 = new Runnable() {
            public void run() {
            ...
            this.mScanHandler.post(new Runnable() {
                public void run() {
                    try {
                        ...
                        LogManager.m6049e(e, CycledLeScannerForJellyBeanMr2.TAG, "Internal Android exception in startLeScan()", new Object[0]);
                    }
                }
            });
        }
            ...
            this.mScanHandler.post(new Runnable() {
                public void run() {
                    try {
                        ...
                        LogManager.m6049e(e, CycledLeScannerForJellyBeanMr2.TAG, "Internal Android exception in stopLeScan()", new Object[0]);
                    }
                }
            });
        }
        ...
        if (this.leScanCallback == null) {
            this.leScanCallback = new BluetoothAdapter.LeScanCallback() {
                public void onLeScan(BluetoothDevice bluetoothDevice, int i, byte[] bArr) {
                    LogManager.m6046d(CycledLeScannerForJellyBeanMr2.TAG, "got record", new Object[0]);
