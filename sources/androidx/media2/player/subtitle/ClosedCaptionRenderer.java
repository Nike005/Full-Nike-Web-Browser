...
import androidx.media2.player.C4017R;
    ...
    class Cea608CCWidget extends ClosedCaptionWidget implements Cea608CCParser.DisplayListener {
        ...
        private class CCLineBox extends TextView {
            ...
            CCLineBox(Context context) {
                ...
                this.mOutlineWidth = (float) resources.getDimensionPixelSize(C4017R.dimen.subtitle_outline_width);
                this.mShadowRadius = (float) resources.getDimensionPixelSize(C4017R.dimen.subtitle_shadow_radius);
                this.mShadowOffset = (float) resources.getDimensionPixelSize(C4017R.dimen.subtitle_shadow_offset);
            }
            ...
            public void onMeasure(int i, int i2) {
                ...
                if (width != 0.0f) {
                    ...
                    Log.w(ClosedCaptionRenderer.TAG, "onMeasure(): Paint#getTextBounds() returned zero width. Ignored.");
                }
        ...
        private class CCLayout extends LinearLayout implements ClosedCaptionWidget.ClosedCaptionLayout {
            ...
            public void onMeasure(int i, int i2) {
                ...
                int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(((int) (((float) measuredHeight) * SAFE_AREA_RATIO)) / 15, 1073741824);
                int makeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec((int) (((float) measuredWidth) * SAFE_AREA_RATIO), 1073741824);
