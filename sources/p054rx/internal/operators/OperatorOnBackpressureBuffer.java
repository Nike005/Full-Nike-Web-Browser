...
import p054rx.internal.util.BackpressureDrainManager;
    ...
    static final class BufferSubscriber<T> extends Subscriber<T> implements BackpressureDrainManager.BackpressureQueueCallback {
        ...
        private boolean assertCapacity() {
            ...
            L_0x004a:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p054rx.internal.operators.OperatorOnBackpressureBuffer.BufferSubscriber.assertCapacity():boolean");
        }
