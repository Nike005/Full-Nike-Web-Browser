...
public abstract class BaseBannerView extends ViewGroup {
    protected C4859e bannerAdapter;
    ...
    public abstract C4859e getBannerAdapter();
    ...
    private void parseAttributeSet(AttributeSet attributeSet) {
        if (!isInEditMode()) {
            ...
            C4858d.m6456S().mo41306r("tid", "301");
            C4858d.m6456S().mo41298a(getContext(), (C4986p.C4988a) null);
            getViewTreeObserver().addOnScrollChangedListener(this.onScrollChangedListener);
            if (attributeSet != null) {
                TypedArray obtainAttributes = getResources().obtainAttributes(attributeSet, C4822R.styleable.BannersAttrs);
                String string = obtainAttributes.getString(C4822R.styleable.BannersAttrs_bannerSize);
                if (string != null) {
                    char c = 65535;
                ...
                String string2 = obtainAttributes.getString(C4822R.styleable.BannersAttrs_placementId);
                if (string2 != null) {
    ...
    public void setParams(String str, String str2) {
        C4858d.m6456S().mo41307s(str, str2);
    }
