...
import p054rx.internal.schedulers.ImmediateScheduler;
import p054rx.internal.schedulers.TrampolineScheduler;
    ...
    static final class ObserveOnSubscriber<T> extends Subscriber<T> implements Action0 {
        ...
        public void call() {
            ...
            do {
                ...
                if (j3 != j || !checkTerminated(this.finished, queue2.isEmpty(), subscriber, queue2)) {
                    this.emitted = j;
