...
public final class Log {
    ...
    public static void m4d(String str, String str2, Throwable th) {
        if (!logStackTraces) {
            m3d(str, appendThrowableMessage(str2, th));
        } else if (logLevel == 0) {
    ...
    public static void m8i(String str, String str2, Throwable th) {
        if (!logStackTraces) {
            m7i(str, appendThrowableMessage(str2, th));
        } else if (logLevel <= 1) {
    ...
    /* renamed from: w */
    public static void m9w(String str, String str2) {
        if (logLevel <= 2) {
    ...
    /* renamed from: w */
    public static void m10w(String str, String str2, Throwable th) {
        if (!logStackTraces) {
            m9w(str, appendThrowableMessage(str2, th));
        } else if (logLevel <= 2) {
    ...
    public static void m6e(String str, String str2, Throwable th) {
        if (!logStackTraces) {
            m5e(str, appendThrowableMessage(str2, th));
        } else if (logLevel <= 3) {
