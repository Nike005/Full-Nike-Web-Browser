...
public final class zzzy extends zzaal {
    ...
    public final void execute() {
        ...
        zzan.setTitle(resources != null ? resources.getString(C0059R.string.f16s5) : "Create calendar event");
        zzan.setMessage(resources != null ? resources.getString(C0059R.string.f17s6) : "Allow Ad to create a calendar event?");
        zzan.setPositiveButton(resources != null ? resources.getString(C0059R.string.f14s3) : "Accept", new zzzz(this));
        zzan.setNegativeButton(resources != null ? resources.getString(C0059R.string.f15s4) : "Decline", new zzaaa(this));
        zzan.create().show();
    }
}
