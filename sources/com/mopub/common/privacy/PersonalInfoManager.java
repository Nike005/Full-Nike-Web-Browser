...
public class PersonalInfoManager {
    ...
    public PersonalInfoManager(Context context, String str, SdkInitializationListener sdkInitializationListener) {
        ...
        C04111 r3 = new MoPubIdentifier.AdvertisingIdChangeListener() {
    ...
    public void changeConsentStateFromDialog(ConsentStatus consentStatus) {
        ...
        int i = C04166.$SwitchMap$com$mopub$common$privacy$ConsentStatus[consentStatus.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C04166 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.common.privacy.PersonalInfoManager.C04166.<clinit>():void");
        }
    }
