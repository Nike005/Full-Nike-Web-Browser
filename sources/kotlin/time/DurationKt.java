...
public final class DurationKt {
    ...
    private static final double m8236timesmvk6XK0(int i, double d) {
        return Duration.m8218timesimpl(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m8235timeskIfJnKk(double d, double d2) {
        return Duration.m8217timesimpl(d2, d);
    }

    public static final double toDuration(double d, TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return Duration.m8191constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
