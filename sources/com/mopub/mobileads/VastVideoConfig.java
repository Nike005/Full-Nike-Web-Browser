...
public class VastVideoConfig implements Serializable {
            ...
            if (optJSONArray != null && optJSONArray2 != null) {
                for (int i = 0; i < optJSONArray2.length(); i++) {
                    ...
                    if (!(optString == null || hydrateUrls == null)) {
                        switch (C04902.$SwitchMap$com$mopub$mobileads$VideoTrackingEvent[fromString.ordinal()]) {
                            case 1:
    ...
    /* renamed from: com.mopub.mobileads.VastVideoConfig$2 */
    static /* synthetic */ class C04902 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.mobileads.VastVideoConfig.C04902.<clinit>():void");
        }
    }
