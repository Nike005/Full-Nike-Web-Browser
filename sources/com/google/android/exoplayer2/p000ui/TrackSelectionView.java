...
public class TrackSelectionView extends LinearLayout {
    ...
    public TrackSelectionView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.disableView.setText(C0034R.string.exo_track_selection_none);
        ...
        addView(this.inflater.inflate(C0034R.layout.exo_list_divider, this, false));
        ...
        this.defaultView.setText(C0034R.string.exo_track_selection_auto);
