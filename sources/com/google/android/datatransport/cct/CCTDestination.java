...
public final class CCTDestination implements EncodedDestination {
    ...
    private static final Set<Encoding> zzd = Collections.unmodifiableSet(new HashSet(Arrays.asList(new Encoding[]{Encoding.m7231of("proto"), Encoding.m7231of(AdType.STATIC_NATIVE)})));
