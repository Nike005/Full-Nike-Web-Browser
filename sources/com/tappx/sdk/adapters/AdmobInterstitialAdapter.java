...
public class AdmobInterstitialAdapter implements CustomEventInterstitial {
    ...
    /* renamed from: com.tappx.sdk.adapters.AdmobInterstitialAdapter$1 */
    static /* synthetic */ class C17201 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.tappx.sdk.adapters.AdmobInterstitialAdapter.C17201.<clinit>():void");
        }
    }
    ...
    private static final class AdapterListener implements TappxInterstitialListener {
        ...
        /* synthetic */ AdapterListener(CustomEventInterstitialListener customEventInterstitialListener, C17201 r2) {
    ...
    public static int convertToAdmobReason(TappxAdError tappxAdError) {
        int i = C17201.$SwitchMap$com$tappx$sdk$android$TappxAdError[tappxAdError.ordinal()];
        if (i != 1) {
            return i != 2 ? 3 : 0;
        }
        return 2;
    ...
    public void requestInterstitialAd(Context context, CustomEventInterstitialListener customEventInterstitialListener, String str, MediationAdRequest mediationAdRequest, Bundle bundle) {
        ...
        tappxInterstitial.setListener(new AdapterListener(customEventInterstitialListener, (C17201) null));
