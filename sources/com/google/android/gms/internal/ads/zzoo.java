...
public final class zzoo extends zzql implements zzpc {
    ...
    public final void performClick(Bundle bundle) {
        synchronized (this.mLock) {
            if (this.zzbij == null) {
                zzakb.m44e("#001 Attempt to perform click before app native ad initialized.");
            } else {
    ...
    public final boolean recordImpression(Bundle bundle) {
        synchronized (this.mLock) {
            if (this.zzbij == null) {
                zzakb.m44e("#002 Attempt to record impression before native ad initialized.");
                return false;
            }
    ...
    public final void reportTouchEvent(Bundle bundle) {
        synchronized (this.mLock) {
            if (this.zzbij == null) {
                zzakb.m44e("#003 Attempt to report touch event before native ad initialized.");
            } else {
