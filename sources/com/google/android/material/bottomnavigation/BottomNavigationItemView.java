...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0081R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0081R.C0083drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C0081R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0081R.C0084id.icon);
        this.smallLabel = (TextView) findViewById(C0081R.C0084id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0081R.C0084id.largeLabel);
