...
public class StAXEventBuilder {
    ...
    private static final Document process(JDOMFactory jDOMFactory, XMLEventReader xMLEventReader) throws JDOMException {
        ...
        try {
            Document document = jDOMFactory.document((Element) null);
                ...
                while (peek.getEventType() != 8) {
                    if (peek.isStartDocument()) {
                        ...
                        if (peek instanceof Comment) {
                            ...
                            ProcessingInstruction processingInstruction = jDOMFactory.processingInstruction(peek.getTarget(), ((javax.xml.stream.events.ProcessingInstruction) peek).getData());
                            if (element == null) {
