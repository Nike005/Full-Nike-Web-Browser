...
public class PlayerNotificationManager {
    ...
    public PlayerNotificationManager(Context context2, String str, int i, MediaDescriptionAdapter mediaDescriptionAdapter2, NotificationListener notificationListener2, CustomActionReceiver customActionReceiver2) {
        ...
        this.color = 0;
        this.smallIconResourceId = C0034R.C0035drawable.exo_notification_small_icon;
        this.defaults = 0;
        this.priority = -1;
    ...
    public int[] getActionIndicesForCompactView(java.util.List<java.lang.String> r7, com.google.android.exoplayer2.Player r8) {
        ...
        L_0x004c:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p000ui.PlayerNotificationManager.getActionIndicesForCompactView(java.util.List, com.google.android.exoplayer2.Player):int[]");
    }
    ...
    private static Map<String, NotificationCompat.Action> createPlaybackActions(Context context2, int i) {
        ...
        hashMap.put(ACTION_PLAY, new NotificationCompat.Action(C0034R.C0035drawable.exo_notification_play, (CharSequence) context2.getString(C0034R.string.exo_controls_play_description), createBroadcastIntent(ACTION_PLAY, context2, i)));
        hashMap.put(ACTION_PAUSE, new NotificationCompat.Action(C0034R.C0035drawable.exo_notification_pause, (CharSequence) context2.getString(C0034R.string.exo_controls_pause_description), createBroadcastIntent(ACTION_PAUSE, context2, i)));
        hashMap.put(ACTION_STOP, new NotificationCompat.Action(C0034R.C0035drawable.exo_notification_stop, (CharSequence) context2.getString(C0034R.string.exo_controls_stop_description), createBroadcastIntent(ACTION_STOP, context2, i)));
        hashMap.put(ACTION_REWIND, new NotificationCompat.Action(C0034R.C0035drawable.exo_notification_rewind, (CharSequence) context2.getString(C0034R.string.exo_controls_rewind_description), createBroadcastIntent(ACTION_REWIND, context2, i)));
        hashMap.put(ACTION_FAST_FORWARD, new NotificationCompat.Action(C0034R.C0035drawable.exo_notification_fastforward, (CharSequence) context2.getString(C0034R.string.exo_controls_fastforward_description), createBroadcastIntent(ACTION_FAST_FORWARD, context2, i)));
        hashMap.put(ACTION_PREVIOUS, new NotificationCompat.Action(C0034R.C0035drawable.exo_notification_previous, (CharSequence) context2.getString(C0034R.string.exo_controls_previous_description), createBroadcastIntent(ACTION_PREVIOUS, context2, i)));
        hashMap.put(ACTION_NEXT, new NotificationCompat.Action(C0034R.C0035drawable.exo_notification_next, (CharSequence) context2.getString(C0034R.string.exo_controls_next_description), createBroadcastIntent(ACTION_NEXT, context2, i)));
        return hashMap;
    }
            ...
            if (access$500 != null && PlayerNotificationManager.this.isNotificationStarted && intent.getIntExtra(PlayerNotificationManager.EXTRA_INSTANCE_ID, PlayerNotificationManager.this.instanceId) == PlayerNotificationManager.this.instanceId) {
                ...
                if (PlayerNotificationManager.ACTION_PLAY.equals(action)) {
                    if (access$500.getPlaybackState() == 1) {
                        ...
                        PlayerNotificationManager.this.seekTo(access$500, access$500.getCurrentWindowIndex(), -9223372036854775807L);
                    }
