...
class PlayerWrapper {
    ...
    public boolean canPause() {
        ...
        return sessionCommandGroup != null && sessionCommandGroup.hasCommand((int) SessionCommand.COMMAND_CODE_PLAYER_PAUSE);
    }

    /* access modifiers changed from: package-private */
    public boolean canSeekBackward() {
        SessionCommandGroup sessionCommandGroup = this.mAllowedCommands;
        return sessionCommandGroup != null && sessionCommandGroup.hasCommand((int) SessionCommand.COMMAND_CODE_SESSION_REWIND);
    }

    /* access modifiers changed from: package-private */
    public boolean canSeekForward() {
        SessionCommandGroup sessionCommandGroup = this.mAllowedCommands;
        return sessionCommandGroup != null && sessionCommandGroup.hasCommand((int) SessionCommand.COMMAND_CODE_SESSION_FAST_FORWARD);
    }

    /* access modifiers changed from: package-private */
    public boolean canSkipToNext() {
        SessionCommandGroup sessionCommandGroup = this.mAllowedCommands;
        return sessionCommandGroup != null && sessionCommandGroup.hasCommand((int) SessionCommand.COMMAND_CODE_PLAYER_SKIP_TO_NEXT_PLAYLIST_ITEM);
    }

    /* access modifiers changed from: package-private */
    public boolean canSkipToPrevious() {
        SessionCommandGroup sessionCommandGroup = this.mAllowedCommands;
        return sessionCommandGroup != null && sessionCommandGroup.hasCommand((int) SessionCommand.COMMAND_CODE_PLAYER_SKIP_TO_PREVIOUS_PLAYLIST_ITEM);
    }

    /* access modifiers changed from: package-private */
    public boolean canSeekTo() {
        SessionCommandGroup sessionCommandGroup = this.mAllowedCommands;
        return sessionCommandGroup != null && sessionCommandGroup.hasCommand((int) SessionCommand.COMMAND_CODE_PLAYER_SEEK_TO);
    }

    /* access modifiers changed from: package-private */
    public boolean canSelectDeselectTrack() {
        SessionCommandGroup sessionCommandGroup = this.mAllowedCommands;
        return sessionCommandGroup != null && sessionCommandGroup.hasCommand((int) SessionCommand.COMMAND_CODE_PLAYER_SELECT_TRACK) && this.mAllowedCommands.hasCommand((int) SessionCommand.COMMAND_CODE_PLAYER_DESELECT_TRACK);
    }
    ...
    private class MediaControllerCallback extends MediaController.ControllerCallback {
        ...
        public void onAllowedCommandsChanged(MediaController mediaController, SessionCommandGroup sessionCommandGroup) {
            if (PlayerWrapper.this.mAllowedCommands != sessionCommandGroup) {
