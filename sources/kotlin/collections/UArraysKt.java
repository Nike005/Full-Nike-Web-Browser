...
public final class UArraysKt {
    ...
    public static final int m8258random2D5oskM(int[] iArr, Random random) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UIntArray.m7425isEmptyimpl(iArr)) {
            return UIntArray.m7422getimpl(iArr, random.nextInt(UIntArray.m7423getSizeimpl(iArr)));
        }
    ...
    public static final long m8259randomJzugnMA(long[] jArr, Random random) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!ULongArray.m7494isEmptyimpl(jArr)) {
            return ULongArray.m7491getimpl(jArr, random.nextInt(ULongArray.m7492getSizeimpl(jArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final byte m8260randomoSF2wD8(byte[] bArr, Random random) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UByteArray.m7356isEmptyimpl(bArr)) {
            return UByteArray.m7353getimpl(bArr, random.nextInt(UByteArray.m7354getSizeimpl(bArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final short m8261randoms5X_as8(short[] sArr, Random random) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UShortArray.m7589isEmptyimpl(sArr)) {
            return UShortArray.m7586getimpl(sArr, random.nextInt(UShortArray.m7587getSizeimpl(sArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final boolean m8246contentEqualsctEhBpI(int[] iArr, int[] iArr2) {
    ...
    public static final boolean m8249contentEqualsus8wMrg(long[] jArr, long[] jArr2) {
    ...
    public static final boolean m8247contentEqualskdPth3s(byte[] bArr, byte[] bArr2) {
    ...
    public static final boolean m8248contentEqualsmazbYpA(short[] sArr, short[] sArr2) {
    ...
    public static final int m8250contentHashCodeajY9A(int[] iArr) {
    ...
    public static final int m8252contentHashCodeQwZRm1k(long[] jArr) {
    ...
    public static final int m8251contentHashCodeGBYM_sE(byte[] bArr) {
    ...
    public static final int m8253contentHashCoderL5Bavg(short[] sArr) {
    ...
    public static final String m8254contentToStringajY9A(int[] iArr) {
    ...
    public static final String m8256contentToStringQwZRm1k(long[] jArr) {
    ...
    public static final String m8255contentToStringGBYM_sE(byte[] bArr) {
    ...
    public static final String m8257contentToStringrL5Bavg(short[] sArr) {
    ...
    public static final UInt[] m8262toTypedArrayajY9A(int[] iArr) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$toTypedArray");
        int r0 = UIntArray.m7423getSizeimpl(iArr);
        UInt[] uIntArr = new UInt[r0];
        for (int i = 0; i < r0; i++) {
            uIntArr[i] = UInt.m7365boximpl(UIntArray.m7422getimpl(iArr, i));
        }
        return uIntArr;
    }
    ...
    public static final ULong[] m8264toTypedArrayQwZRm1k(long[] jArr) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$toTypedArray");
        int r0 = ULongArray.m7492getSizeimpl(jArr);
        ULong[] uLongArr = new ULong[r0];
        for (int i = 0; i < r0; i++) {
            uLongArr[i] = ULong.m7434boximpl(ULongArray.m7491getimpl(jArr, i));
        }
        return uLongArr;
    }
    ...
    public static final UByte[] m8263toTypedArrayGBYM_sE(byte[] bArr) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$toTypedArray");
        int r0 = UByteArray.m7354getSizeimpl(bArr);
        UByte[] uByteArr = new UByte[r0];
        for (int i = 0; i < r0; i++) {
            uByteArr[i] = UByte.m7298boximpl(UByteArray.m7353getimpl(bArr, i));
        }
        return uByteArr;
    }
    ...
    public static final UShort[] m8265toTypedArrayrL5Bavg(short[] sArr) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$toTypedArray");
        int r0 = UShortArray.m7587getSizeimpl(sArr);
        UShort[] uShortArr = new UShort[r0];
        for (int i = 0; i < r0; i++) {
            uShortArr[i] = UShort.m7531boximpl(UShortArray.m7586getimpl(sArr, i));
        }
        return uShortArr;
    }
}
