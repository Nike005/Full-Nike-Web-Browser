...
final class zzaw extends RemoteMediaPlayer.zzb {
    ...
    zzaw(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, int[] iArr, JSONObject jSONObject) {
    ...
    public final void zza(com.google.android.gms.internal.cast.zzcn r6) {
        /*
            ...
            int[] r3 = r5.zzfn     // Catch:{ zzdk | IllegalStateException -> 0x002e }
            org.json.JSONObject r4 = r5.zzfi     // Catch:{ zzdk | IllegalStateException -> 0x002e }
            r1.zza((com.google.android.gms.internal.cast.zzdm) r2, (int[]) r3, (org.json.JSONObject) r4)     // Catch:{ zzdk | IllegalStateException -> 0x002e }
