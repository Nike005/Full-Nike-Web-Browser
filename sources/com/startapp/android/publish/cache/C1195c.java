...
public class C1195c implements Serializable {
    ...
    public C1195c(AdPreferences.Placement placement2, AdPreferences adPreferences) {
        ...
        this.forceOfferWall3D = C1061i.m1197a(adPreferences, "forceOfferWall3D");
        this.forceOfferWall2D = C1061i.m1197a(adPreferences, "forceOfferWall2D");
        this.forceFullpage = C1061i.m1197a(adPreferences, "forceFullpage");
        this.forceOverlay = C1061i.m1197a(adPreferences, "forceOverlay");
        this.testMode = C1061i.m1197a(adPreferences, "testMode");
        this.country = C1061i.m1201b(adPreferences, ImpressionData.COUNTRY);
        this.advertiserId = C1061i.m1201b(adPreferences, "advertiserId");
        this.template = C1061i.m1201b(adPreferences, "template");
        this.type = C1103c.m1365a(adPreferences, "type");
    }

    /* renamed from: a */
    public AdPreferences.Placement mo15085a() {
    ...
    public int hashCode() {
        ...
        C1040Ad.AdType adType = this.type;
        if (adType != null) {
            i = adType.hashCode();
        }
        return i3 + i;
