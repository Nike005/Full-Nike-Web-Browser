    ...
    public static class Builder {
        ...
        private Builder derivePositionAnchorFromAlignment() {
            if (this.textAlignment == null) {
                ...
                int i = C39411.$SwitchMap$android$text$Layout$Alignment[this.textAlignment.ordinal()];
                if (i == 1) {
    ...
    static /* synthetic */ class C39411 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.media2.exoplayer.external.text.webvtt.WebvttCue.C39411.<clinit>():void");
        }
    }
}
