...
public class VerticalItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z3) {
                ...
                C32032 r62 = new Runnable() {
                    public void run() {
                        Iterator it = arrayList2.iterator();
                        while (it.hasNext()) {
                            VerticalItemAnimator.this.animateChangeImpl((ChangeInfo) it.next());
                        }
                        arrayList2.clear();
            ...
            if (z4) {
                ...
                C32043 r5 = new Runnable() {
                    public void run() {
                        Iterator it = arrayList3.iterator();
                        while (it.hasNext()) {
                            VerticalItemAnimator.this.animateAddImpl((RecyclerView.ViewHolder) it.next());
                        }
                        arrayList3.clear();
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        animate.setDuration(getRemoveDuration()).alpha(0.0f).translationX((float) ((-viewHolder.itemView.getWidth()) / 2)).setInterpolator(new AccelerateInterpolator()).setListener(new VpaListenerAdapter() {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        ...
        ViewCompat.setTranslationX(viewHolder.itemView, (float) ((-viewHolder.itemView.getWidth()) / 2));
    ...
    public void animateMoveImpl(RecyclerView.ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        animate.setDuration(getMoveDuration()).setListener(new VpaListenerAdapter() {
            public void onAnimationStart(View view) {
                VerticalItemAnimator.this.dispatchMoveStarting(viewHolder2);
            }
            ...
            public void onAnimationEnd(View view) {
                animate.setListener((ViewPropertyAnimatorListener) null);
                VerticalItemAnimator.this.dispatchMoveFinished(viewHolder2);
                VerticalItemAnimator.this.mMoveAnimations.remove(viewHolder2);
                VerticalItemAnimator.this.dispatchFinishedWhenDone();
            }
        }).start();
    }
