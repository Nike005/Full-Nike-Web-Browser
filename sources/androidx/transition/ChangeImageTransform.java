    ...
    static /* synthetic */ class C45673 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.transition.ChangeImageTransform.C45673.<clinit>():void");
        }
    }

    private static Matrix copyImageMatrix(ImageView imageView) {
        int i = C45673.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
        if (i == 1) {
