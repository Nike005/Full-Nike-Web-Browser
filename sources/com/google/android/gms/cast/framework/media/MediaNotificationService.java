...
public class MediaNotificationService extends Service {
    ...
    public void onCreate() {
        zzd zza = zze.zza((Service) this, CastContext.getSharedInstance(this).zzr(), ObjectWrapper.wrap(null), CastContext.getSharedInstance(this).getCastOptions().getCastMediaOptions());
        this.zzlb = zza;
        try {
            zza.onCreate();
        } catch (RemoteException e) {
