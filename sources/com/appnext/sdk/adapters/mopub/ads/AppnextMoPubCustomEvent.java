...
public abstract class AppnextMoPubCustomEvent extends CustomEventInterstitial {
    ...
    protected C4924Ad mAd;
    /* access modifiers changed from: private */
    public CustomEventInterstitial.CustomEventInterstitialListener mInterstitialListener;

    /* access modifiers changed from: protected */
    public abstract C4924Ad createAd(Context context, Map<String, Object> map, Map<String, String> map2);
    ...
    public void loadInterstitial(Context context, CustomEventInterstitial.CustomEventInterstitialListener customEventInterstitialListener, Map<String, Object> map, Map<String, String> map2) {
        ...
        C4924Ad createAd = createAd(context.getApplicationContext(), map, map2);
        this.mAd = createAd;
        if (createAd == null) {
            ...
            this.mAd.setOnAdErrorCallback(new OnAdError() {
                ...
                public void adError(java.lang.String r6) {
                    ...
                    L_0x0079:
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.appnext.sdk.adapters.mopub.ads.AppnextMoPubCustomEvent.C50365.adError(java.lang.String):void");
                }
            });
            this.mAd.loadAd();
        } catch (Throwable th) {
