...
public interface MediaSourceEventListener {
    ...
    public static final class EventDispatcher {
            ...
            while (it.hasNext()) {
                ...
                postOrRun(next.handler, new Runnable(next.listener, mediaPeriodId2) {
                    ...
                    public final void run() {
                        MediaSourceEventListener.EventDispatcher.this.mo44454xa9fff584(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo44454xa9fff584(MediaSourceEventListener mediaSourceEventListener, MediaSource.MediaPeriodId mediaPeriodId2) {
        ...
        public void mediaPeriodReleased() {
            ...
            while (it.hasNext()) {
                ...
                postOrRun(next.handler, new Runnable(next.listener, mediaPeriodId2) {
                    ...
                    public final void run() {
                        MediaSourceEventListener.EventDispatcher.this.mo44455xb596e71e(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo44455xb596e71e(MediaSourceEventListener mediaSourceEventListener, MediaSource.MediaPeriodId mediaPeriodId2) {
        ...
        public void upstreamDiscarded(MediaLoadData mediaLoadData) {
            ...
            while (it.hasNext()) {
                ...
                postOrRun(next.handler, new Runnable(next.listener, mediaPeriodId2, mediaLoadData) {
                    ...
                    public final void run() {
                        MediaSourceEventListener.EventDispatcher.this.mo44457xcce9218(this.f$1, this.f$2, this.f$3);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo44457xcce9218(MediaSourceEventListener mediaSourceEventListener, MediaSource.MediaPeriodId mediaPeriodId2, MediaLoadData mediaLoadData) {
        ...
        public void downstreamFormatChanged(MediaLoadData mediaLoadData) {
            ...
            while (it.hasNext()) {
                ...
                postOrRun(next.handler, new Runnable(next.listener, mediaLoadData) {
                    ...
                    public final void run() {
                        MediaSourceEventListener.EventDispatcher.this.mo44449x9a021abe(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo44449x9a021abe(MediaSourceEventListener mediaSourceEventListener, MediaLoadData mediaLoadData) {
