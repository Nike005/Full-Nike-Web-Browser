...
public class Attribute extends CloneBase implements NamespaceAware, Serializable, Cloneable {
    ...
    public boolean getBooleanValue() throws DataConversionException {
        String trim = this.value.trim();
        if (trim.equalsIgnoreCase(CleanerProperties.BOOL_ATT_TRUE) || trim.equalsIgnoreCase(C4899d.f4618fe) || trim.equalsIgnoreCase("1") || trim.equalsIgnoreCase("yes")) {
            return true;
        }
        if (trim.equalsIgnoreCase("false") || trim.equalsIgnoreCase(C4899d.f4619ff) || trim.equalsIgnoreCase("0") || trim.equalsIgnoreCase("no")) {
            return false;
        }
