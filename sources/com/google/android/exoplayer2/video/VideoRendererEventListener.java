...
public interface VideoRendererEventListener {
    ...
    public static final class EventDispatcher {
        ...
        public void decoderInitialized(String str, long j, long j2) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(str, j, j2) {
                    ...
                    public final void run() {
                        VideoRendererEventListener.EventDispatcher.this.mo1428x9a08f997(this.f$1, this.f$2, this.f$3);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo1428x9a08f997(String str, long j, long j2) {
        ...
        public void inputFormatChanged(Format format) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(format) {
                    ...
                    public final void run() {
                        VideoRendererEventListener.EventDispatcher.this.mo1432xe7570b3(this.f$1);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo1432xe7570b3(Format format) {
        ...
        public void droppedFrames(int i, long j) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(i, j) {
                    ...
                    public final void run() {
                        VideoRendererEventListener.EventDispatcher.this.mo1430xf7e95759(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo1430xf7e95759(int i, long j) {
        ...
        public void videoSizeChanged(int i, int i2, int i3, float f) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(i, i2, i3, f) {
                    ...
                    public final void run() {
                        VideoRendererEventListener.EventDispatcher.this.mo1434x6ff94f6c(this.f$1, this.f$2, this.f$3, this.f$4);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo1434x6ff94f6c(int i, int i2, int i3, float f) {
        ...
        public void renderedFirstFrame(Surface surface) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(surface) {
                    ...
                    public final void run() {
                        VideoRendererEventListener.EventDispatcher.this.mo1433x44bb7f11(this.f$1);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo1433x44bb7f11(Surface surface) {
