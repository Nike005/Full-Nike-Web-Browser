...
public class C4861g extends C4826a {
    ...
    public void inflateView(int i, AppnextAd appnextAd) {
        try {
            ...
            AppnextWebView.m6957u(this.context).mo41343a(jSurl, (AppnextWebView.C5017c) new AppnextWebView.C5017c() {
                /* renamed from: f */
                public final void mo40715f(String str) {
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        public final void run() {
                            C4861g.this.loadWebview(jSurl, AppnextWebView.m6957u(C4861g.this.context).mo41346aj(jSurl));
                        }
                    });
                }
                ...
                public final void error(String str) {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        public final void run() {
                            C4861g.this.loadWebview(jSurl, C4861g.this.getFallbackScript());
                        }
                    });
                }
            });
            AppnextWebView.m6957u(this.context).mo41343a(getTargetJSurl(), (AppnextWebView.C5017c) null);
    ...
    public void destroy() {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            public final void run() {
                try {
                    ((ViewGroup) C4861g.this.webView.getParent()).removeView(C4861g.this.webView);
                } catch (Throwable unused) {
                }
                if (C4861g.this.webView != null) {
                    C4861g.this.webView.destroyDrawingCache();
                    C4861g.this.webView.destroy();
                }
            }
        });
    ...
    public JSONObject getConfigParams() throws JSONException {
        ...
        jSONObject.put("pview", C4858d.m6456S().get("pview"));
        ...
        jSONObject.put("remove_poster_on_auto_play", C4858d.m6456S().get("remove_poster_on_auto_play"));
        ...
        jSONObject.put("gdpr", C4977k.m6867a((AppnextAd) getSelectedAd(), (C4986p) C4858d.m6456S()));
        jSONObject.put("lang_settings", new JSONObject(C4944b.m6738bp().mo41226bq()).toString());
    ...
    public class C4871a {
        ...
        public void openStore(String str) {
            C4861g.this.handler.removeCallbacksAndMessages((Object) null);
            if (!C4861g.this.isDestroyed()) {
                C4861g.this.handler.post(new Runnable() {
                    public final void run() {
                        if (!C4861g.this.getSelectedAd().getWebview().equals("0")) {
                            C4861g.this.click();
                            return;
                        }
                        char c = 65535;
                        if (C4861g.this.getSelectedAd().getRevenueType().equals("cpi")) {
                            C4858d S = C4858d.m6456S();
                            String lowerCase = S.get(C4861g.this.getBannerSize().toString() + "_cpiActiveFlow").toLowerCase();
                            StringBuilder sb = new StringBuilder();
                            sb.append(C4861g.this.getBannerSize().toString());
                            ...
                            if (c != 0) {
                                if (c == 1) {
                                    boolean unused = C4861g.this.clicked = true;
                                } else if (c == 2) {
                                    C4861g.this.openResultPage(false);
                                    return;
                                }
                                C4861g.this.click();
                                return;
                            }
                            C4861g.this.openResultPage(true);
                            return;
                        }
                        C4858d S2 = C4858d.m6456S();
                        String lowerCase2 = S2.get(C4861g.this.getBannerSize().toString() + "_cpcActiveFlow").toLowerCase();
                        StringBuilder sb2 = new StringBuilder();
                        sb2.append(C4861g.this.getBannerSize().toString());
                        ...
                        if (c == 0) {
                            boolean unused2 = C4861g.this.clicked = true;
                        }
                        C4861g.this.click();
                    }
                });
        ...
        public void openLink(String str) {
            if (!C4861g.this.isDestroyed()) {
                C4861g.this.openLink(str);
            }
        }

        @JavascriptInterface
        public void logSTP(String str, String str2) {
            C4967f.m6820a((C4924Ad) C4861g.this.getBannerAd(), (AppnextAd) C4861g.this.getSelectedAd(), str, str2, (C4986p) C4858d.m6456S());
        }
    }
    ...
    public class C4873b extends WebViewClient {
        public C4873b() {
        }
    ...
    public void pageFinished() {
        if (!isDestroyed()) {
            new Thread(new Runnable() {
                public final void run() {
                    C4861g gVar = C4861g.this;
                    String unused = gVar.adsid = C4967f.m6827b(gVar.context, false);
                    C4861g.this.handler.removeCallbacksAndMessages((Object) null);
                    C4861g.this.handler.post(new Runnable() {
                        public final void run() {
                            try {
                                C4861g.this.loadJS("javascript:(function() { try { Appnext.Layout.destroy('internal'); } catch(err){ Appnext.jsError(err.message); }})()");
                                C4861g gVar = C4861g.this;
                                gVar.loadJS("javascript:(function() { try { Appnext.setParams(" + C4861g.this.getConfigParams().toString() + "); } catch(err){ Appnext.jsError(err.message); }})()");
                                C4861g gVar2 = C4861g.this;
                                gVar2.loadJS("javascript:(function() { try { Appnext.loadBanner(" + new JSONObject(C4861g.this.getSelectedAd().getAdJSON()).toString() + ",'" + C4861g.this.getBannerSize().toString() + "'); } catch(err){ Appnext.jsError(err.message); }})()");
                                C4861g.this.shown.add(C4861g.this.getSelectedAd().getBannerID());
                            } catch (Throwable unused) {
                            }
                        }
                    });
    ...
    private void activateAutoRefresh() {
        ...
        if (Boolean.parseBoolean(S.get("_arFlag")) && i > 0) {
            this.refreshHandler.postDelayed(new Runnable() {
                public final void run() {
                    try {
                        AppnextAd a = C4856b.m6439R().mo40904a(C4861g.this.context, (C4924Ad) C4861g.this.getBannerAd(), (ArrayList<?>) C4861g.this.getAds(), C4861g.this.getAdRequest().getCreativeType(), (ArrayList<String>) C4861g.this.shown);
                        if (a != null) {
                            C4861g.this.setSelectedAd(new BannerAdData(a));
                            if (Boolean.parseBoolean(C4858d.m6456S().get("impOne"))) {
                                C4861g.this.setReportedImpression(false);
                                C4861g.this.impression();
                            } else if (Boolean.parseBoolean(C4858d.m6456S().get("pview"))) {
                                C4861g.this.refreshHandler.postDelayed(new Runnable() {
                                    public final void run() {
                                        C4861g.this.getUserAction().mo41311a(C4861g.this.getSelectedAd(), C4861g.this.getSelectedAd().getImpressionURL(), (C4956e.C4965a) null);
                                    }
                                }, (long) (Integer.parseInt(C4858d.m6456S().get("postpone_vta_sec")) * 1000));
                            }
                            C4861g.this.pageFinished();
                        }
                    } catch (Throwable unused) {
