...
abstract class UserState {
    ...
    private static final String[] LOCATION_FIELDS = {C4905i.f4638fC, "long", "loc_acc", "loc_type", "loc_bg", "loc_time_stamp", "ad_id"};
    ...
    public void setLocation(LocationController.LocationPoint locationPoint) {
        try {
            this.syncValues.put(C4905i.f4638fC, locationPoint.lat);
            ...
            this.dependValues.put("loc_bg", locationPoint.f296bg);
    ...
    public void clearLocation() {
        try {
            this.syncValues.put(C4905i.f4638fC, (Object) null);
