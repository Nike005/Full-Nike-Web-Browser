...
public class MraidBridge {
    ...
    public void runCommand(MraidJavascriptCommand mraidJavascriptCommand, Map<String, String> map) throws MraidCommandException {
        if (mraidJavascriptCommand.requiresClick(this.mPlacementType) && !isClicked()) {
            ...
            switch (C05505.$SwitchMap$com$mopub$mraid$MraidJavascriptCommand[mraidJavascriptCommand.ordinal()]) {
                case 1:
                    this.mMraidBridgeListener.onClose();
                    return;
                case 2:
                    boolean z = false;
                    this.mMraidBridgeListener.onResize(checkRange(parseSize(map.get("width")), 0, DefaultOggSeeker.MATCH_BYTE_RANGE), checkRange(parseSize(map.get("height")), 0, DefaultOggSeeker.MATCH_BYTE_RANGE), checkRange(parseSize(map.get("offsetX")), -100000, DefaultOggSeeker.MATCH_BYTE_RANGE), checkRange(parseSize(map.get("offsetY")), -100000, DefaultOggSeeker.MATCH_BYTE_RANGE), parseClosePosition(map.get("customClosePosition"), CloseableLayout.ClosePosition.TOP_RIGHT), parseBoolean(map.get("allowOffscreen"), true));
    ...
    static /* synthetic */ class C05505 {
        ...
        static {
            ...
            L_0x0078:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.mraid.MraidBridge.C05505.<clinit>():void");
        }
    }
