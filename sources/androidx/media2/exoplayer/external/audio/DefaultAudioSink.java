    ...
    public boolean handleBuffer(ByteBuffer byteBuffer, long j) throws AudioSink.InitializationException, AudioSink.WriteException {
        ...
        if (this.inputBuffer != null) {
            ...
            if (this.afterDrainPlaybackParameters == null) {
                ...
                PlaybackParameters applyPlaybackParameters = this.audioProcessorChain.applyPlaybackParameters(playbackParameters3);
                ArrayDeque<PlaybackParametersCheckpoint> arrayDeque = this.playbackParametersCheckpoints;
                long max = Math.max(0, j2);
                Configuration configuration2 = this.configuration;
                str2 = TAG;
                arrayDeque.add(new PlaybackParametersCheckpoint(applyPlaybackParameters, max, configuration2.framesToDurationUs(getWrittenFrames())));
                setupAudioProcessors();
            }
        ...
        if (!this.inputBuffer.hasRemaining()) {
            ...
            Log.m6210w(str, "Resetting stalled audio track");
            flush();
            return true;
        }
    }
    ...
    private final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
        ...
        public void onPositionFramesMismatch(long j, long j2, long j3, long j4) {
            ...
            if (!DefaultAudioSink.failOnSpuriousAudioTimestamp) {
                Log.m6210w(DefaultAudioSink.TAG, sb2);
                return;
            }
        ...
        public void onInvalidLatency(long j) {
            ...
            sb.append(j);
            Log.m6210w(DefaultAudioSink.TAG, sb.toString());
        }
