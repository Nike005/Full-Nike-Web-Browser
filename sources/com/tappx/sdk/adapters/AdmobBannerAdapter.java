...
public class AdmobBannerAdapter implements CustomEventBanner {
    ...
    /* renamed from: com.tappx.sdk.adapters.AdmobBannerAdapter$1 */
    static /* synthetic */ class C17191 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.tappx.sdk.adapters.AdmobBannerAdapter.C17191.<clinit>():void");
        }
    }
    ...
    private static final class AdapterListener implements TappxBannerListener {
        ...
        /* synthetic */ AdapterListener(CustomEventBannerListener customEventBannerListener, C17191 r2) {
    ...
    public static int convertToAdmobReason(TappxAdError tappxAdError) {
        int i = C17191.$SwitchMap$com$tappx$sdk$android$TappxAdError[tappxAdError.ordinal()];
        if (i != 1) {
            return i != 2 ? 3 : 0;
        }
        return 2;
    ...
    public void requestBannerAd(Context context, CustomEventBannerListener customEventBannerListener, String str, AdSize adSize, MediationAdRequest mediationAdRequest, Bundle bundle) {
        ...
        this.banner.setListener(new AdapterListener(customEventBannerListener, (C17191) null));
