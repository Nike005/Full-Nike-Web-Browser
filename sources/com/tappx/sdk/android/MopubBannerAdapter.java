...
class MopubBannerAdapter extends CustomEventBanner {
    ...
    /* renamed from: a */
    private TappxBanner f2610a;

    /* renamed from: com.tappx.sdk.android.MopubBannerAdapter$1 */
    static /* synthetic */ class C17211 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f2611a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f2611a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f2611a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.tappx.sdk.android.MopubBannerAdapter.C17211.<clinit>():void");
        }
    }

    /* renamed from: com.tappx.sdk.android.MopubBannerAdapter$a */
    private static final class C1722a implements TappxBannerListener {

        /* renamed from: a */
        private final CustomEventBanner.CustomEventBannerListener f2612a;

        private C1722a(CustomEventBanner.CustomEventBannerListener customEventBannerListener) {
            this.f2612a = customEventBannerListener;
        }

        /* synthetic */ C1722a(CustomEventBanner.CustomEventBannerListener customEventBannerListener, C17211 r2) {
            this(customEventBannerListener);
        }

        public void onBannerClicked(TappxBanner tappxBanner) {
            this.f2612a.onBannerClicked();
        }

        public void onBannerCollapsed(TappxBanner tappxBanner) {
            this.f2612a.onBannerCollapsed();
        }

        public void onBannerExpanded(TappxBanner tappxBanner) {
            this.f2612a.onBannerExpanded();
        }
        ...
        public void onBannerLoadFailed(TappxBanner tappxBanner, TappxAdError tappxAdError) {
            ...
            this.f2612a.onBannerFailed(MopubBannerAdapter.m3792b(tappxAdError));
        }

        public void onBannerLoaded(TappxBanner tappxBanner) {
            Log.v("Tappx", "MoPub adapter: Banner loaded");
            this.f2612a.onBannerLoaded(tappxBanner);
        }
    }
    ...
    /* renamed from: a */
    private int m3789a(Map<String, String> map, String str, int i) {
        try {
    ...
    /* renamed from: a */
    private TappxBanner.AdSize m3791a(int i, int i2) {
    ...
    /* renamed from: b */
    public static MoPubErrorCode m3792b(TappxAdError tappxAdError) {
        int i = C17211.f2611a[tappxAdError.ordinal()];
    ...
    public void loadBanner(Context context, CustomEventBanner.CustomEventBannerListener customEventBannerListener, Map<String, Object> map, Map<String, String> map2) {
        ...
        int a = m3789a(map2, "adWidth", -1);
        int a2 = m3789a(map2, "adHeight", -1);
        if (str == null || str.isEmpty()) {
            Log.e("Tappx", "MoPub adapter: invalid app key as server parameter");
            customEventBannerListener.onBannerFailed(MoPubErrorCode.ADAPTER_CONFIGURATION_ERROR);
            return;
        }
        TappxBanner.AdSize a3 = m3791a(a, a2);
        TappxBanner tappxBanner = new TappxBanner(context, str);
        this.f2610a = tappxBanner;
        tappxBanner.setListener(new C1722a(customEventBannerListener, (C17211) null));
        this.f2610a.setAdSize(a3);
        this.f2610a.loadAd(new AdRequest().mediator(BuildConfig.SDK_NAME));
        Log.v("Tappx", "Loading " + getClass().getSimpleName());
    }

    /* access modifiers changed from: protected */
    public void onInvalidate() {
        TappxBanner tappxBanner = this.f2610a;
        if (tappxBanner != null) {
