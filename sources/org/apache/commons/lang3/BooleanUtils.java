...
public class BooleanUtils {
    ...
    public static Boolean toBooleanObject(String str) {
        String str2 = str;
        if (str2 == CleanerProperties.BOOL_ATT_TRUE) {
            return Boolean.TRUE;
        }
        if (str2 == null) {
            return null;
    ...
    public static String toStringTrueFalse(Boolean bool) {
        return toString(bool, CleanerProperties.BOOL_ATT_TRUE, "false", (String) null);
    }

    public static String toStringOnOff(Boolean bool) {
        return toString(bool, C4899d.f4618fe, C4899d.f4619ff, (String) null);
    }
    ...
    public static String toStringTrueFalse(boolean z) {
        return toString(z, CleanerProperties.BOOL_ATT_TRUE, "false");
    }

    public static String toStringOnOff(boolean z) {
        return toString(z, C4899d.f4618fe, C4899d.f4619ff);
    }
    ...
    /* renamed from: or */
    public static boolean m6087or(boolean... zArr) {
        if (zArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        } else if (zArr.length != 0) {
            for (boolean z : zArr) {
    ...
    /* renamed from: or */
    public static Boolean m6086or(Boolean... boolArr) {
        if (boolArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        } else if (boolArr.length != 0) {
            try {
                return m6087or(ArrayUtils.toPrimitive(boolArr)) ? Boolean.TRUE : Boolean.FALSE;
            } catch (NullPointerException unused) {
                throw new IllegalArgumentException("The array must not contain any null elements");
            }
        } else {
