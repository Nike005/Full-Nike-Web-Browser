    ...
    static /* synthetic */ class C06161 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.nativeads.NativeErrorCode.C06161.<clinit>():void");
        }
    }

    public int getIntCode() {
        int i = C06161.$SwitchMap$com$mopub$nativeads$NativeErrorCode[ordinal()];
        if (i == 1) {
            return 2;
        }
        if (i != 2) {
