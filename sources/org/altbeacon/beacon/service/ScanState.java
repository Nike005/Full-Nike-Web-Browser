...
public class ScanState implements Serializable {
    ...
    public static org.altbeacon.beacon.service.ScanState restore(android.content.Context r10) {
        ...
        L_0x0053:
            ...
            org.altbeacon.beacon.logging.LogManager.m6046d(r1, r6, r7)     // Catch:{ all -> 0x007b }
            goto L_0x0071
        L_0x0061:
            ...
            org.altbeacon.beacon.logging.LogManager.m6048e(r6, r7, r8)     // Catch:{ all -> 0x007b }
            java.lang.String r6 = TAG     // Catch:{ all -> 0x007b }
        ...
        L_0x0080:
            ...
            org.altbeacon.beacon.logging.LogManager.m6054w(r3, r6, r7)     // Catch:{ all -> 0x00e5 }
        ...
        L_0x00a5:
            ...
            org.altbeacon.beacon.logging.LogManager.m6046d(r10, r1, r2)     // Catch:{ all -> 0x00ec }
    ...
    public void save() {
        /*
            ...
            org.altbeacon.beacon.logging.LogManager.m6046d(r6, r7, r8)     // Catch:{ IOException -> 0x008e }
            java.lang.String r6 = TAG     // Catch:{ IOException -> 0x008e }
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x008e }
            r7.<init>()     // Catch:{ IOException -> 0x008e }
            ...
            java.lang.Object[] r8 = new java.lang.Object[r2]     // Catch:{ IOException -> 0x008e }
            org.altbeacon.beacon.logging.LogManager.m6048e(r6, r7, r8)     // Catch:{ IOException -> 0x008e }
        L_0x0076:
            ...
            org.altbeacon.beacon.logging.LogManager.m6048e(r1, r5, r6)     // Catch:{ IOException -> 0x008e }
        L_0x0085:
        ...
        L_0x00a1:
            ...
            org.altbeacon.beacon.logging.LogManager.m6048e(r5, r6, r7)     // Catch:{ all -> 0x00c2 }
    ...
    public int getScanJobRuntimeMillis() {
        long j;
        String str = TAG;
        LogManager.m6046d(str, "ScanState says background mode for ScanJob is " + getBackgroundMode(), new Object[0]);
        if (getBackgroundMode().booleanValue()) {
    ...
    public void applyChanges(BeaconManager beaconManager) {
        ...
        String str = TAG;
        LogManager.m6046d(str, "ranged regions: old=" + arrayList2.size() + " new=" + arrayList4.size(), new Object[0]);
        String str2 = TAG;
        LogManager.m6046d(str2, "monitored regions: old=" + arrayList.size() + " new=" + arrayList3.size(), new Object[0]);
        Iterator it = arrayList4.iterator();
        while (it.hasNext()) {
            Region region = (Region) it.next();
            if (!arrayList2.contains(region)) {
                String str3 = TAG;
                LogManager.m6046d(str3, "Starting ranging region: " + region, new Object[0]);
        ...
        while (it2.hasNext()) {
            ...
            if (!arrayList4.contains(region2)) {
                String str4 = TAG;
                LogManager.m6046d(str4, "Stopping ranging region: " + region2, new Object[0]);
                this.mRangedRegionState.remove(region2);
            }
        }
        String str5 = TAG;
        LogManager.m6046d(str5, "Updated state with " + arrayList4.size() + " ranging regions and " + arrayList3.size() + " monitoring regions.", new Object[0]);
        save();
    }
}
