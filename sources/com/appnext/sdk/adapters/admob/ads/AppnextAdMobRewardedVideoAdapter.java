...
public class AppnextAdMobRewardedVideoAdapter implements MediationRewardedVideoAdAdapter {
    ...
    /* renamed from: ad */
    AppnextRewardedVideoAd f4907ad;
    ...
    public void initialize(Context context, MediationAdRequest mediationAdRequest, String str, MediationRewardedVideoAdListener mediationRewardedVideoAdListener, Bundle bundle, Bundle bundle2) {
        ...
        if (serializable2 == null || !(serializable2 instanceof RewardedConfig)) {
            this.f4907ad = new AppnextRewardedVideoAd(context, str2);
        } else {
            this.f4907ad = new AppnextRewardedVideoAd(context, str2, (RewardedConfig) serializable2);
        }
        if (serializable != null && (serializable instanceof RewardedServerSidePostback)) {
            ...
            this.f4907ad.setRewardedServerSidePostback(rewardedServerSidePostback.getRewardsTransactionId(), rewardedServerSidePostback.getRewardsUserId(), rewardedServerSidePostback.getRewardsRewardTypeCurrency(), rewardedServerSidePostback.getRewardsAmountRewarded(), rewardedServerSidePostback.getRewardsCustomParameter());
        }
        this.f4907ad.setOnAdErrorCallback(new OnAdError() {
        ...
        this.f4907ad.setOnAdClickedCallback(new OnAdClicked() {
        ...
        this.f4907ad.setOnAdClosedCallback(new OnAdClosed() {
        ...
        this.f4907ad.setOnAdLoadedCallback(new OnAdLoaded() {
        ...
        this.f4907ad.setOnAdOpenedCallback(new OnAdOpened() {
        ...
        this.f4907ad.setOnVideoEndedCallback(new OnVideoEnded() {
    ...
    public void loadAd(MediationAdRequest mediationAdRequest, Bundle bundle, Bundle bundle2) {
        AppnextRewardedVideoAd appnextRewardedVideoAd = this.f4907ad;
