...
final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSource.SourceInfoRefreshListener, DefaultMediaClock.PlaybackParameterListener, PlayerMessage.Sender {
    ...
    public synchronized void sendMessage(PlayerMessage playerMessage) {
        if (this.released) {
            Log.m6210w(TAG, "Ignoring messages sent after release.");
    ...
    public boolean handleMessage(Message message) {
        ...
        try {
            ...
            Log.m6207e(TAG, "Internal runtime error.", e3);
    ...
    private void seekToCurrentPosition(boolean z) throws ExoPlaybackException {
        MediaSource.MediaPeriodId mediaPeriodId = this.queue.getPlayingPeriod().f5125info.f4079id;
    ...
    private void doSomeWork() throws ExoPlaybackException, IOException {
        ...
        long j = playingPeriod.f5125info.durationUs;
        if (z2 && ((j == -9223372036854775807L || j <= this.playbackInfo.positionUs) && playingPeriod.f5125info.isFinal)) {
            setState(4);
            stopRenderers();
    ...
    private void seekToInternal(androidx.media2.exoplayer.external.ExoPlayerImplInternal.SeekPosition r23) throws androidx.media2.exoplayer.external.ExoPlaybackException {
        ...
        L_0x008c:
            r4 = r12
        L_0x008d:
            long r6 = androidx.media2.exoplayer.external.C3875C.usToMs(r4)     // Catch:{ all -> 0x00de }
            androidx.media2.exoplayer.external.PlaybackInfo r0 = r1.playbackInfo     // Catch:{ all -> 0x00de }
            long r10 = r0.positionUs     // Catch:{ all -> 0x00de }
            long r10 = androidx.media2.exoplayer.external.C3875C.usToMs(r10)     // Catch:{ all -> 0x00de }
    ...
    private long seekToPeriodPosition(MediaSource.MediaPeriodId mediaPeriodId, long j, boolean z) throws ExoPlaybackException {
        ...
        while (true) {
            if (mediaPeriodHolder != null) {
                if (mediaPeriodId.equals(mediaPeriodHolder.f5125info.f4079id) && mediaPeriodHolder.prepared) {
    ...
    private void resetInternal(boolean r24, boolean r25, boolean r26, boolean r27) {
        ...
        L_0x0025:
            ...
            androidx.media2.exoplayer.external.util.Log.m6207e(r6, r7, r0)
        L_0x002a:
            int r5 = r5 + 1
            goto L_0x0018
        L_0x002d:
        ...
        L_0x003b:
            ...
            androidx.media2.exoplayer.external.util.Log.m6207e(r6, r0, r7)
        L_0x0042:
            int r5 = r5 + 1
            goto L_0x0033
        L_0x0045:
    ...
    public final /* synthetic */ void lambda$sendMessageToTargetThread$0$ExoPlayerImplInternal(PlayerMessage playerMessage) {
        try {
            ...
            Log.m6207e(TAG, "Unexpected error delivering message on external thread.", e);
    ...
    private boolean resolvePendingMessagePosition(PendingMessageInfo pendingMessageInfo) {
        if (pendingMessageInfo.resolvedPeriodUid == null) {
            Pair<Object, Long> resolveSeekPosition = resolveSeekPosition(new SeekPosition(pendingMessageInfo.message.getTimeline(), pendingMessageInfo.message.getWindowIndex(), C3875C.msToUs(pendingMessageInfo.message.getPositionMs())), false);
                ...
                if (selectTracks != null) {
                    if (z) {
                        ...
                        if (playingPeriod.prepared) {
                            playingPeriod.applyTrackSelection(selectTracks, Math.max(playingPeriod.f5125info.startPositionUs, playingPeriod.toPeriodTime(this.rendererPositionUs)), false);
                        }
                    }
    ...
    private boolean shouldTransitionToReadyState(boolean z) {
        ...
        MediaPeriodHolder loadingPeriod = this.queue.getLoadingPeriod();
        if ((loadingPeriod.isFullyBuffered() && loadingPeriod.f5125info.isFinal) || this.loadControl.shouldStartPlayback(getTotalBufferedDurationUs(), this.mediaClock.getPlaybackParameters().speed, this.rebuffering)) {
            return true;
        }
        return false;
    }
    ...
    private boolean isTimelineReady() {
        ...
        long j = playingPeriod.f5125info.durationUs;
        return j == -9223372036854775807L || this.playbackInfo.positionUs < j || (next != null && (next.prepared || next.f5125info.f4079id.isAd()));
    }
    ...
    private void handleSourceInfoRefreshed(androidx.media2.exoplayer.external.ExoPlayerImplInternal.MediaSourceRefreshInfo r14) throws androidx.media2.exoplayer.external.ExoPlaybackException {
        ...
        L_0x00f9:
            ...
            androidx.media2.exoplayer.external.MediaPeriodInfo r1 = r14.f5125info
            androidx.media2.exoplayer.external.source.MediaSource$MediaPeriodId r1 = r1.f4079id
            boolean r1 = r1.equals(r6)
            if (r1 == 0) goto L_0x00f9
            androidx.media2.exoplayer.external.MediaPeriodQueue r1 = r13.queue
            androidx.media2.exoplayer.external.MediaPeriodInfo r2 = r14.f5125info
        ...
        if (mediaSource2 != null) {
            ...
            if (this.queue.hasPlayingPeriod()) {
                ...
                while (this.playWhenReady && playingPeriod != readingPeriod && this.rendererPositionUs >= playingPeriod.getNext().getStartPositionRendererTime()) {
                    ...
                    int i2 = playingPeriod.f5125info.isLastInTimelinePeriod ? 0 : 3;
                    MediaPeriodHolder advancePlayingPeriod = this.queue.advancePlayingPeriod();
                    updatePlayingPeriodRenderers(playingPeriod);
                    this.playbackInfo = this.playbackInfo.copyWithNewPosition(advancePlayingPeriod.f5125info.f4079id, advancePlayingPeriod.f5125info.startPositionUs, advancePlayingPeriod.f5125info.contentPositionUs, getTotalBufferedDurationUs());
                    this.playbackInfoUpdate.setPositionDiscontinuity(i2);
                    updatePlaybackPositions();
                    playingPeriod = advancePlayingPeriod;
                    z = true;
                }
                if (readingPeriod.f5125info.isFinal) {
                    while (true) {
                        Renderer[] rendererArr = this.renderers;
                        if (i < rendererArr.length) {
                            Renderer renderer = rendererArr[i];
    ...
    private void handlePeriodPrepared(MediaPeriod mediaPeriod) throws ExoPlaybackException {
        if (this.queue.isLoading(mediaPeriod)) {
            ...
            if (!this.queue.hasPlayingPeriod()) {
                resetRendererPosition(this.queue.advancePlayingPeriod().f5125info.startPositionUs);
    ...
    private void handleLoadingMediaPeriodChanged(boolean z) {
        long j;
        MediaPeriodHolder loadingPeriod = this.queue.getLoadingPeriod();
        MediaSource.MediaPeriodId mediaPeriodId = loadingPeriod == null ? this.playbackInfo.periodId : loadingPeriod.f5125info.f4079id;
