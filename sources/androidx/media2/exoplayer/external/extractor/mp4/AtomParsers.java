...
final class AtomParsers {
    ...
    public static Track parseTrak(Atom.ContainerAtom containerAtom, Atom.LeafAtom leafAtom, long j, DrmInitData drmInitData, boolean z, boolean z2) throws ParserException {
        ...
        StsdData parseStsd = parseStsd(containerAtomOfType2.getLeafAtomOfType(1937011556).data, parseTkhd.f4082id, parseTkhd.rotationDegrees, (String) parseMdhd.second, drmInitData, z2);
        if (!z) {
        ...
        return new Track(parseTkhd.f4082id, trackTypeForHdlr, ((Long) parseMdhd.first).longValue(), parseMvhd, j4, parseStsd.format, parseStsd.requiredSampleTransformation, parseStsd.trackEncryptionBoxes, parseStsd.nalUnitLengthFieldLength, jArr2, jArr);
    }
    ...
    public static TrackSampleTable parseStbl(Track track, Atom.ContainerAtom containerAtom, GaplessInfoHolder gaplessInfoHolder) throws ParserException {
        ...
        if (!(sampleSizeBox.isFixedSampleSize() && "audio/raw".equals(track3.format.sampleMimeType) && readUnsignedIntToInt == 0 && i == 0 && i2 == 0)) {
            ...
            while (true) {
                ...
                int i31 = i23;
                if (!z3) {
                    Log.m6210w(TAG, "Unexpected end of chunk data");
            ...
            track2 = track;
            int i38 = track2.f4083id;
            String str = !z2 ? ", ctts invalid" : "";
            StringBuilder sb = new StringBuilder(str.length() + MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_ROUTE_SELECTED);
