...
class IntentHandler {
    ...
    public void convertIntentsToCallbacks(Context context, Intent intent) {
        ...
        if (rangingData != null) {
            LogManager.m6046d(TAG, "got ranging data", new Object[0]);
            if (rangingData.getBeacons() == null) {
                LogManager.m6054w(TAG, "Ranging data has a null beacons collection", new Object[0]);
            }
            ...
            if (rangingNotifiers != null) {
                ...
                LogManager.m6046d(TAG, "but ranging notifier is null, so we're dropping it.", new Object[0]);
            }
        ...
        if (monitoringData != null) {
            LogManager.m6046d(TAG, "got monitoring data", new Object[0]);
            ...
            if (monitoringNotifiers != null) {
                for (MonitorNotifier next : monitoringNotifiers) {
                    LogManager.m6046d(TAG, "Calling monitoring notifier: %s", next);
