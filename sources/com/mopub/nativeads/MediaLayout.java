...
public class MediaLayout extends RelativeLayout {
    ...
    public void setMuteState(MuteState muteState) {
        ...
        if (muteState != this.mMuteState) {
            ...
            if (C05822.$SwitchMap$com$mopub$nativeads$MediaLayout$MuteState[this.mMuteState.ordinal()] != 1) {
    ...
    /* renamed from: com.mopub.nativeads.MediaLayout$2 */
    static /* synthetic */ class C05822 {
        ...
        static {
            ...
            L_0x0064:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.nativeads.MediaLayout.C05822.<clinit>():void");
        }
    }

    /* access modifiers changed from: private */
    public void updateViewState() {
        switch (C05822.$SwitchMap$com$mopub$nativeads$MediaLayout$Mode[this.mMode.ordinal()]) {
            case 1:
