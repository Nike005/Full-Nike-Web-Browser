...
public final class SubripDecoder extends SimpleSubtitleDecoder {
            ...
            if (readLine == null) {
                ...
                try {
                    ...
                    if (matcher.matches()) {
                        ...
                        Log.m6210w(TAG, valueOf.length() != 0 ? "Skipping invalid timing: ".concat(valueOf) : new String("Skipping invalid timing: "));
                    }
                } catch (NumberFormatException unused) {
                    String valueOf2 = String.valueOf(readLine);
                    Log.m6210w(TAG, valueOf2.length() != 0 ? "Skipping invalid index: ".concat(valueOf2) : new String("Skipping invalid index: "));
                }
            }
        }
    ...
    private androidx.media2.exoplayer.external.text.Cue buildCue(android.text.Spanned r19, java.lang.String r20) {
        /*
            r18 = this;
            r0 = r20
            if (r0 != 0) goto L_0x000c
            androidx.media2.exoplayer.external.text.Cue r0 = new androidx.media2.exoplayer.external.text.Cue
            r2 = r19
            r0.<init>(r2)
            return r0
        L_0x000c:
        ...
        L_0x00f2:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.exoplayer.external.text.subrip.SubripDecoder.buildCue(android.text.Spanned, java.lang.String):androidx.media2.exoplayer.external.text.Cue");
    }
