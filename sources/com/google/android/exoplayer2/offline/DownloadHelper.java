...
public final class DownloadHelper {
    ...
    public static DownloadHelper forProgressive(Context context, Uri uri2) {
        return forProgressive(context, uri2, (String) null);
    }

    @Deprecated
    public static DownloadHelper forProgressive(Uri uri2, String str) {
        return new DownloadHelper(DownloadRequest.TYPE_PROGRESSIVE, uri2, str, (MediaSource) null, DEFAULT_TRACK_SELECTOR_PARAMETERS_WITHOUT_VIEWPORT, new RendererCapabilities[0]);
    }

    public static DownloadHelper forProgressive(Context context, Uri uri2, String str) {
        return new DownloadHelper(DownloadRequest.TYPE_PROGRESSIVE, uri2, str, (MediaSource) null, getDefaultTrackSelectorParameters(context), new RendererCapabilities[0]);
    }

    @Deprecated
    public static DownloadHelper forDash(Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory) {
        return forDash(uri2, factory, renderersFactory, (DrmSessionManager<FrameworkMediaCrypto>) null, DEFAULT_TRACK_SELECTOR_PARAMETERS_WITHOUT_VIEWPORT);
    }
    ...
    public static DownloadHelper forDash(Context context, Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory) {
        return forDash(uri2, factory, renderersFactory, (DrmSessionManager<FrameworkMediaCrypto>) null, getDefaultTrackSelectorParameters(context));
    }

    public static DownloadHelper forDash(Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, DefaultTrackSelector.Parameters parameters) {
        return new DownloadHelper(DownloadRequest.TYPE_DASH, uri2, (String) null, createMediaSourceInternal(DASH_FACTORY_CONSTRUCTOR, uri2, factory, (List<StreamKey>) null), parameters, Util.getRendererCapabilities(renderersFactory, drmSessionManager));
    }

    @Deprecated
    public static DownloadHelper forHls(Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory) {
        return forHls(uri2, factory, renderersFactory, (DrmSessionManager<FrameworkMediaCrypto>) null, DEFAULT_TRACK_SELECTOR_PARAMETERS_WITHOUT_VIEWPORT);
    }
    ...
    public static DownloadHelper forHls(Context context, Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory) {
        return forHls(uri2, factory, renderersFactory, (DrmSessionManager<FrameworkMediaCrypto>) null, getDefaultTrackSelectorParameters(context));
    }

    public static DownloadHelper forHls(Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, DefaultTrackSelector.Parameters parameters) {
        return new DownloadHelper(DownloadRequest.TYPE_HLS, uri2, (String) null, createMediaSourceInternal(HLS_FACTORY_CONSTRUCTOR, uri2, factory, (List<StreamKey>) null), parameters, Util.getRendererCapabilities(renderersFactory, drmSessionManager));
    }

    @Deprecated
    public static DownloadHelper forSmoothStreaming(Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory) {
        return forSmoothStreaming(uri2, factory, renderersFactory, (DrmSessionManager<FrameworkMediaCrypto>) null, DEFAULT_TRACK_SELECTOR_PARAMETERS_WITHOUT_VIEWPORT);
    }
    ...
    public static DownloadHelper forSmoothStreaming(Context context, Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory) {
        return forSmoothStreaming(uri2, factory, renderersFactory, (DrmSessionManager<FrameworkMediaCrypto>) null, getDefaultTrackSelectorParameters(context));
    }

    public static DownloadHelper forSmoothStreaming(Uri uri2, DataSource.Factory factory, RenderersFactory renderersFactory, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, DefaultTrackSelector.Parameters parameters) {
        return new DownloadHelper(DownloadRequest.TYPE_SS, uri2, (String) null, createMediaSourceInternal(SS_FACTORY_CONSTRUCTOR, uri2, factory, (List<StreamKey>) null), parameters, Util.getRendererCapabilities(renderersFactory, drmSessionManager));
    }
    ...
    public DownloadHelper(String str, Uri uri2, String str2, MediaSource mediaSource2, DefaultTrackSelector.Parameters parameters, RendererCapabilities[] rendererCapabilitiesArr) {
        ...
        this.trackSelector = new DefaultTrackSelector(parameters, (TrackSelection.Factory) new DownloadTrackSelection.Factory());
    ...
    public void onMediaPrepared() {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            ...
            this.trackSelector.onSelectionActivated(runTrackSelection(i3).f5083info);
    ...
    private static Constructor<? extends MediaSourceFactory> getConstructor(String str) {
        try {
            return Class.forName(str).asSubclass(MediaSourceFactory.class).getConstructor(new Class[]{DataSource.Factory.class});
    ...
    private static MediaSource createMediaSourceInternal(Constructor<? extends MediaSourceFactory> constructor, Uri uri2, DataSource.Factory factory, List<StreamKey> list) {
        if (constructor != null) {
            try {
