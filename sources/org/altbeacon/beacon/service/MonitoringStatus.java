...
public class MonitoringStatus {
    ...
    public synchronized void updateNewlyOutside() {
        ...
        for (Region next : regions()) {
            ...
            if (stateOf.markOutsideIfExpired()) {
                LogManager.m6046d(TAG, "found a monitor that expired: %s", next);
    ...
    private void restoreOrInitializeMonitoringStatus() {
        ...
        if (!this.mStatePreservationIsOn) {
            LogManager.m6046d(TAG, "Not restoring monitoring state because persistence is disabled", new Object[0]);
        } else if (currentTimeMillis > 900000) {
            String str = TAG;
            LogManager.m6046d(str, "Not restoring monitoring state because it was recorded too many milliseconds ago: " + currentTimeMillis, new Object[0]);
        } else {
            restoreMonitoringStatus();
            LogManager.m6046d(TAG, "Done restoring monitoring status", new Object[0]);
        }
    }
    ...
    public void saveMonitoringStatusIfOn() {
        ...
        L_0x0005:
            ...
            org.altbeacon.beacon.logging.LogManager.m6046d(r0, r3, r2)
            ...
            org.altbeacon.beacon.logging.LogManager.m6054w(r0, r2, r1)
        ...
        L_0x007d:
            ...
            org.altbeacon.beacon.logging.LogManager.m6048e(r4, r5, r6)     // Catch:{ all -> 0x0099 }
    ...
    public void restoreMonitoringStatus() {
        /*
            ...
            org.altbeacon.beacon.logging.LogManager.m6046d(r4, r5, r6)     // Catch:{ IOException -> 0x00ab, ClassNotFoundException -> 0x00a9, ClassCastException -> 0x00a7 }
        ...
        L_0x003e:
            ...
            org.altbeacon.beacon.logging.LogManager.m6046d(r6, r5, r7)     // Catch:{ IOException -> 0x00ab, ClassNotFoundException -> 0x00a9, ClassCastException -> 0x00a7 }
            goto L_0x003e
        L_0x007b:
        ...
        L_0x00c6:
            ...
            org.altbeacon.beacon.logging.LogManager.m6046d(r0, r4, r1)     // Catch:{ all -> 0x00ef }
            goto L_0x00e4
        L_0x00d4:
            ...
            org.altbeacon.beacon.logging.LogManager.m6048e(r4, r5, r6)     // Catch:{ all -> 0x00ef }
        L_0x00e4:
        ...
        if (getRegionsStateMap().containsKey(region)) {
            ...
            while (true) {
                ...
                if (next.equals(region)) {
                    ...
                    String str = TAG;
                    LogManager.m6046d(str, "Replacing region with unique identifier " + region.getUniqueId(), new Object[0]);
                    String str2 = TAG;
                    LogManager.m6046d(str2, "Old definition: " + next, new Object[0]);
                    String str3 = TAG;
                    LogManager.m6046d(str3, "New definition: " + region, new Object[0]);
                    LogManager.m6046d(TAG, "clearing state", new Object[0]);
                    getRegionsStateMap().remove(region);
                }
            }
        }
