...
final class zzari extends WebView implements ViewTreeObserver.OnGlobalLayoutListener, DownloadListener, zzaqw {
    ...
    public final synchronized void destroy() {
        ...
        if (!this.zzddj) {
            ...
            zzvn();
            this.zzddj = true;
            zzakb.m43v("Initiating WebView self destruct sequence in 3...");
            zzakb.m43v("Loading blank page in WebView, 2...");
            zzdt(Constants.SCHEME_BLANK);
        }
    }
    ...
    public final synchronized void zza(zzarl zzarl) {
        if (this.zzddp != null) {
            zzakb.m44e("Attempt to create multiple AdWebViewVideoControllers.");
        } else {
            this.zzddp = zzarl;
        }
    }
    ...
    public final void zzus() {
        zzakb.m43v("Cannot add text view to inner AdWebView");
    }
}
