...
public final class zzaad {
    ...
    public final void execute() {
        if (this.zzbnd == null) {
            ...
            this.zzbnd.setRequestedOrientation(C4924Ad.ORIENTATION_PORTRAIT.equalsIgnoreCase(this.zzbwn) ? zzbv.zzem().zzrm() : C4924Ad.ORIENTATION_LANDSCAPE.equalsIgnoreCase(this.zzbwn) ? zzbv.zzem().zzrl() : this.zzbwm ? -1 : zzbv.zzem().zzrn());
        }
    }
}
