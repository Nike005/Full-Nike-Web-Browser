...
class OSInAppMessageController implements OSDynamicTriggerController.OSDynamicTriggerControllerObserver, OSSystemConditionController.OSSystemConditionObserver {
    ...
    private static ArrayList<String> PREFERRED_VARIANT_ORDER = new ArrayList<String>() {
        {
            add(SystemMediaRouteProvider.PACKAGE_NAME);
            add("app");
    ...
    public void showAlertDialogMessage(final OSInAppMessage oSInAppMessage, final List<OSInAppMessagePrompt> list) {
        String string = OneSignal.appContext.getString(C0770R.string.location_not_available_title);
        new AlertDialog.Builder(ActivityLifecycleHandler.curActivity).setTitle(string).setMessage(OneSignal.appContext.getString(C0770R.string.location_not_available_message)).setPositiveButton(17039370, new DialogInterface.OnClickListener() {
