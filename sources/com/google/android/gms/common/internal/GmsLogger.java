...
public final class GmsLogger {
    ...
    /* renamed from: d */
    public final void mo4110d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zza(str2));
        }
    }
    ...
    /* renamed from: d */
    public final void mo4111d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* renamed from: v */
    public final void mo4119v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zza(str2));
        }
    }
    ...
    /* renamed from: v */
    public final void mo4120v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* renamed from: i */
    public final void mo4115i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zza(str2));
        }
    }
    ...
    /* renamed from: i */
    public final void mo4116i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* renamed from: w */
    public final void mo4121w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zza(str2));
        }
    }
    ...
    /* renamed from: w */
    public final void mo4122w(String str, String str2, Throwable th) {
        if (canLog(5)) {
    ...
    /* renamed from: e */
    public final void mo4112e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zza(str2));
        }
    }
    ...
    /* renamed from: e */
    public final void mo4113e(String str, String str2, Throwable th) {
        if (canLog(6)) {
