        ...
        if (i != 160) {
            if (i == ID_TRACK_ENTRY) {
                ...
                if (this.currentTrack.cryptoData != null) {
                    this.currentTrack.drmInitData = new DrmInitData(new DrmInitData.SchemeData(C3875C.UUID_NIL, "video/webm", this.currentTrack.cryptoData.encryptionKey));
                    return;
                }
    ...
    private static final class Track {
        ...
        public void initializeOutput(androidx.media2.exoplayer.external.extractor.ExtractorOutput r43, int r44) throws androidx.media2.exoplayer.external.ParserException {
            ...
            L_0x01ba:
                ...
                androidx.media2.exoplayer.external.util.Log.m6210w(r9, r1)
                goto L_0x0334
            L_0x01e4:
                r26 = r1
                r4 = r16
        ...
        private static Pair<String, List<byte[]>> parseFourCcPrivate(ParsableByteArray parsableByteArray) throws ParserException {
            try {
                ...
                Log.m6210w(MatroskaExtractor.TAG, "Unknown FourCC. Setting mimeType to video/x-unknown");
