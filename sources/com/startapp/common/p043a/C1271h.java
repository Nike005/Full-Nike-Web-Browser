...
public class C1271h {
    ...
    public static class C1273b {
        ...
        /* renamed from: a */
        public String mo15471a() {
            return this.f1503a;
        }

        /* renamed from: b */
        public String mo15473b() {
            return this.f1504b;
        }

        /* renamed from: c */
        public String mo15475c() {
            return this.f1505c;
        }

        /* renamed from: a */
        public void mo15472a(String str) {
            this.f1503a = str;
        }

        /* renamed from: b */
        public void mo15474b(String str) {
            this.f1504b = str;
        }

        /* renamed from: c */
        public void mo15476c(String str) {
            this.f1505c = str;
        }
    }
    ...
    public static class C1272a {
        ...
        /* renamed from: b */
        public String mo15468b() {
            return this.f1502b;
        }

        /* renamed from: b */
        public void mo15469b(String str) {
            this.f1502b = str;
        }

        public String toString() {
            return "HttpResult: " + this.f1502b + StringUtils.SPACE + this.f1501a;
        }
    }
    ...
    /* renamed from: a */
    public static String m2084a(Context context, String str, byte[] bArr, Map<String, String> map, String str2, boolean z) {
        return m2085a(context, str, bArr, map, str2, z, "application/json");
    }
    ...
    public static java.lang.String m2085a(android.content.Context r4, java.lang.String r5, byte[] r6, java.util.Map<java.lang.String, java.lang.String> r7, java.lang.String r8, boolean r9, java.lang.String r10) {
        /*
            r0 = 0
            r1 = 0
            java.net.HttpURLConnection r4 = m2088b(r4, r5, r6, r7, r8, r9, r10)     // Catch:{ Exception -> 0x00c0, all -> 0x00bd }
        ...
        L_0x00ee:
            goto L_0x00ed
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.common.p043a.C1271h.m2085a(android.content.Context, java.lang.String, byte[], java.util.Map, java.lang.String, boolean, java.lang.String):java.lang.String");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static com.startapp.common.p043a.C1271h.C1272a m2081a(android.content.Context r10, java.lang.String r11, java.util.Map<java.lang.String, java.lang.String> r12, java.lang.String r13, boolean r14) {
        /*
            r2 = 0
            r6 = 0
            r7 = 1
            ...
            r4 = r13
            r5 = r14
            java.net.HttpURLConnection r10 = m2088b(r0, r1, r2, r3, r4, r5, r6)     // Catch:{ Exception -> 0x00ba, all -> 0x00b7 }
            ...
            com.startapp.common.p047d.C1299a.m2194b(r10, r11)     // Catch:{ Exception -> 0x005f, all -> 0x00b1 }
            ...
            r11.mo15469b(r13)     // Catch:{ Exception -> 0x005f, all -> 0x00b1 }
        ...
        L_0x004b:
            ...
            r11.mo15467a(r13)     // Catch:{ Exception -> 0x005f, all -> 0x00b1 }
        L_0x0052:
        ...
        L_0x00e8:
            goto L_0x00e7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.common.p043a.C1271h.m2081a(android.content.Context, java.lang.String, java.util.Map, java.lang.String, boolean):com.startapp.common.a.h$a");
    }

    /* renamed from: b */
    private static HttpURLConnection m2088b(Context context, String str, byte[] bArr, Map<String, String> map, String str2, boolean z, String str3) {
        HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(str).openConnection();
        httpURLConnection.addRequestProperty("Cache-Control", "no-cache");
        C1299a.m2192a(httpURLConnection, str);
    ...
    /* renamed from: a */
    public static String m2083a(Context context) {
        String str = "WIFI";
        try {
    ...
    /* renamed from: a */
    public static C1273b m2082a(Context context, String str) {
        if (str.toLowerCase().compareTo("WIFI".toLowerCase()) == 0) {
            return m2087b(context);
        }
        return null;
    }

    /* renamed from: b */
    public static C1273b m2087b(Context context) {
        String str = "e100";
            ...
            if (connectivityManager != null) {
                if (C1261c.m2031a(context, "android.permission.ACCESS_NETWORK_STATE")) {
                    ...
                    if (activeNetworkInfo == null || !activeNetworkInfo.isConnected()) {
                        ...
                        str2 = "e103";
                    } else if (C1261c.m2031a(context, "android.permission.ACCESS_WIFI_STATE")) {
                        int rssi = ((WifiManager) context.getApplicationContext().getSystemService("wifi")).getConnectionInfo().getRssi();
                        bVar.mo15476c(Integer.toString(WifiManager.calculateSignalLevel(rssi, 5)));
                        bVar.mo15474b(Integer.toString(rssi));
                        str2 = null;
                    }
                }
                str = str2;
    ...
    /* renamed from: c */
    public static Boolean m2089c(Context context) {
        NetworkInfo activeNetworkInfo;
        ConnectivityManager connectivityManager = (ConnectivityManager) context.getSystemService("connectivity");
        if (connectivityManager == null || !C1261c.m2031a(context, "android.permission.ACCESS_NETWORK_STATE") || (activeNetworkInfo = connectivityManager.getActiveNetworkInfo()) == null || !activeNetworkInfo.isConnected()) {
            return null;
        }
    ...
    /* renamed from: a */
    public static String m2086a(WifiInfo wifiInfo) {
