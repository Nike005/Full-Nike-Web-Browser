...
public abstract class Evaluator {
    ...
    public static final class Tag extends Evaluator {
        ...
        public String toString() {
            return String.format(UrlUtils.QUERY_PLACE_HOLDER, new Object[]{this.tagName});
        }
    }
    ...
    public static final class C2530Id extends Evaluator {

        /* renamed from: id */
        private String f3969id;

        public C2530Id(String str) {
            this.f3969id = str;
        }

        public boolean matches(Element element, Element element2) {
            return this.f3969id.equals(element2.mo22818id());
        }

        public String toString() {
            return String.format("#%s", new Object[]{this.f3969id});
        }
    }
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
        ...
        /* renamed from: a */
        protected final int f3967a;

        /* renamed from: b */
        protected final int f3968b;
        ...
        public boolean matches(Element element, Element element2) {
            ...
            if (i != 0) {
                ...
                return true;
            } else if (calculatePosition == this.f3968b) {
                return true;
            } else {
                return false;
            }
        ...
        public String toString() {
            if (this.f3967a == 0) {
                return String.format(":%s(%d)", new Object[]{getPseudoClass(), Integer.valueOf(this.f3968b)});
            } else if (this.f3968b == 0) {
                return String.format(":%s(%dn)", new Object[]{getPseudoClass(), Integer.valueOf(this.f3967a)});
            } else {
                return String.format(":%s(%dn%+d)", new Object[]{getPseudoClass(), Integer.valueOf(this.f3967a), Integer.valueOf(this.f3968b)});
            }
        }
    }
