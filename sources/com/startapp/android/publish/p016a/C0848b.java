...
public class C0848b extends LinearLayout {

    /* renamed from: a */
    private static Map<String, String> f402a = new HashMap<String, String>() {
        {
    ...
    public void setRating(float f) {
        ...
        for (int i3 = 0; i3 < floor; i3++) {
            m451a("filled_star.png");
        }
        if (i != 0) {
            m451a("half_star.png");
        }
        for (int i4 = 0; i4 < i2; i4++) {
            m451a("empty_star.png");
        }
    }
    ...
    private void m451a(String str) {
        try {
            int a = C1060h.m1162a(getContext(), 2);
            int a2 = C1060h.m1162a(getContext(), 5);
            ImageView imageView = new ImageView(getContext());
            Bitmap a3 = C1049a.m1129a(getContext(), str);
            if (a3 == null) {
                a3 = C1265d.m2054a(f402a.get(str));
            }
            imageView.setImageBitmap(Bitmap.createScaledBitmap(a3, C1060h.m1162a(getContext(), 15), C1060h.m1162a(getContext(), 15), true));
