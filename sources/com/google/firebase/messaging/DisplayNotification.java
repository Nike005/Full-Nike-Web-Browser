...
class DisplayNotification {
    ...
    private void showNotification(CommonNotificationBuilder.DisplayNotificationInfo displayNotificationInfo) {
        ...
        ((NotificationManager) this.context.getSystemService(OneSignalDbContract.NotificationTable.TABLE_NAME)).notify(displayNotificationInfo.tag, displayNotificationInfo.f38id, displayNotificationInfo.notificationBuilder.build());
    }
}
