...
public class DataSdkActivity extends AppCompatActivity {
    ...
    public static void startRequestPermissions(Context context, ConfigPhp configPhp2, String str) {
        if (PermissionsRequester.isPermissionsRequired(configPhp2, context) || (!DataSdkController.isSdkAccepted(context) && !TextUtils.isEmpty(str))) {
            ...
            intent.putExtra(CONFIG_PHP_KEY, configPhp2);
    ...
    public void showEulaDialog(String str, ConfigPhp configPhp2) {
        View inflate = getLayoutInflater().inflate(C5051R.layout.appsgeysersdk_datasdk_dialog, (ViewGroup) null);
        ((TextView) inflate.findViewById(C5051R.C5054id.appsgeysersdk_datasdk_dialog_title)).setText(getString(C5051R.string.appsgeysersdk_eula_title));
        AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(this, C5051R.style.MaterialAlertDialog));
        builder.setCancelable(false);
        ((TextView) inflate.findViewById(C5051R.C5054id.appsgeysersdk_datasdk_dialog_accept)).setOnClickListener(new View.OnClickListener(configPhp2, this) {
        ...
        ((TextView) inflate.findViewById(C5051R.C5054id.appsgeysersdk_datasdk_dialog_decline)).setOnClickListener(new View.OnClickListener(this, configPhp2, str) {
        ...
        WebView webView = (WebView) inflate.findViewById(C5051R.C5054id.appsgeysersdk_datasdk_dialog_web_view);
        webView.loadData(new StringBuilder(str).insert(0, configPhp2.getEulaBeginning() != null ? configPhp2.getEulaBeginning() : "").toString(), MIME_TYPE, "UTF-8");
        webView.setScrollbarFadingEnabled(false);
        new PreferencesCoder(this).savePrefLong(DataSdkController.PREFS_ELAPSED_TIME, 0);
