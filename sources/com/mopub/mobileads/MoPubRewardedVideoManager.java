...
public class MoPubRewardedVideoManager {
    ...
    public void onAdSuccess(AdResponse adResponse) {
        ...
        try {
            ...
            treeMap.put(DataKeys.BROADCAST_IDENTIFIER_KEY, Long.valueOf(C0421Utils.generateUniqueId()));
    ...
    public void onAdError(VolleyError volleyError, String str) {
        ...
        if (volleyError instanceof MoPubNetworkError) {
            int i = C045415.$SwitchMap$com$mopub$network$MoPubNetworkError$Reason[((MoPubNetworkError) volleyError).getReason().ordinal()];
            if (i == 1 || i == 2) {
    ...
    /* renamed from: com.mopub.mobileads.MoPubRewardedVideoManager$15 */
    static /* synthetic */ class C045415 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.mobileads.MoPubRewardedVideoManager.C045415.<clinit>():void");
        }
    }
