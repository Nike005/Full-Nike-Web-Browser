...
public final class C4967f {
    ...
    /* renamed from: fd */
    static final int f4788fd = 8000;

    /* renamed from: gP */
    private static final String f4789gP = "expiredTimems";

    /* renamed from: gQ */
    private static double f4790gQ = -1.0d;

    /* renamed from: gR */
    private static HashMap<String, Bitmap> f4791gR = new HashMap<>();

    /* renamed from: gS */
    private static String f4792gS = "";

    /* renamed from: gT */
    private static String f4793gT = "";

    /* renamed from: gU */
    private static String f4794gU = "";

    /* renamed from: gV */
    public static final Executor f4795gV = new ThreadPoolExecutor(Runtime.getRuntime().availableProcessors() + 1, (Runtime.getRuntime().availableProcessors() * 2) + 1, 1, TimeUnit.SECONDS, new LinkedBlockingQueue(128), new ThreadFactory() {

        /* renamed from: gW */
        private final AtomicInteger f4796gW = new AtomicInteger(1);

        public final Thread newThread(Runnable runnable) {
            return new Thread(runnable, "AsyncTask #" + this.f4796gW.getAndIncrement());
        }
    });

    /* renamed from: bg */
    public static double m6836bg() {
        return 0.0d;
    }

    /* renamed from: c */
    public static void m6841c(Throwable th) {
    }

    /* renamed from: o */
    public static void m6850o(String str) {
    }
    ...
    /* renamed from: l */
    public static String m6845l(Context context) {
        return m6827b(context, true);
    }

    /* renamed from: b */
    public static String m6827b(Context context, boolean z) {
        String str;
        ...
        try {
            ...
            str = AdsIDHelper.m6697a(context.getApplicationContext(), z);
    ...
    /* renamed from: m */
    static void m6847m(Context context) {
        try {
            WebView webView = new WebView(context);
            f4792gS = webView.getSettings().getUserAgentString();
            webView.destroy();
    ...
    /* renamed from: bd */
    static String m6833bd() {
        return f4792gS;
    }

    /* renamed from: V */
    private static void m6806V(String str) {
        f4792gS = str;
    }

    /* renamed from: be */
    public static String m6834be() {
        try {
            return URLEncoder.encode("android " + Build.VERSION.SDK_INT + StringUtils.SPACE + Build.MANUFACTURER + StringUtils.SPACE + Build.MODEL, "UTF-8");
        } catch (Throwable unused) {
    ...
    /* renamed from: bf */
    public static int m6835bf() {
        Runtime runtime = Runtime.getRuntime();
        return (int) ((runtime.maxMemory() / 1048576) - ((runtime.totalMemory() - runtime.freeMemory()) / 1048576));
    }

    /* renamed from: a */
    public static String m6815a(String str, HashMap<String, String> hashMap) throws IOException {
        return m6818a(str, hashMap, true, 8000);
    }

    /* renamed from: a */
    public static String m6817a(String str, HashMap<String, String> hashMap, boolean z) throws IOException {
        return m6818a(str, hashMap, z, 8000);
    }

    /* renamed from: a */
    public static String m6816a(String str, HashMap<String, String> hashMap, int i) throws IOException {
        return m6818a(str, (HashMap<String, String>) null, true, i);
    }

    /* renamed from: a */
    public static String m6818a(String str, HashMap<String, String> hashMap, boolean z, int i) throws IOException {
        return new String(m6832b(str, hashMap, z, i, C4899d.C4900a.HashMap), "UTF-8");
    }

    /* renamed from: a */
    public static String m6813a(String str, ArrayList<Pair<String, String>> arrayList) throws IOException {
        return m6814a(str, arrayList, 8000);
    }

    /* renamed from: a */
    public static String m6814a(String str, ArrayList<Pair<String, String>> arrayList, int i) throws IOException {
        return new String(m6832b(str, arrayList, true, i, C4899d.C4900a.ArrayList), "UTF-8");
    }

    /* renamed from: b */
    public static String m6828b(String str, JSONObject jSONObject) throws IOException {
        return new String(m6832b(str, jSONObject, true, 8000, C4899d.C4900a.JSONObject), "UTF-8");
    }

    /* renamed from: a */
    public static byte[] m6824a(String str, Object obj, boolean z, int i) throws IOException {
        return m6832b(str, obj, z, i, C4899d.C4900a.HashMap);
    }

    /* renamed from: W */
    private static boolean m6807W(String str) {
        try {
            ...
            if (TextUtils.isEmpty(string) || !string.equals(m6827b(C4901e.getContext(), true))) {
                return false;
            }
            return true;
        } catch (Throwable unused) {
    ...
    /* renamed from: X */
    private static boolean m6808X(String str) {
        try {
            JSONObject jSONObject = new JSONObject(str);
            if (!jSONObject.has(f4789gP)) {
                return true;
            }
            if (System.currentTimeMillis() >= jSONObject.getLong(f4789gP)) {
                return true;
            }
            return false;
        } catch (Throwable unused) {
    ...
    public static byte[] m6825a(java.lang.String r18, java.lang.Object r19, boolean r20, int r21, com.appnext.base.p082b.C4899d.C4900a r22) throws java.lang.Exception {
        /*
            r0 = r19
            r1 = r22
            java.lang.String r2 = "secret"
            java.lang.String r3 = "rnd"
            com.appnext.base.services.a r4 = com.appnext.base.services.C4917a.m6668aK()
            ...
            boolean r5 = m6807W(r4)
            if (r5 == 0) goto L_0x002b
            boolean r5 = m6808X(r4)
            if (r5 == 0) goto L_0x0094
        L_0x002b:
            java.util.HashMap r4 = new java.util.HashMap
            r4.<init>()
            com.appnext.base.b.h r5 = com.appnext.base.p082b.C4904h.m6584aO()
            android.content.Context r12 = com.appnext.base.p082b.C4901e.getContext()
            java.lang.String r12 = m6827b((android.content.Context) r12, (boolean) r10)
            java.lang.String r5 = r5.mo41009M(r12)
            r4.put(r7, r5)
            ...
            com.appnext.base.b.d$a r12 = com.appnext.base.p082b.C4899d.C4900a.HashMap     // Catch:{ all -> 0x0207 }
            byte[] r4 = m6832b(r5, r4, r9, r8, r12)     // Catch:{ all -> 0x0207 }
        ...
        L_0x005c:
            ...
            android.content.Context r12 = com.appnext.base.p082b.C4901e.getContext()     // Catch:{ all -> 0x0207 }
            java.lang.String r12 = m6827b((android.content.Context) r12, (boolean) r10)     // Catch:{ all -> 0x0207 }
            ...
            com.appnext.base.services.a r12 = com.appnext.base.services.C4917a.m6668aK()     // Catch:{ all -> 0x0207 }
        ...
        L_0x00a7:
            ...
            java.lang.String r13 = f4792gS     // Catch:{ all -> 0x01f7 }
            r5.setRequestProperty(r12, r13)     // Catch:{ all -> 0x01f7 }
            r5.setRequestProperty(r3, r4)     // Catch:{ all -> 0x01f7 }
            android.content.Context r3 = com.appnext.base.p082b.C4901e.getContext()     // Catch:{ all -> 0x01f7 }
            java.lang.String r3 = m6827b((android.content.Context) r3, (boolean) r10)     // Catch:{ all -> 0x01f7 }
            boolean r4 = android.text.TextUtils.isEmpty(r3)     // Catch:{ all -> 0x01f7 }
            java.lang.String r12 = "aidForSend"
            if (r4 == 0) goto L_0x00f8
            com.appnext.base.b.d$a r3 = com.appnext.base.p082b.C4899d.C4900a.String     // Catch:{ all -> 0x01f7 }
            java.lang.Object r3 = com.appnext.base.p082b.C4906j.m6593a(r12, r3)     // Catch:{ all -> 0x01f7 }
        ...
        L_0x00f7:
            return r11
        L_0x00f8:
            com.appnext.base.b.d$a r4 = com.appnext.base.p082b.C4899d.C4900a.String     // Catch:{ all -> 0x01f7 }
            com.appnext.base.p082b.C4906j.m6596a((java.lang.String) r12, (java.lang.String) r3, (com.appnext.base.p082b.C4899d.C4900a) r4)     // Catch:{ all -> 0x01f7 }
        L_0x00fd:
            boolean r4 = android.text.TextUtils.isEmpty(r3)     // Catch:{ all -> 0x01f7 }
        ...
        L_0x0108:
            return r11
        L_0x0109:
            com.appnext.base.b.h r4 = com.appnext.base.p082b.C4904h.m6584aO()     // Catch:{ all -> 0x01f7 }
            java.lang.String r3 = r4.mo41009M(r3)     // Catch:{ all -> 0x01f7 }
            ...
            com.appnext.base.b.d$a r3 = com.appnext.base.p082b.C4899d.C4900a.JSONObject     // Catch:{ all -> 0x01f7 }
            if (r1 == r3) goto L_0x0124
            com.appnext.base.b.d$a r3 = com.appnext.base.p082b.C4899d.C4900a.JSONArray     // Catch:{ all -> 0x01f7 }
        ...
        L_0x0139:
            java.lang.String r3 = ""
            com.appnext.base.b.d$a r4 = com.appnext.base.p082b.C4899d.C4900a.JSONArray     // Catch:{ all -> 0x01f7 }
            ...
            goto L_0x0194
        L_0x0147:
            com.appnext.base.b.d$a r4 = com.appnext.base.p082b.C4899d.C4900a.JSONObject     // Catch:{ all -> 0x01f7 }
            ...
            goto L_0x0194
        L_0x0153:
            com.appnext.base.b.d$a r4 = com.appnext.base.p082b.C4899d.C4900a.HashMap     // Catch:{ all -> 0x01f7 }
        ...
        L_0x0167:
            ...
            goto L_0x0167
        L_0x0184:
            java.lang.String r3 = m6830b((java.util.List<android.util.Pair<java.lang.String, java.lang.String>>) r4, (boolean) r9)     // Catch:{ all -> 0x01f7 }
            goto L_0x0194
        L_0x0189:
            com.appnext.base.b.d$a r4 = com.appnext.base.p082b.C4899d.C4900a.ArrayList     // Catch:{ all -> 0x01f7 }
            if (r1 != r4) goto L_0x0194
            r3 = r0
            java.util.ArrayList r3 = (java.util.ArrayList) r3     // Catch:{ all -> 0x01f7 }
            java.lang.String r3 = m6830b((java.util.List<android.util.Pair<java.lang.String, java.lang.String>>) r3, (boolean) r9)     // Catch:{ all -> 0x01f7 }
        L_0x0194:
            com.appnext.base.b.h r4 = com.appnext.base.p082b.C4904h.m6584aO()     // Catch:{ all -> 0x01f7 }
            byte[] r2 = r4.mo41010f(r3, r2)     // Catch:{ all -> 0x01f7 }
        ...
        L_0x01a5:
            ...
            java.io.InputStream r0 = m6812a((java.io.InputStream) r11)     // Catch:{ all -> 0x01f7 }
            byte[] r0 = m6831b((java.io.InputStream) r0)     // Catch:{ all -> 0x01f7 }
        ...
        L_0x01d4:
            ...
            byte[] r0 = m6831b((java.io.InputStream) r11)     // Catch:{ all -> 0x01f7 }
        ...
        L_0x01e7:
            ...
            byte[] r0 = m6832b(r2, r0, r9, r8, r1)     // Catch:{ all -> 0x01f7 }
        ...
        L_0x0213:
            goto L_0x0212
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appnext.core.C4967f.m6825a(java.lang.String, java.lang.Object, boolean, int, com.appnext.base.b.d$a):byte[]");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static byte[] m6832b(java.lang.String r9, java.lang.Object r10, boolean r11, int r12, com.appnext.base.p082b.C4899d.C4900a r13) throws java.io.IOException {
        /*
            ...
            java.lang.String r2 = f4792gS     // Catch:{ all -> 0x0124 }
            r0.setRequestProperty(r1, r2)     // Catch:{ all -> 0x0124 }
            ...
            com.appnext.base.b.d$a r2 = com.appnext.base.p082b.C4899d.C4900a.JSONObject     // Catch:{ all -> 0x0124 }
            if (r13 == r2) goto L_0x003f
            com.appnext.base.b.d$a r2 = com.appnext.base.p082b.C4899d.C4900a.JSONArray     // Catch:{ all -> 0x0124 }
        ...
        L_0x0054:
            ...
            com.appnext.base.b.d$a r4 = com.appnext.base.p082b.C4899d.C4900a.JSONArray     // Catch:{ all -> 0x0124 }
            ...
            goto L_0x00c7
        L_0x0071:
            com.appnext.base.b.d$a r4 = com.appnext.base.p082b.C4899d.C4900a.JSONObject     // Catch:{ all -> 0x0124 }
            ...
            goto L_0x00c7
        L_0x0080:
            com.appnext.base.b.d$a r4 = com.appnext.base.p082b.C4899d.C4900a.HashMap     // Catch:{ all -> 0x0124 }
        ...
        L_0x0094:
            ...
            goto L_0x0094
        L_0x00b1:
            java.lang.String r4 = m6830b((java.util.List<android.util.Pair<java.lang.String, java.lang.String>>) r5, (boolean) r11)     // Catch:{ all -> 0x0124 }
            r3.write(r4)     // Catch:{ all -> 0x0124 }
            goto L_0x00c7
        L_0x00b9:
            com.appnext.base.b.d$a r4 = com.appnext.base.p082b.C4899d.C4900a.ArrayList     // Catch:{ all -> 0x0124 }
            if (r13 != r4) goto L_0x00c7
            r4 = r10
            java.util.ArrayList r4 = (java.util.ArrayList) r4     // Catch:{ all -> 0x0124 }
            java.lang.String r4 = m6830b((java.util.List<android.util.Pair<java.lang.String, java.lang.String>>) r4, (boolean) r11)     // Catch:{ all -> 0x0124 }
            r3.write(r4)     // Catch:{ all -> 0x0124 }
        L_0x00c7:
        ...
        L_0x00d0:
            ...
            java.io.InputStream r10 = m6812a((java.io.InputStream) r9)     // Catch:{ all -> 0x0124 }
            byte[] r10 = m6831b((java.io.InputStream) r10)     // Catch:{ all -> 0x0124 }
        ...
        L_0x00fc:
            ...
            byte[] r10 = m6831b((java.io.InputStream) r9)     // Catch:{ all -> 0x0124 }
        ...
        L_0x0114:
            ...
            byte[] r9 = m6832b(r1, r10, r11, r12, r13)     // Catch:{ all -> 0x0124 }
        ...
        L_0x0134:
            goto L_0x0133
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appnext.core.C4967f.m6832b(java.lang.String, java.lang.Object, boolean, int, com.appnext.base.b.d$a):byte[]");
    }

    /* renamed from: a */
    public static InputStream m6812a(InputStream inputStream) throws IOException {
    ...
    /* renamed from: b */
    private static byte[] m6831b(InputStream inputStream) throws IOException {
    ...
    /* renamed from: Y */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.graphics.Bitmap m6809Y(java.lang.String r4) {
        /*
            r0 = 0
            java.util.HashMap<java.lang.String, android.graphics.Bitmap> r1 = f4791gR     // Catch:{ all -> 0x0086 }
        ...
        L_0x0070:
            return r0
        L_0x0071:
            java.util.HashMap<java.lang.String, android.graphics.Bitmap> r2 = f4791gR     // Catch:{ all -> 0x0084 }
        ...
        L_0x008c:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appnext.core.C4967f.m6809Y(java.lang.String):android.graphics.Bitmap");
    }

    /* renamed from: d */
    private static void m6843d(HashMap<String, Bitmap> hashMap) {
        try {
    ...
    /* renamed from: b */
    private static String m6830b(List<Pair<String, String>> list, boolean z) {
    ...
    /* renamed from: a */
    public static int m6811a(Context context, float f) {
        return (int) (f * (((float) context.getResources().getDisplayMetrics().densityDpi) / 160.0f));
    }

    /* renamed from: a */
    public static void m6822a(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9) {
        String str10 = str6;
        try {
            if (str10.equals(C4708a.f4159I) || str10.equals(C4708a.f4163M)) {
                ...
                new Thread(new Runnable() {
                    public final void run() {
                        ...
                        String str2;
                        try {
                            str = URLEncoder.encode(str11.replace(StringUtils.SPACE, "_"), "UTF-8");
                        } catch (Throwable unused) {
                            str = "";
                        }
                        try {
                            str2 = URLEncoder.encode(str12.replace(StringUtils.SPACE, "_"), "UTF-8");
                        } catch (Throwable unused2) {
                            str2 = "";
                        }
                        ...
                        try {
                            ...
                            C4967f.m6815a(format, (HashMap<String, String>) null);
                        } catch (Throwable th) {
    ...
    /* renamed from: a */
    private static void m6819a(Context context, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8) {
        try {
            ...
            new Thread(new Runnable() {
                public final void run() {
                    String str;
                    try {
                        str = C4967f.m6852q(context2);
                    } catch (Throwable unused) {
                        str = "";
                    }
                    C4967f.m6822a(str9, str10, str11, str12, str, str13, str14, str15, str16);
                }
            }).start();
        } catch (Throwable unused) {
        }
    ...
    /* renamed from: a */
    public static void m6820a(C4924Ad ad, AppnextAd appnextAd, String str, String str2, C4986p pVar) {
        final C4986p pVar2 = pVar;
            ...
            public final void run() {
                try {
                    if (Boolean.parseBoolean(pVar2.get("stp_flag"))) {
                        ...
                        arrayList.add(new Pair("did", C4967f.m6827b(ad2.getContext(), true)));
                        ...
                        C4967f.m6814a("https://global.appnext.com/stp.aspx", (ArrayList<Pair<String, String>>) arrayList, 8000);
                    }
                } catch (Throwable unused) {
                }
            }
    ...
    /* renamed from: c */
    public static boolean m6842c(Context context, String str) {
        try {
    ...
    /* renamed from: m */
    public static String m6846m(String str, String str2) {
    ...
    /* renamed from: n */
    public static String m6848n(Context context) {
    ...
    /* renamed from: o */
    public static String m6849o(Context context) {
    ...
    /* renamed from: Z */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static int m6810Z(java.lang.String r7) {
        /*
        ...
        L_0x0056:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appnext.core.C4967f.m6810Z(java.lang.String):int");
    }

    /* renamed from: b */
    public static String m6829b(Throwable th) {
    ...
    /* renamed from: a */
    public static boolean m6823a(Context context, String str) {
    ...
    /* renamed from: p */
    public static String m6851p(Context context) {
    ...
    /* renamed from: bh */
    public static String m6837bh() {
        return Locale.getDefault().getLanguage();
    }

    /* renamed from: q */
    public static String m6852q(Context context) {
        if (f4794gU.equals("")) {
            synchronized ("2.5.1.472") {
                if (f4794gU.equals("")) {
                    f4794gU = m6853r(context);
                }
            }
        }
        return f4794gU;
    ...
    /* renamed from: aa */
    private static String m6826aa(String str) {
        try {
    ...
    /* renamed from: c */
    private static String m6839c(int i) {
    ...
    /* renamed from: c */
    public static String m6840c(String str) {
    ...
    /* renamed from: g */
    public static String m6844g(AppnextAd appnextAd) {
        String str;
    ...
    /* renamed from: s */
    public static boolean m6854s(Context context) {
        try {
            if (context.checkPermission("android.permission.ACCESS_NETWORK_STATE", Process.myPid(), Process.myUid()) != 0) {
                m6815a("http://www.appnext.com/myid.html", (HashMap<String, String>) null);
                return true;
            }
            NetworkInfo activeNetworkInfo = ((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo();
            if (activeNetworkInfo != null && activeNetworkInfo.isConnected()) {
    ...
    /* renamed from: a */
    public static void m6821a(File file) {
        if (file.isDirectory()) {
    ...
    /* renamed from: r */
    public static String m6853r(Context context) {
        String b = m6827b(context, true);
        if (b.equals("")) {
            return m6839c(32);
        }
        return m6826aa(b + "_" + (System.currentTimeMillis() / 1000));
    }
}
