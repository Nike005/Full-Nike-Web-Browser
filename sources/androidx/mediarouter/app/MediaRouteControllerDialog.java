...
public class MediaRouteControllerDialog extends AlertDialog {
    ...
    public MediaRouteControllerDialog(android.content.Context r2, int r3) {
        /*
            ...
            int r0 = androidx.mediarouter.C4427R.dimen.mr_controller_volume_group_list_padding_top
            ...
            int r3 = androidx.mediarouter.C4427R.C4431interpolator.mr_linear_out_slow_in
            android.view.animation.Interpolator r3 = android.view.animation.AnimationUtils.loadInterpolator(r2, r3)
            r1.mLinearOutSlowInInterpolator = r3
            int r3 = androidx.mediarouter.C4427R.C4431interpolator.mr_fast_out_slow_in
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C4427R.layout.mr_controller_material_dialog_b);
        findViewById(BUTTON_NEUTRAL_RES_ID).setVisibility(8);
        ClickListener clickListener = new ClickListener();
        FrameLayout frameLayout = (FrameLayout) findViewById(C4427R.C4430id.mr_expandable_area);
        ...
        LinearLayout linearLayout = (LinearLayout) findViewById(C4427R.C4430id.mr_dialog_area);
        ...
        button.setText(C4427R.string.mr_controller_disconnect);
        ...
        button2.setText(C4427R.string.mr_controller_stop_casting);
        this.mStopCastingButton.setTextColor(buttonTextColor);
        this.mStopCastingButton.setOnClickListener(clickListener);
        this.mRouteNameTextView = (TextView) findViewById(C4427R.C4430id.mr_name);
        ImageButton imageButton = (ImageButton) findViewById(C4427R.C4430id.mr_close);
        this.mCloseButton = imageButton;
        imageButton.setOnClickListener(clickListener);
        this.mCustomControlLayout = (FrameLayout) findViewById(C4427R.C4430id.mr_custom_control);
        this.mDefaultControlLayout = (FrameLayout) findViewById(C4427R.C4430id.mr_default_control);
        C44424 r2 = new View.OnClickListener() {
            public void onClick(View view) {
        ...
        ImageView imageView = (ImageView) findViewById(C4427R.C4430id.mr_art);
        this.mArtView = imageView;
        imageView.setOnClickListener(r2);
        findViewById(C4427R.C4430id.mr_control_title_container).setOnClickListener(r2);
        this.mMediaMainControlLayout = (LinearLayout) findViewById(C4427R.C4430id.mr_media_main_control);
        this.mDividerView = findViewById(C4427R.C4430id.mr_control_divider);
        this.mPlaybackControlLayout = (RelativeLayout) findViewById(C4427R.C4430id.mr_playback_control);
        this.mTitleView = (TextView) findViewById(C4427R.C4430id.mr_control_title);
        this.mSubtitleView = (TextView) findViewById(C4427R.C4430id.mr_control_subtitle);
        ImageButton imageButton2 = (ImageButton) findViewById(C4427R.C4430id.mr_control_playback_ctrl);
        this.mPlaybackControlButton = imageButton2;
        imageButton2.setOnClickListener(clickListener);
        LinearLayout linearLayout2 = (LinearLayout) findViewById(C4427R.C4430id.mr_volume_control);
        this.mVolumeControlLayout = linearLayout2;
        linearLayout2.setVisibility(8);
        SeekBar seekBar = (SeekBar) findViewById(C4427R.C4430id.mr_volume_slider);
        ...
        this.mVolumeGroupList = (OverlayListView) findViewById(C4427R.C4430id.mr_volume_group_list);
        ...
        MediaRouteExpandCollapseButton mediaRouteExpandCollapseButton = (MediaRouteExpandCollapseButton) findViewById(C4427R.C4430id.mr_group_expand_collapse);
        ...
        loadInterpolator();
        this.mGroupListAnimationDurationMs = this.mContext.getResources().getInteger(C4427R.integer.mr_controller_volume_group_list_animation_duration_ms);
        this.mGroupListFadeInDurationMs = this.mContext.getResources().getInteger(C4427R.integer.mr_controller_volume_group_list_fade_in_duration_ms);
        this.mGroupListFadeOutDurationMs = this.mContext.getResources().getInteger(C4427R.integer.mr_controller_volume_group_list_fade_out_duration_ms);
    ...
    public void updateLayout() {
        ...
        this.mVolumeGroupListItemIconSize = resources.getDimensionPixelSize(C4427R.dimen.mr_controller_volume_group_list_item_icon_size);
        this.mVolumeGroupListItemHeight = resources.getDimensionPixelSize(C4427R.dimen.mr_controller_volume_group_list_item_height);
        this.mVolumeGroupListMaxHeight = resources.getDimensionPixelSize(C4427R.dimen.mr_controller_volume_group_list_max_height);
    ...
    public void updateVolumeGroupItemHeight(View view) {
        setLayoutHeight((LinearLayout) view.findViewById(C4427R.C4430id.volume_item_container), this.mVolumeGroupListItemHeight);
        View findViewById = view.findViewById(C4427R.C4430id.mr_volume_item_icon);
    ...
    public void animateGroupListItemsInternal(Map<MediaRouter.RouteInfo, Rect> map, Map<MediaRouter.RouteInfo, BitmapDrawable> map2) {
        ...
        if (set != null && this.mGroupMemberRoutesRemoved != null) {
            ...
            C44479 r3 = new Animation.AnimationListener() {
    ...
    private void fadeInAddedRoutes() {
        C443912 r0 = new Animation.AnimationListener() {
            public void onAnimationRepeat(Animation animation) {
            }
    ...
    public void clearGroupListAnimation(boolean z) {
        ...
        for (int i = 0; i < this.mVolumeGroupList.getChildCount(); i++) {
            ...
            if (!z || (set = this.mGroupMemberRoutesAdded) == null || !set.contains(routeInfo)) {
                ((LinearLayout) childAt.findViewById(C4427R.C4430id.volume_item_container)).setVisibility(0);
                AnimationSet animationSet = new AnimationSet(true);
    ...
    private void updatePlaybackControlLayout() {
        ...
        L_0x0020:
            ...
            int r1 = androidx.mediarouter.C4427R.string.mr_controller_casting_screen
            r0.setText(r1)
        L_0x0036:
            r0 = 1
        L_0x0037:
        ...
        L_0x0044:
            ...
            android.widget.TextView r0 = r8.mTitleView
            int r1 = androidx.mediarouter.C4427R.string.mr_controller_no_info_available
            r0.setText(r1)
            goto L_0x0036
        L_0x0050:
        ...
        L_0x0063:
            android.widget.TextView r0 = r8.mTitleView
            int r1 = androidx.mediarouter.C4427R.string.mr_controller_no_media_selected
            r0.setText(r1)
            goto L_0x0036
        L_0x006b:
            android.widget.TextView r2 = r8.mTitleView
        ...
        L_0x009b:
            ...
            int r0 = androidx.mediarouter.C4427R.attr.mediaRoutePauseDrawable
            int r2 = androidx.mediarouter.C4427R.string.mr_controller_pause
            goto L_0x00cb
        L_0x00ae:
            if (r0 == 0) goto L_0x00bb
            boolean r2 = r8.isStopActionSupported()
            if (r2 == 0) goto L_0x00bb
            int r0 = androidx.mediarouter.C4427R.attr.mediaRouteStopDrawable
            int r2 = androidx.mediarouter.C4427R.string.mr_controller_stop
            goto L_0x00cb
        L_0x00bb:
            if (r0 != 0) goto L_0x00c8
            boolean r0 = r8.isPlayActionSupported()
            if (r0 == 0) goto L_0x00c8
            int r0 = androidx.mediarouter.C4427R.attr.mediaRoutePlayDrawable
            int r2 = androidx.mediarouter.C4427R.string.mr_controller_play
            goto L_0x00cb
        L_0x00c8:
            r0 = 0
            r2 = 0
    ...
    private final class ClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (id == MediaRouteControllerDialog.BUTTON_STOP_RES_ID || id == MediaRouteControllerDialog.BUTTON_DISCONNECT_RES_ID) {
                ...
                MediaRouteControllerDialog.this.dismiss();
            } else if (id == C4427R.C4430id.mr_control_playback_ctrl) {
                if (MediaRouteControllerDialog.this.mMediaController != null && MediaRouteControllerDialog.this.mState != null) {
                    ...
                    if (i != 0 && MediaRouteControllerDialog.this.isPauseActionSupported()) {
                        ...
                        i2 = C4427R.string.mr_controller_pause;
                        ...
                        i2 = C4427R.string.mr_controller_stop;
                        ...
                        i2 = C4427R.string.mr_controller_play;
                    }
            ...
            } else if (id == C4427R.C4430id.mr_close) {
                MediaRouteControllerDialog.this.dismiss();
            }
        }
    }
    ...
    private class VolumeGroupAdapter extends ArrayAdapter<MediaRouter.RouteInfo> {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            int i3 = 0;
            if (view == null) {
                view = LayoutInflater.from(viewGroup.getContext()).inflate(C4427R.layout.mr_controller_volume_item, viewGroup, false);
            } else {
            ...
            if (routeInfo != null) {
                ...
                TextView textView = (TextView) view.findViewById(C4427R.C4430id.mr_name);
                textView.setEnabled(isEnabled);
                textView.setText(routeInfo.getName());
                MediaRouteVolumeSlider mediaRouteVolumeSlider = (MediaRouteVolumeSlider) view.findViewById(C4427R.C4430id.mr_volume_slider);
                ...
                ImageView imageView = (ImageView) view.findViewById(C4427R.C4430id.mr_volume_item_icon);
                if (isEnabled) {
                    i2 = 255;
                } else {
                ...
                LinearLayout linearLayout = (LinearLayout) view.findViewById(C4427R.C4430id.volume_item_container);
