...
public class RegionMonitoringState implements Serializable {
    ...
    public boolean markOutsideIfExpired() {
        ...
        LogManager.m6046d(TAG, "We are newly outside the region because the lastSeenTime of %s was %s seconds ago, and that is over the expiration duration of %s", Long.valueOf(this.lastSeenTime), Long.valueOf(SystemClock.elapsedRealtime() - this.lastSeenTime), Long.valueOf(BeaconManager.getRegionExitPeriod()));
        markOutside();
        return true;
    }
