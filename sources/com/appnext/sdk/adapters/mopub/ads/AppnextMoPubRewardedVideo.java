...
public class AppnextMoPubRewardedVideo extends CustomEventRewardedVideo {
    ...
    public boolean hasVideoAvailable() {
        RewardedVideo rewardedVideo = this.f4908ad;
    ...
    public void showVideo() {
        ...
        if (appnextMediationSettings != null && (!appnextMediationSettings._rewardsAmountRewarded.equals("") || !appnextMediationSettings._rewardsCustomParameter.equals("") || !appnextMediationSettings._rewardsRewardTypeCurrency.equals("") || !appnextMediationSettings._rewardsTransactionId.equals("") || !appnextMediationSettings._rewardsUserId.equals(""))) {
            this.f4908ad.setRewardedServerSidePostback(appnextMediationSettings._rewardsTransactionId, appnextMediationSettings._rewardsUserId, appnextMediationSettings._rewardsRewardTypeCurrency, appnextMediationSettings._rewardsAmountRewarded, appnextMediationSettings._rewardsCustomParameter);
        }
        RewardedVideo rewardedVideo = this.f4908ad;
    ...
    private void init(Activity activity, Map<String, Object> map, Map<String, String> map2) {
        ...
        if (obj2 == null || !(obj2 instanceof RewardedConfig)) {
            this.f4908ad = new CustomEventRewardedVideoAd(activity, appnextPlacementIdExtraKey);
        } else {
            this.f4908ad = new CustomEventRewardedVideoAd(activity, appnextPlacementIdExtraKey, (RewardedConfig) obj2);
        }
        if (obj != null && (obj instanceof RewardedServerSidePostback)) {
            ...
            this.f4908ad.setRewardedServerSidePostback(rewardedServerSidePostback.getRewardsTransactionId(), rewardedServerSidePostback.getRewardsUserId(), rewardedServerSidePostback.getRewardsRewardTypeCurrency(), rewardedServerSidePostback.getRewardsAmountRewarded(), rewardedServerSidePostback.getRewardsCustomParameter());
        }
        this.f4908ad.setOnVideoEndedCallback(new OnVideoEnded() {
        ...
        this.f4908ad.setOnAdLoadedCallback(new OnAdLoaded() {
        ...
        this.f4908ad.setOnAdOpenedCallback(new OnAdOpened() {
        ...
        this.f4908ad.setOnAdClickedCallback(new OnAdClicked() {
        ...
        this.f4908ad.setOnAdClosedCallback(new OnAdClosed() {
        ...
        this.f4908ad.setOnAdErrorCallback(new OnAdError() {
            ...
            public void adError(java.lang.String r6) {
                ...
                L_0x0091:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.appnext.sdk.adapters.mopub.ads.AppnextMoPubRewardedVideo.C50426.adError(java.lang.String):void");
            }
        });
    }
