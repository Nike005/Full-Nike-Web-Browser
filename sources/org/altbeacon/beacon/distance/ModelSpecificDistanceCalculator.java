...
public class ModelSpecificDistanceCalculator implements DistanceCalculator {
    ...
    public double calculateDistance(int i, double d) {
        ...
        LogManager.m6054w(TAG, "distance calculator has not been set", new Object[0]);
        return -1.0d;
    }
    ...
    private DistanceCalculator findCalculatorForModel(AndroidModel androidModel) {
        LogManager.m6046d(TAG, "Finding best distance calculator for %s, %s, %s, %s", androidModel.getVersion(), androidModel.getBuildNumber(), androidModel.getModel(), androidModel.getManufacturer());
        Map<AndroidModel, DistanceCalculator> map = this.mModelMap;
        AndroidModel androidModel2 = null;
        if (map == null) {
            LogManager.m6046d(TAG, "Cannot get distance calculator because modelMap was never initialized", new Object[0]);
            return null;
        }
        int i = 0;
        ...
        if (androidModel2 != null) {
            LogManager.m6046d(TAG, "found a match with score %s", Integer.valueOf(i));
            LogManager.m6046d(TAG, "Finding best distance calculator for %s, %s, %s, %s", androidModel2.getVersion(), androidModel2.getBuildNumber(), androidModel2.getModel(), androidModel2.getManufacturer());
            this.mModel = androidModel2;
        } else {
            this.mModel = this.mDefaultModel;
            LogManager.m6054w(TAG, "Cannot find match for this device.  Using default", new Object[0]);
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0044, code lost:
        org.altbeacon.beacon.logging.LogManager.m6049e(r1, TAG, "Cannot update distance models from online database at %s with JSON: %s", r9.mRemoteUpdateUrlString, r2.toString());
     */
    ...
    public boolean loadModelMapFromFile() {
        ...
        L_0x0043:
            ...
            org.altbeacon.beacon.logging.LogManager.m6049e(r1, r0, r2, r3)
            return r5
        L_0x0057:
            r0 = move-exception
            r3 = r7
        ...
        L_0x006a:
            ...
            org.altbeacon.beacon.logging.LogManager.m6049e(r2, r0, r7, r4)     // Catch:{ all -> 0x005f }
    ...
    public boolean saveJson(String str) {
        ...
        try {
            ...
            LogManager.m6050i(TAG, "Successfully saved new distance model file", new Object[0]);
            return true;
        } catch (Exception e) {
            LogManager.m6055w(e, TAG, "Cannot write updated distance model to local storage", new Object[0]);
            if (fileOutputStream != null) {
                try {
                    fileOutputStream.close();
    ...
    private void requestModelMapFromWeb() {
        if (this.mContext.checkCallingOrSelfPermission("android.permission.INTERNET") != 0) {
            LogManager.m6054w(TAG, "App has no android.permission.INTERNET permission.  Cannot check for distance model updates", new Object[0]);
        } else {
            new ModelSpecificDistanceUpdater(this.mContext, this.mRemoteUpdateUrlString, new ModelSpecificDistanceUpdater.CompletionHandler() {
                public void onComplete(String str, Exception exc, int i) {
                    if (exc != null) {
                        LogManager.m6054w(ModelSpecificDistanceCalculator.TAG, "Cannot updated distance models from online database at %s", exc, ModelSpecificDistanceCalculator.this.mRemoteUpdateUrlString);
                    } else if (i != 200) {
                        LogManager.m6054w(ModelSpecificDistanceCalculator.TAG, "Cannot updated distance models from online database at %s due to HTTP status code %s", ModelSpecificDistanceCalculator.this.mRemoteUpdateUrlString, Integer.valueOf(i));
                    } else {
                        LogManager.m6046d(ModelSpecificDistanceCalculator.TAG, "Successfully downloaded distance models from online database", new Object[0]);
                        try {
                            ...
                            if (ModelSpecificDistanceCalculator.this.saveJson(str)) {
                                ...
                                LogManager.m6050i(ModelSpecificDistanceCalculator.TAG, "Successfully updated distance model with latest from online database", new Object[0]);
                            }
                        } catch (JSONException e) {
                            LogManager.m6055w(e, ModelSpecificDistanceCalculator.TAG, "Cannot parse json from downloaded distance model", new Object[0]);
                        }
                    }
                }
    ...
    private void loadDefaultModelMap() {
        try {
            ...
            LogManager.m6049e(e, TAG, "Cannot build model distance calculations", new Object[0]);
        }
    }
