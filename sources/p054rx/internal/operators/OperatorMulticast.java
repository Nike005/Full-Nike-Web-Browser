...
import p054rx.subjects.Subject;
...
public final class OperatorMulticast<T, R> extends ConnectableObservable<R> {
    ...
    public void connect(p054rx.functions.Action1<? super p054rx.Subscription> r6) {
        /*
            r5 = this;
        ...
        L_0x000e:
            ...
            rx.subjects.Subject r1 = (p054rx.subjects.Subject) r1     // Catch:{ all -> 0x0071 }
            rx.Subscriber r2 = p054rx.observers.Subscribers.from(r1)     // Catch:{ all -> 0x0071 }
            ...
            rx.Subscription r3 = p054rx.subscriptions.Subscriptions.create(r3)     // Catch:{ all -> 0x0071 }
            r2.set(r3)     // Catch:{ all -> 0x0071 }
            java.lang.Object r2 = r2.get()     // Catch:{ all -> 0x0071 }
            rx.Subscription r2 = (p054rx.Subscription) r2     // Catch:{ all -> 0x0071 }
        ...
        L_0x003b:
            ...
            rx.Subscriber r3 = (p054rx.Subscriber) r3     // Catch:{ all -> 0x0071 }
        ...
        L_0x0075:
            goto L_0x0074
        */
        throw new UnsupportedOperationException("Method not decompiled: p054rx.internal.operators.OperatorMulticast.connect(rx.functions.Action1):void");
    }
}
