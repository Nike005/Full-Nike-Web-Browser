...
public final class zzwy {
    ...
    public zzwy(JSONObject jSONObject) throws JSONException {
        if (zzakb.isLoggable(2)) {
            ...
            zzakb.m43v(valueOf.length() != 0 ? "Mediation Response JSON: ".concat(valueOf) : new String("Mediation Response JSON: "));
        }
        ...
        JSONObject optJSONObject = jSONObject.optJSONObject(C4944b.f4720hW);
