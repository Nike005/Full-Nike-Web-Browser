...
public class StringUtils {
    ...
    /* renamed from: CR */
    public static final String f3948CR = "\r";
    public static final String EMPTY = "";
    public static final int INDEX_NOT_FOUND = -1;

    /* renamed from: LF */
    public static final String f3949LF = "\n";
    ...
    public static double getJaroWinklerDistance(CharSequence charSequence, CharSequence charSequence2) {
        ...
        double length = (double) charSequence.length();
        Double.isNaN(d);
        Double.isNaN(length);
        double length2 = (double) charSequence2.length();
        Double.isNaN(d);
        Double.isNaN(length2);
        double d2 = (d / length) + (d / length2);
        double d3 = (double) matches[1];
        Double.isNaN(d);
        Double.isNaN(d3);
        Double.isNaN(d);
        double d4 = (d2 + ((d - d3) / d)) / 3.0d;
        if (d4 >= 0.7d) {
            double d5 = (double) matches[3];
            Double.isNaN(d5);
            double min = Math.min(0.1d, 1.0d / d5);
            double d6 = (double) matches[2];
            Double.isNaN(d6);
            d4 += min * d6 * (1.0d - d4);
        }
        double round = (double) Math.round(d4 * 100.0d);
        Double.isNaN(round);
        return round / 100.0d;
    }
