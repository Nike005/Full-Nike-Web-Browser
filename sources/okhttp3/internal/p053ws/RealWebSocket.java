...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        if ("GET".equals(request.method())) {
            ...
            this.key = ByteString.m7280of(bArr).base64();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x005e, code lost:
        if ((r4 instanceof okhttp3.internal.p053ws.RealWebSocket.Message) == false) goto L_0x008c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0060, code lost:
        r2 = ((okhttp3.internal.p053ws.RealWebSocket.Message) r4).data;
        r0 = okio.Okio.buffer(r0.newMessageSink(((okhttp3.internal.p053ws.RealWebSocket.Message) r4).formatOpcode, (long) r2.size()));
        r0.write(r2);
        r0.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x008e, code lost:
        if ((r4 instanceof okhttp3.internal.p053ws.RealWebSocket.Close) == false) goto L_0x00a5;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x0090, code lost:
        r4 = (okhttp3.internal.p053ws.RealWebSocket.Close) r4;
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x0008:
            ...
            boolean r6 = r5 instanceof okhttp3.internal.p053ws.RealWebSocket.Close     // Catch:{ all -> 0x00b0 }
        ...
        L_0x0034:
            ...
            r8 = r5
            okhttp3.internal.ws.RealWebSocket$Close r8 = (okhttp3.internal.p053ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00b0 }
        ...
        L_0x0055:
            ...
            goto L_0x00a0
        L_0x005c:
            boolean r2 = r4 instanceof okhttp3.internal.p053ws.RealWebSocket.Message     // Catch:{ all -> 0x00ab }
            if (r2 == 0) goto L_0x008c
            r2 = r4
            okhttp3.internal.ws.RealWebSocket$Message r2 = (okhttp3.internal.p053ws.RealWebSocket.Message) r2     // Catch:{ all -> 0x00ab }
            okio.ByteString r2 = r2.data     // Catch:{ all -> 0x00ab }
            okhttp3.internal.ws.RealWebSocket$Message r4 = (okhttp3.internal.p053ws.RealWebSocket.Message) r4     // Catch:{ all -> 0x00ab }
        ...
        L_0x008c:
            boolean r2 = r4 instanceof okhttp3.internal.p053ws.RealWebSocket.Close     // Catch:{ all -> 0x00ab }
            if (r2 == 0) goto L_0x00a5
            okhttp3.internal.ws.RealWebSocket$Close r4 = (okhttp3.internal.p053ws.RealWebSocket.Close) r4     // Catch:{ all -> 0x00ab }
