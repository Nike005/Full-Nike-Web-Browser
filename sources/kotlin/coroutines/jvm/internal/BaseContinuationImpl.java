        ...
        while (true) {
            ...
            try {
                ...
                if (invokeSuspend != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    obj = Result.m7286constructorimpl(invokeSuspend);
                ...
                obj = Result.m7286constructorimpl(ResultKt.createFailure(th));
            }
        }
    }
