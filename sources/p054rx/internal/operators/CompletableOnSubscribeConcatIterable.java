...
public final class CompletableOnSubscribeConcatIterable implements Completable.OnSubscribe {
    ...
    public void call(CompletableSubscriber completableSubscriber) {
        try {
            ...
            completableSubscriber.onSubscribe(concatInnerSubscriber.f3976sd);
    ...
    static final class ConcatInnerSubscriber extends AtomicInteger implements CompletableSubscriber {
        ...
        /* renamed from: sd */
        final SequentialSubscription f3976sd = new SequentialSubscription();
        ...
        public void onSubscribe(Subscription subscription) {
            this.f3976sd.replace(subscription);
        }
        ...
        public void next() {
            if (!this.f3976sd.isUnsubscribed() && getAndIncrement() == 0) {
                Iterator<? extends Completable> it = this.sources;
                while (!this.f3976sd.isUnsubscribed()) {
                    try {
                        if (!it.hasNext()) {
