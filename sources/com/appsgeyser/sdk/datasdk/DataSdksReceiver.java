...
public class DataSdksReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        if (intent != null) {
            NetworkManager.getInstance().sendRequestAsync(new PreferencesCoder(context).getPrefString(Constants.PREFS_CONFIG_PHP_URL, ""), Integer.valueOf(NetworkManager.RequestType.CONFIG_PHP.ordinal()), context, (Response.Listener<String>) new Response.Listener<String>() {
