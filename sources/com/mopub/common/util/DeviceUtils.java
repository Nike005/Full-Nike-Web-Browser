...
public class DeviceUtils {
    ...
    @Deprecated
    public static String getIpAddress(C0419IP ip) throws SocketException {
        return null;
    }
    ...
    public enum ForceOrientation {
        FORCE_PORTRAIT(C4924Ad.ORIENTATION_PORTRAIT),
        FORCE_LANDSCAPE(C4924Ad.ORIENTATION_LANDSCAPE),
    ...
    public static int memoryCacheSizeBytes(Context context) {
        ...
        try {
            if (C0421Utils.bitMaskContainsFlag(context.getApplicationInfo().flags, ApplicationInfo.class.getDeclaredField("FLAG_LARGE_HEAP").getInt((Object) null))) {
