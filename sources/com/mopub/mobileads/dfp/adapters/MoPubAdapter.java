...
public class MoPubAdapter implements MediationNativeAdapter, MediationBannerAdapter, MediationInterstitialAdapter {
    ...
    public void requestNativeAd(final Context context, final MediationNativeListener mediationNativeListener, Bundle bundle, NativeMediationAdRequest nativeMediationAdRequest, Bundle bundle2) {
        ...
        if (nativeMediationAdRequest.isAppInstallAdRequested() || !nativeMediationAdRequest.isContentAdRequested()) {
            ...
            C05111 r10 = new MoPubNative.MoPubNativeNetworkListener() {
                ...
                public void onNativeLoad(com.mopub.nativeads.NativeAd r6) {
                    ...
                    L_0x0065:
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.mopub.mobileads.dfp.adapters.MoPubAdapter.C05111.onNativeLoad(com.mopub.nativeads.NativeAd):void");
                }

                public void onNativeFail(NativeErrorCode nativeErrorCode) {
                    int i = C05154.$SwitchMap$com$mopub$nativeads$NativeErrorCode[nativeErrorCode.ordinal()];
                    if (i == 1) {
    ...
    private class MBannerListener implements MoPubView.BannerAdListener {
        ...
        public void onBannerFailed(MoPubView moPubView, MoPubErrorCode moPubErrorCode) {
            int i = C05154.$SwitchMap$com$mopub$mobileads$MoPubErrorCode[moPubErrorCode.ordinal()];
            if (i == 1) {
    ...
    /* renamed from: com.mopub.mobileads.dfp.adapters.MoPubAdapter$4 */
    static /* synthetic */ class C05154 {
        ...
        static {
            ...
            L_0x0058:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mopub.mobileads.dfp.adapters.MoPubAdapter.C05154.<clinit>():void");
        }
    }
    ...
    public void showInterstitial() {
        if (this.mMoPubInterstitial.isReady()) {
            ...
            MoPubLog.m336i("Interstitial was not ready. Unable to load the interstitial");
        }
    }
    ...
    private SdkInitializationListener initSdkListener() {
        return new SdkInitializationListener() {
            public void onInitializationFinished() {
                MoPubLog.m332d("MoPub SDK initialized.");
            }
        };
    }
