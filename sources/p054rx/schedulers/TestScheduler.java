...
import p054rx.internal.schedulers.SchedulePeriodicHelper;
...
public class TestScheduler extends Scheduler {
    ...
    final class InnerTestScheduler extends Scheduler.Worker implements SchedulePeriodicHelper.NowNanoSupplier {
        ...
        /* renamed from: s */
        private final BooleanSubscription f4013s = new BooleanSubscription();

        InnerTestScheduler() {
        }

        public void unsubscribe() {
            this.f4013s.unsubscribe();
        }

        public boolean isUnsubscribed() {
            return this.f4013s.isUnsubscribed();
        }
