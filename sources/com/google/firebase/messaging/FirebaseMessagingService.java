        ...
        if (c == 0) {
            ...
            if (MessagingAnalytics.shouldUploadFirelogAnalytics(intent)) {
                ...
                if (transportFactory != null) {
                    MessagingAnalytics.logNotificationReceived(intent, transportFactory.getTransport(Constants.FirelogAnalytics.FCM_LOG_SOURCE, String.class, Encoding.m7231of(AdType.STATIC_NATIVE), FirebaseMessagingService$$Lambda$0.$instance));
                } else {
