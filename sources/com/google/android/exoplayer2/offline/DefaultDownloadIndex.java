...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    public com.google.android.exoplayer2.offline.Download getDownload(java.lang.String r4) throws com.google.android.exoplayer2.database.DatabaseIOException {
        /*
            ...
            r1 = 1
            java.lang.String[] r1 = new java.lang.String[r1]     // Catch:{ SQLiteException -> 0x0037 }
            r2 = 0
            r1[r2] = r4     // Catch:{ SQLiteException -> 0x0037 }
            android.database.Cursor r4 = r3.getCursor(r0, r1)     // Catch:{ SQLiteException -> 0x0037 }
            int r0 = r4.getCount()     // Catch:{ all -> 0x0029 }
            if (r0 != 0) goto L_0x001c
            r0 = 0
            if (r4 == 0) goto L_0x001b
            r4.close()     // Catch:{ SQLiteException -> 0x0037 }
        L_0x001b:
            return r0
        L_0x001c:
        ...
        L_0x0032:
            r4 = move-exception
            r0.addSuppressed(r4)     // Catch:{ SQLiteException -> 0x0037 }
        L_0x0036:
            throw r1     // Catch:{ SQLiteException -> 0x0037 }
        L_0x0037:
            r4 = move-exception
    ...
    public void putDownload(Download download) throws DatabaseIOException {
        ...
        contentValues.put("id", download.request.f5073id);
        ...
        try {
            this.databaseProvider.getWritableDatabase().replaceOrThrow(this.tableName, (String) null, contentValues);
