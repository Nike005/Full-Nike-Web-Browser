...
public final class PlaybackStatsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    public void finishAllSessions() {
        ...
        AnalyticsListener.EventTime eventTime = new AnalyticsListener.EventTime(SystemClock.elapsedRealtime(), Timeline.EMPTY, 0, (MediaSource.MediaPeriodId) null, 0, 0, 0);
    ...
    public void onPlayerStateChanged(AnalyticsListener.EventTime eventTime, boolean z, int i) {
        ...
        for (String next : this.playbackStatsTrackers.keySet()) {
            this.playbackStatsTrackers.get(next).onPlayerStateChanged(eventTime, z, i, this.sessionManager.belongsToSession(eventTime, next));
        }
    }
    ...
    public void onSeekStarted(AnalyticsListener.EventTime eventTime) {
        ...
        for (String next : this.playbackStatsTrackers.keySet()) {
            if (this.sessionManager.belongsToSession(eventTime, next)) {
                this.playbackStatsTrackers.get(next).onSeekStarted(eventTime);
            }
        }
    }
    ...
    public void onSeekProcessed(AnalyticsListener.EventTime eventTime) {
        ...
        for (String next : this.playbackStatsTrackers.keySet()) {
            if (this.sessionManager.belongsToSession(eventTime, next)) {
                this.playbackStatsTrackers.get(next).onSeekProcessed(eventTime);
            }
        }
    }
