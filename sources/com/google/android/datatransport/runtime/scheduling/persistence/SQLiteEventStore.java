...
public class SQLiteEventStore implements EventStore, SynchronizationGuard {
    ...
    private static final Encoding PROTOBUF_ENCODING = Encoding.m7231of("proto");
    ...
    public PersistedEvent persist(TransportContext transportContext, EventInternal eventInternal) {
        Logging.m7236d(LOG_TAG, "Storing event with priority=%s, name=%s for destination %s", transportContext.getPriority(), eventInternal.getTransportName(), transportContext.getBackendName());
    ...
    static /* synthetic */ Object lambda$clearDb$11(SQLiteDatabase sQLiteDatabase) {
        sQLiteDatabase.delete(com.mopub.common.Constants.VIDEO_TRACKING_EVENTS_KEY, (String) null, new String[0]);
