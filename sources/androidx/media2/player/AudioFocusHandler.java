...
public class AudioFocusHandler {
    ...
    private static class AudioFocusHandlerImplBase implements AudioFocusHandlerImpl {
        ...
        private void abandonAudioFocusLocked() {
            if (this.mCurrentFocusGainType != 0) {
                Log.d(AudioFocusHandler.TAG, "abandoningAudioFocusLocked, currently=" + this.mCurrentFocusGainType);
        ...
        private class BecomingNoisyReceiver extends BroadcastReceiver {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:18:0x005e, code lost:
                r3.this$0.mPlayer.setPlayerVolume(r3.this$0.mPlayer.getPlayerVolume() * androidx.media2.player.AudioFocusHandler.AudioFocusHandlerImplBase.VOLUME_DUCK_FACTOR);
             */
        ...
        private class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:67:0x00a5, code lost:
                ...
                r0 = androidx.media2.player.AudioFocusHandler.AudioFocusHandlerImplBase.VOLUME_DUCK_FACTOR * r4;
                r1 = r3.this$0.mLock;
             */
