...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static final int[] ATTRS = {C3333R.attr.actionBarSize, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C3333R.C3336id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C3333R.C3336id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C3333R.C3336id.action_bar));
        }
    }
