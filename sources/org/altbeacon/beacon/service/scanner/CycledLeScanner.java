...
public abstract class CycledLeScanner {
    ...
    public static org.altbeacon.beacon.service.scanner.CycledLeScanner createScanner(android.content.Context r14, long r15, long r17, boolean r19, org.altbeacon.beacon.service.scanner.CycledLeScanCallback r20, org.altbeacon.bluetooth.BluetoothCrashResolver r21) {
        /*
            ...
            org.altbeacon.beacon.logging.LogManager.m6054w(r1, r2, r0)
            r0 = 0
            return r0
        L_0x0012:
            int r0 = android.os.Build.VERSION.SDK_INT
            ...
            org.altbeacon.beacon.logging.LogManager.m6050i(r1, r3, r0)
        L_0x0020:
            r4 = 0
            goto L_0x0047
        L_0x0022:
    ...
    public void setScanPeriods(long j, long j2, boolean z) {
        LogManager.m6046d(TAG, "Set scan periods called with %s, %s Background mode must have changed.", Long.valueOf(j), Long.valueOf(j2));
        ...
        this.mBetweenScanPeriod = j2;
        if (z) {
            LogManager.m6046d(TAG, "We are in the background.  Setting wakeup alarm", new Object[0]);
            setWakeUpAlarm();
        } else {
            LogManager.m6046d(TAG, "We are not in the background.  Cancelling wakeup alarm", new Object[0]);
            cancelWakeUpAlarm();
        }
        ...
        if (j3 > elapsedRealtime) {
            ...
            if (j4 < j3) {
                ...
                LogManager.m6050i(TAG, "Adjusted nextScanStartTime to be %s", new Date((this.mNextScanCycleStartTime - SystemClock.elapsedRealtime()) + System.currentTimeMillis()));
            }
        }
        ...
        if (j5 > elapsedRealtime) {
            ...
            if (j6 < j5) {
                ...
                LogManager.m6050i(TAG, "Adjusted scanStopTime to be %s", Long.valueOf(j6));
            }
        }
    }

    public void start() {
        LogManager.m6046d(TAG, "start called", new Object[0]);
        this.mScanningEnabled = true;
        if (!this.mScanCyclerStarted) {
            scanLeDevice(true);
        } else {
            LogManager.m6046d(TAG, "scanning already started", new Object[0]);
        }
    }

    public void stop() {
        LogManager.m6046d(TAG, "stop called", new Object[0]);
        this.mScanningEnabled = false;
        if (this.mScanCyclerStarted) {
            scanLeDevice(false);
            if (this.mScanningLeftOn) {
                LogManager.m6046d(TAG, "Stopping scanning previously left on.", new Object[0]);
                this.mScanningLeftOn = false;
                try {
                    LogManager.m6046d(TAG, "stopping bluetooth le scan", new Object[0]);
                    finishScan();
                } catch (Exception e) {
                    LogManager.m6055w(e, TAG, "Internal Android exception scanning for beacons", new Object[0]);
                }
            }
        } else {
            LogManager.m6046d(TAG, "scanning already stopped", new Object[0]);
        }
    }
    ...
    public void destroy() {
        LogManager.m6046d(TAG, "Destroying", new Object[0]);
        this.mHandler.removeCallbacksAndMessages((Object) null);
        this.mScanHandler.post(new Runnable() {
            public void run() {
                LogManager.m6046d(CycledLeScanner.TAG, "Quitting scan thread", new Object[0]);
    ...
    public void scanLeDevice(Boolean bool) {
        try {
            ...
            if (getBluetoothAdapter() == null) {
                LogManager.m6048e(TAG, "No Bluetooth adapter.  beaconService cannot scan.", new Object[0]);
            }
            if (!this.mScanningEnabled || !bool.booleanValue()) {
                LogManager.m6046d(TAG, "disabling scan", new Object[0]);
                ...
                LogManager.m6046d(TAG, "starting a new scan cycle", new Object[0]);
                if (this.mScanning && !this.mScanningPaused) {
                    if (!this.mRestartNeeded) {
                        LogManager.m6046d(TAG, "We are already scanning and have been for " + (SystemClock.elapsedRealtime() - this.mCurrentScanStartTime) + " millis", new Object[0]);
                        this.mScanCycleStopTime = SystemClock.elapsedRealtime() + this.mScanPeriod;
                        scheduleScanCycleStop();
                        LogManager.m6046d(TAG, "Scan started", new Object[0]);
                    }
                }
                this.mScanning = true;
                    ...
                    if (getBluetoothAdapter() != null) {
                        if (getBluetoothAdapter().isEnabled()) {
                            if (this.mBluetoothCrashResolver != null && this.mBluetoothCrashResolver.isRecoveryInProgress()) {
                                LogManager.m6054w(TAG, "Skipping scan because crash recovery is in progress.", new Object[0]);
                            } else if (this.mScanningEnabled) {
                                if (this.mRestartNeeded) {
                                    this.mRestartNeeded = false;
                                    LogManager.m6046d(TAG, "restarting a bluetooth le scan", new Object[0]);
                                } else {
                                    LogManager.m6046d(TAG, "starting a new bluetooth le scan", new Object[0]);
                                }
                                try {
                                    ...
                                    LogManager.m6049e(e, TAG, "Internal Android exception scanning for beacons", new Object[0]);
                                }
                            } else {
                                LogManager.m6046d(TAG, "Scanning unnecessary - no monitoring or ranging active.", new Object[0]);
                            }
                            this.mLastScanCycleStartTime = SystemClock.elapsedRealtime();
                        } else {
                            LogManager.m6046d(TAG, "Bluetooth is disabled.  Cannot scan for beacons.", new Object[0]);
                        }
                    }
                } catch (Exception e2) {
                    LogManager.m6049e(e2, TAG, "Exception starting Bluetooth scan.  Perhaps Bluetooth is disabled or unavailable?", new Object[0]);
                }
                this.mScanCycleStopTime = SystemClock.elapsedRealtime() + this.mScanPeriod;
                scheduleScanCycleStop();
                LogManager.m6046d(TAG, "Scan started", new Object[0]);
            ...
            LogManager.m6054w(TAG, "SecurityException working accessing bluetooth.", new Object[0]);
        }
    }
    ...
    public void scheduleScanCycleStop() {
        ...
        LogManager.m6046d(TAG, "Waiting to stop scan cycle for another %s milliseconds", Long.valueOf(elapsedRealtime));
        if (this.mBackgroundFlag) {
            setWakeUpAlarm();
        }
        Handler handler = this.mHandler;
        C23282 r3 = new Runnable() {
            public void run() {
    ...
    private void finishScanCycle() {
        LogManager.m6046d(TAG, "Done with scan cycle", new Object[0]);
        try {
                    ...
                    if (getBluetoothAdapter().isEnabled()) {
                        if (this.mDistinctPacketsDetectedPerScan && this.mBetweenScanPeriod == 0) {
                            if (!mustStopScanToPreventAndroidNScanTimeout()) {
                                LogManager.m6046d(TAG, "Not stopping scanning.  Device capable of multiple indistinct detections per scan.", new Object[0]);
                        ...
                        if (Build.VERSION.SDK_INT < 24 || this.mBetweenScanPeriod + this.mScanPeriod >= ANDROID_N_MIN_SCAN_CYCLE_MILLIS || elapsedRealtime - this.mLastScanCycleStartTime >= ANDROID_N_MIN_SCAN_CYCLE_MILLIS) {
                            ...
                            LogManager.m6046d(TAG, "Not stopping scan because this is Android N and we keep scanning for a minimum of 6 seconds at a time. We will stop in " + (ANDROID_N_MIN_SCAN_CYCLE_MILLIS - (elapsedRealtime - this.mLastScanCycleStartTime)) + " millisconds.", new Object[0]);
                            this.mScanningLeftOn = true;
                            this.mLastScanCycleEndTime = SystemClock.elapsedRealtime();
                        }
                    } else {
            ...
            if (!this.mScanningEnabled) {
                LogManager.m6046d(TAG, "Scanning disabled. ", new Object[0]);
                this.mScanCyclerStarted = false;
                cancelWakeUpAlarm();
            }
        } catch (SecurityException unused) {
    ...
    public BluetoothAdapter getBluetoothAdapter() {
        try {
            if (this.mBluetoothAdapter == null) {
                ...
                if (adapter == null) {
                    LogManager.m6054w(TAG, "Failed to construct a BluetoothAdapter", new Object[0]);
                }
            }
        } catch (SecurityException unused) {
            LogManager.m6048e(TAG, "Cannot consruct bluetooth adapter.  Security Exception", new Object[0]);
        }
    ...
    public void setWakeUpAlarm() {
        ...
        LogManager.m6046d(TAG, "Set a wakeup alarm to go off in %s ms: %s", Long.valueOf(j), getWakeUpOperation());
    }
    ...
    public void cancelWakeUpAlarm() {
        LogManager.m6046d(TAG, "cancel wakeup alarm: %s", this.mWakeUpOperation);
        ((AlarmManager) this.mContext.getSystemService(NotificationCompat.CATEGORY_ALARM)).set(2, Long.MAX_VALUE, getWakeUpOperation());
        LogManager.m6046d(TAG, "Set a wakeup alarm to go off in %s ms: %s", Long.valueOf(Long.MAX_VALUE - SystemClock.elapsedRealtime()), getWakeUpOperation());
    }
    ...
    private long getNextScanStartTime() {
        ...
        LogManager.m6046d(TAG, "Normalizing between scan period from %s to %s", Long.valueOf(this.mBetweenScanPeriod), Long.valueOf(elapsedRealtime));
    ...
    private boolean mustStopScanToPreventAndroidNScanTimeout() {
        ...
        L_0x0025:
            ...
            org.altbeacon.beacon.logging.LogManager.m6046d(r1, r2, r0)
