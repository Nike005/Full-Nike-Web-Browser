...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m6022ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m6023ln(float f) {
