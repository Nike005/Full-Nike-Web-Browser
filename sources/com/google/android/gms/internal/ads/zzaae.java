...
import com.google.android.gms.ads.impl.C0059R;
...
public final class zzaae extends zzaal {
    ...
    public final void execute() {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            zzan.setTitle(resources != null ? resources.getString(C0059R.string.f12s1) : "Save image");
            zzan.setMessage(resources != null ? resources.getString(C0059R.string.f13s2) : "Allow Ad to store image in Picture gallery?");
            zzan.setPositiveButton(resources != null ? resources.getString(C0059R.string.f14s3) : "Accept", new zzaaf(this, str, lastPathSegment));
            zzan.setNegativeButton(resources != null ? resources.getString(C0059R.string.f15s4) : "Decline", new zzaag(this));
            zzan.create().show();
        }
    }
}
