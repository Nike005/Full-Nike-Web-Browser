...
import com.mopub.mobileads.base.C0506R;
...
public class MoPubView extends FrameLayout {
    ...
    private MoPubAdSize getMoPubAdSizeFromAttributeSet(Context context, AttributeSet attributeSet, MoPubAdSize moPubAdSize) {
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C0506R.styleable.MoPubView, 0, 0);
        try {
            moPubAdSize = MoPubAdSize.valueOf(obtainStyledAttributes.getInteger(C0506R.styleable.MoPubView_moPubAdSize, moPubAdSize.toInt()));
