    ...
    class Cea608CCWidget extends ClosedCaptionWidget implements Cea608CCParser.DisplayListener {
        ...
        private class CCLineBox extends AppCompatTextView {
            ...
            CCLineBox(Context context) {
                ...
                this.mOutlineWidth = (float) resources.getDimensionPixelSize(C4412R.dimen.subtitle_outline_width);
                this.mShadowRadius = (float) resources.getDimensionPixelSize(C4412R.dimen.subtitle_shadow_radius);
                this.mShadowOffset = (float) resources.getDimensionPixelSize(C4412R.dimen.subtitle_shadow_offset);
            }
