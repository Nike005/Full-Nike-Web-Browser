...
public class VideoView extends SelectiveLayout {
    ...
    public VideoView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mSurfaceListener = new VideoViewInterface.SurfaceListener() {
            public void onSurfaceCreated(View view, int i, int i2) {
                if (VideoView.DEBUG) {
                    Log.d(VideoView.TAG, "onSurfaceCreated(), width/height: " + i + "/" + i2 + ", " + view.toString());
                }
            ...
            public void onSurfaceChanged(View view, int i, int i2) {
                if (VideoView.DEBUG) {
                    Log.d(VideoView.TAG, "onSurfaceChanged(). width/height: " + i + "/" + i2 + ", " + view.toString());
                }
            }
        ...
        SubtitleController subtitleController = new SubtitleController(context, (MediaTimeProvider) null, new SubtitleController.Listener() {
            ...
            public void onSubtitleTrackSelected(androidx.media2.widget.SubtitleTrack r5) {
                ...
                L_0x0044:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.media2.widget.VideoView.C44242.onSubtitleTrackSelected(androidx.media2.widget.SubtitleTrack):void");
            }
        });
    ...
    public void updateMusicView(MediaItem mediaItem) {
        if (mediaItem != null && isCurrentItemMusic()) {
            ...
            Drawable albumArt = getAlbumArt(metadata, resources.getDrawable(C4412R.C4414drawable.ic_default_album_image));
            String string = getString(metadata, "android.media.metadata.TITLE", resources.getString(C4412R.string.mcv2_music_title_unknown_text));
            String string2 = getString(metadata, "android.media.metadata.ARTIST", resources.getString(C4412R.string.mcv2_music_artist_unknown_text));
    ...
    private Drawable getAlbumArt(MediaMetadata mediaMetadata, Drawable drawable) {
        ...
        this.mMusicView.setBackgroundColor(getResources().getColor(C4412R.color.music_view_default_background));
        return drawable;
    }
        ...
        private boolean shouldIgnoreCallback(PlayerWrapper playerWrapper) {
            ...
            if (VideoView.DEBUG) {
                try {
                    ...
                    Log.w(VideoView.TAG, methodName + " should be ignored. player is already gone.");
