...
final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSource.MediaSourceCaller, DefaultMediaClock.PlaybackParameterListener, PlayerMessage.Sender {
    ...
    public synchronized void sendMessage(PlayerMessage playerMessage) {
        ...
        Log.m9w(TAG, "Ignoring messages sent after release.");
    ...
    public boolean handleMessage(Message message) {
        ...
        try {
            ...
            Log.m6e(TAG, getExoPlaybackExceptionMessage(e), e);
            stopInternal(true, false, false);
            this.playbackInfo = this.playbackInfo.copyWithPlaybackError(e);
            maybeNotifyPlaybackInfoChanged();
        } catch (IOException e2) {
            Log.m6e(TAG, "Source error.", e2);
            ...
            Log.m6e(TAG, "Internal runtime error.", e3);
    ...
    private void seekToCurrentPosition(boolean z) throws ExoPlaybackException {
        MediaSource.MediaPeriodId mediaPeriodId = this.queue.getPlayingPeriod().f5150info.f5057id;
    ...
    private void doSomeWork() throws com.google.android.exoplayer2.ExoPlaybackException, java.io.IOException {
        ...
        L_0x00b2:
            ...
            r15 = 1
        L_0x00b9:
            com.google.android.exoplayer2.MediaPeriodInfo r4 = r3.f5150info
            ...
            if (r5 > 0) goto L_0x00e2
        L_0x00d5:
            com.google.android.exoplayer2.MediaPeriodInfo r3 = r3.f5150info
    ...
    private void seekToInternal(com.google.android.exoplayer2.ExoPlayerImplInternal.SeekPosition r17) throws com.google.android.exoplayer2.ExoPlaybackException {
        ...
        L_0x009b:
            r0 = r12
        L_0x009c:
            long r4 = com.google.android.exoplayer2.C5211C.usToMs(r0)     // Catch:{ all -> 0x00e7 }
            com.google.android.exoplayer2.PlaybackInfo r6 = r7.playbackInfo     // Catch:{ all -> 0x00e7 }
            long r2 = r6.positionUs     // Catch:{ all -> 0x00e7 }
            long r2 = com.google.android.exoplayer2.C5211C.usToMs(r2)     // Catch:{ all -> 0x00e7 }
    ...
    private long seekToPeriodPosition(MediaSource.MediaPeriodId mediaPeriodId, long j, boolean z) throws ExoPlaybackException {
        ...
        while (true) {
            if (mediaPeriodHolder != null) {
                if (mediaPeriodId.equals(mediaPeriodHolder.f5150info.f5057id) && mediaPeriodHolder.prepared) {
    ...
    private void resetInternal(boolean r24, boolean r25, boolean r26, boolean r27, boolean r28) {
        ...
        L_0x0025:
            ...
            com.google.android.exoplayer2.util.Log.m6e(r6, r7, r0)
        L_0x002a:
            int r5 = r5 + 1
            goto L_0x0018
        L_0x002d:
        ...
        L_0x003b:
            ...
            com.google.android.exoplayer2.util.Log.m6e(r6, r0, r7)
        L_0x0042:
            int r5 = r5 + 1
            goto L_0x0033
        L_0x0045:
    ...
    private void sendMessageToTargetThread(PlayerMessage playerMessage) {
        ...
        if (!handler2.getLooper().getThread().isAlive()) {
            Log.m9w("TAG", "Trying to send message on a dead thread.");
            playerMessage.markAsProcessed(false);
            return;
        }
    ...
    public /* synthetic */ void lambda$sendMessageToTargetThread$0$ExoPlayerImplInternal(PlayerMessage playerMessage) {
        try {
            ...
            Log.m6e(TAG, "Unexpected error delivering message on external thread.", e);
    ...
    private boolean resolvePendingMessagePosition(PendingMessageInfo pendingMessageInfo) {
        if (pendingMessageInfo.resolvedPeriodUid == null) {
            Pair<Object, Long> resolveSeekPosition = resolveSeekPosition(new SeekPosition(pendingMessageInfo.message.getTimeline(), pendingMessageInfo.message.getWindowIndex(), C5211C.msToUs(pendingMessageInfo.message.getPositionMs())), false);
            ...
            if (!selectTracks.isEquivalent(playingPeriod.getTrackSelectorResult())) {
                if (z) {
                    ...
                    if (playingPeriod.prepared) {
                        playingPeriod.applyTrackSelection(selectTracks, Math.max(playingPeriod.f5150info.startPositionUs, playingPeriod.toPeriodTime(this.rendererPositionUs)), false);
                    }
                }
    ...
    private boolean shouldTransitionToReadyState(boolean z) {
        ...
        if ((loadingPeriod.isFullyBuffered() && loadingPeriod.f5150info.isFinal) || this.loadControl.shouldStartPlayback(getTotalBufferedDurationUs(), this.mediaClock.getPlaybackParameters().speed, this.rebuffering)) {
            return true;
        }
        return false;
    }
    ...
    private boolean isTimelineReady() {
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        long j = playingPeriod.f5150info.durationUs;
    ...
    private void handleSourceInfoRefreshed(com.google.android.exoplayer2.ExoPlayerImplInternal.MediaSourceRefreshInfo r12) throws com.google.android.exoplayer2.ExoPlaybackException {
        ...
        L_0x011c:
            ...
            com.google.android.exoplayer2.MediaPeriodInfo r1 = r12.f5150info
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r1 = r1.f5057id
            boolean r1 = r1.equals(r6)
            if (r1 == 0) goto L_0x011c
            com.google.android.exoplayer2.MediaPeriodQueue r1 = r11.queue
            com.google.android.exoplayer2.MediaPeriodInfo r2 = r12.f5150info
    ...
    private void maybeUpdateReadingPeriod() throws ExoPlaybackException {
        ...
        if (readingPeriod != null) {
            ...
            if (readingPeriod.getNext() == null) {
                if (readingPeriod.f5150info.isFinal) {
                    while (true) {
                        Renderer[] rendererArr = this.renderers;
                        if (i < rendererArr.length) {
                            Renderer renderer = rendererArr[i];
    ...
    private void maybeUpdatePlayingPeriod() throws ExoPlaybackException {
        ...
        while (shouldAdvancePlayingPeriod()) {
            ...
            updatePlayingPeriodRenderers(playingPeriod);
            this.playbackInfo = copyWithNewPosition(advancePlayingPeriod.f5150info.f5057id, advancePlayingPeriod.f5150info.startPositionUs, advancePlayingPeriod.f5150info.contentPositionUs);
            this.playbackInfoUpdate.setPositionDiscontinuity(playingPeriod.f5150info.isLastInTimelinePeriod ? 0 : 3);
            updatePlaybackPositions();
            z = true;
        }
    }
    ...
    private void handlePeriodPrepared(MediaPeriod mediaPeriod) throws ExoPlaybackException {
        if (this.queue.isLoading(mediaPeriod)) {
            ...
            if (loadingPeriod == this.queue.getPlayingPeriod()) {
                resetRendererPosition(loadingPeriod.f5150info.startPositionUs);
    ...
    private void handleLoadingMediaPeriodChanged(boolean z) {
        long j;
        MediaPeriodHolder loadingPeriod = this.queue.getLoadingPeriod();
        MediaSource.MediaPeriodId mediaPeriodId = loadingPeriod == null ? this.playbackInfo.periodId : loadingPeriod.f5150info.f5057id;
