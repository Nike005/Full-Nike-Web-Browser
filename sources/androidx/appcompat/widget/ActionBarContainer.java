...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C3333R.styleable.ActionBar);
        this.mBackground = obtainStyledAttributes.getDrawable(C3333R.styleable.ActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C3333R.styleable.ActionBar_backgroundStacked);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(C3333R.styleable.ActionBar_height, -1);
        boolean z = true;
        if (getId() == C3333R.C3336id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C3333R.styleable.ActionBar_backgroundSplit);
        }
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C3333R.C3336id.action_bar);
        this.mContextView = findViewById(C3333R.C3336id.action_context_bar);
    }
