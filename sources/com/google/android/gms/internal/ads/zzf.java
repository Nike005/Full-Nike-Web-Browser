...
final class zzf implements zzt {
    ...
    public final synchronized boolean zzb(com.google.android.gms.internal.ads.zzr<?> r6) {
        ...
        L_0x001e:
            ...
            com.google.android.gms.internal.ads.zzaf.m40d(r6, r1)     // Catch:{ all -> 0x0052 }
        L_0x0038:
            monitor-exit(r5)
            return r2
        L_0x003a:
    ...
    public final synchronized void zza(zzr<?> zzr) {
        ...
        if (remove != null && !remove.isEmpty()) {
            if (zzaf.DEBUG) {
                zzaf.m42v("%d waiting requests for cacheKey=%s; resend to network", Integer.valueOf(remove.size()), url);
            }
            ...
            try {
                ...
                zzaf.m41e("Couldn't add request to queue. %s", e.toString());
    ...
    public final void zza(zzr<?> zzr, zzx<?> zzx) {
        ...
        if (remove != null) {
            if (zzaf.DEBUG) {
                zzaf.m42v("Releasing %d waiting requests for cacheKey=%s.", Integer.valueOf(remove.size()), url);
            }
            for (zzr zzb : remove) {
