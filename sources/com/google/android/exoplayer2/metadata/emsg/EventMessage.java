...
public final class EventMessage implements Metadata.Entry {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.durationMs != eventMessage.durationMs || this.f5063id != eventMessage.f5063id || !Util.areEqual(this.schemeIdUri, eventMessage.schemeIdUri) || !Util.areEqual(this.value, eventMessage.value) || !Arrays.equals(this.messageData, eventMessage.messageData)) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "EMSG: scheme=" + this.schemeIdUri + ", id=" + this.f5063id + ", durationMs=" + this.durationMs + ", value=" + this.value;
    }
