...
import com.startapp.android.publish.ads.video.p022a.C0965a;
...
public class C1038h {
    ...
    public enum C1039a {
        ...
        private C1039a(String str) {
            this.desctiption = str;
        }

        /* renamed from: a */
        public String mo14417a() {
    ...
    public static java.lang.String m1116a(android.content.Context r11, java.net.URL r12, java.lang.String r13) {
        /*
            ...
            r3 = 3
            com.startapp.common.p043a.C1270g.m2078a((java.lang.String) r2, (int) r3, (java.lang.String) r1)
            r1 = 0
            java.lang.String r3 = m1115a((android.content.Context) r11, (java.lang.String) r13)     // Catch:{ Exception -> 0x0097, all -> 0x0093 }
        ...
        L_0x005e:
            ...
            java.lang.String r9 = m1115a((android.content.Context) r11, (java.lang.String) r9)     // Catch:{ Exception -> 0x0084 }
        ...
        L_0x009b:
            ...
            java.lang.String r11 = m1115a((android.content.Context) r11, (java.lang.String) r13)     // Catch:{ all -> 0x00d4 }
        ...
        L_0x00e1:
            goto L_0x00e0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.startapp.android.publish.ads.video.C1038h.m1116a(android.content.Context, java.net.URL, java.lang.String):java.lang.String");
    }

    /* renamed from: a */
    public static C1039a m1114a(Context context) {
        C1039a aVar = C1039a.ELIGIBLE;
        if (m1120c(context)) {
            aVar = C1039a.INELIGIBLE_ERRORS_THRESHOLD_REACHED;
        }
        if (!C1061i.m1196a(context, (Class<? extends Activity>) FullScreenActivity.class)) {
            aVar = C1039a.INELIGIBLE_MISSING_ACTIVITY;
        }
        return !m1121d(context) ? C1039a.INELIGIBLE_NO_STORAGE : aVar;
    }

    /* renamed from: b */
    public static void m1119b(Context context) {
        C1166k.m1615b(context, "videoErrorsCount", Integer.valueOf(C1166k.m1608a(context, "videoErrorsCount", (Integer) 0).intValue() + 1));
    }

    /* renamed from: a */
    public static void m1117a(Context context, C0965a aVar) {
        if (aVar != null) {
            for (String b : aVar.mo14254a()) {
                C1103c.m1394b(context, b);
            }
        }
    }

    /* renamed from: a */
    public static boolean m1118a(String str) {
        for (C1200g next : C1186a.m1756a().mo15074d()) {
            if (next.mo15103b() instanceof C1008e) {
                C1008e eVar = (C1008e) next.mo15103b();
                if (!(eVar.mo14370d() == null || eVar.mo14370d().getLocalVideoPath() == null || !eVar.mo14370d().getLocalVideoPath().equals(str))) {
                    return true;
                }
            }
        }
    ...
    /* renamed from: a */
    static String m1115a(Context context, String str) {
        return context.getFilesDir() + "/" + str;
    }

    /* renamed from: c */
    private static boolean m1120c(Context context) {
        if (C1098b.m1303a().mo14754H().mo15027e() >= 0 && C1166k.m1608a(context, "videoErrorsCount", (Integer) 0).intValue() >= C1098b.m1303a().mo14754H().mo15027e()) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: d */
    private static boolean m1121d(Context context) {
        long a = C1061i.m1173a(context.getFilesDir(), -1);
        if (a < 0) {
            return false;
        }
        if (a / PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID > C1098b.m1303a().mo14754H().mo15025c() * PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) {
            return true;
        }
        return false;
    }
