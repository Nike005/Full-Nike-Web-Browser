    ...
    static /* synthetic */ class C07951 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.onesignal.influence.OSTrackerFactory.C07951.<clinit>():void");
        }
    }

    public void addSessionData(JSONObject jSONObject, List<OSInfluence> list) {
        for (OSInfluence next : list) {
            if (C07951.$SwitchMap$com$onesignal$influence$model$OSInfluenceChannel[next.getInfluenceChannel().ordinal()] == 1) {
