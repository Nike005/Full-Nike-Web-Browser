    ...
    static final class AsyncOuterManager<S, T> implements Producer, Subscription, Observer<Observable<? extends T>> {
        ...
        public void request(long r5) {
            ...
            L_0x007e:
                goto L_0x007d
            */
            throw new UnsupportedOperationException("Method not decompiled: p054rx.observables.AsyncOnSubscribe.AsyncOuterManager.request(long):void");
        }
        ...
        public void requestRemaining(long r4) {
            ...
            L_0x0076:
                goto L_0x0075
            */
            throw new UnsupportedOperationException("Method not decompiled: p054rx.observables.AsyncOnSubscribe.AsyncOuterManager.requestRemaining(long):void");
        }
        ...
        private void subscribeBufferToObservable(Observable<? extends T> observable) {
            ...
            final C28341 r3 = new Subscriber<T>() {
                long remaining = j;
