...
public abstract class SubtitleTrack implements MediaTimeProvider.OnMediaTimeListener {
    ...
    public synchronized void updateActiveCues(boolean r8, long r9) {
        ...
        L_0x000c:
            androidx.media2.player.subtitle.SubtitleTrack$CueList r8 = r7.mCues     // Catch:{ all -> 0x00ba }
            long r0 = r7.mLastUpdateTimeMs     // Catch:{ all -> 0x00ba }
        ...
        L_0x0018:
            ...
            androidx.media2.player.subtitle.SubtitleTrack$Cue r1 = (androidx.media2.player.subtitle.SubtitleTrack.Cue) r1     // Catch:{ all -> 0x00ba }
        ...
        L_0x0050:
            java.util.ArrayList<androidx.media2.player.subtitle.SubtitleTrack$Cue> r0 = r7.mActiveCues     // Catch:{ all -> 0x00ba }
        ...
        L_0x0096:
            ...
            goto L_0x0018
        L_0x009f:
            android.util.LongSparseArray<androidx.media2.player.subtitle.SubtitleTrack$Run> r8 = r7.mRunsByEndTime     // Catch:{ all -> 0x00ba }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:39:0x00d8 A[DONT_GENERATE, SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized boolean addCue(androidx.media2.player.subtitle.SubtitleTrack.Cue r12) {
        /*
            r11 = this;
            monitor-enter(r11)
            androidx.media2.player.subtitle.SubtitleTrack$CueList r0 = r11.mCues     // Catch:{ all -> 0x00f7 }
            r0.add(r12)     // Catch:{ all -> 0x00f7 }
            long r0 = r12.mRunID     // Catch:{ all -> 0x00f7 }
            r2 = 0
            int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r4 == 0) goto L_0x003d
            android.util.LongSparseArray<androidx.media2.player.subtitle.SubtitleTrack$Run> r0 = r11.mRunsByID     // Catch:{ all -> 0x00f7 }
            long r4 = r12.mRunID     // Catch:{ all -> 0x00f7 }
            java.lang.Object r0 = r0.get(r4)     // Catch:{ all -> 0x00f7 }
            androidx.media2.player.subtitle.SubtitleTrack$Run r0 = (androidx.media2.player.subtitle.SubtitleTrack.Run) r0     // Catch:{ all -> 0x00f7 }
            if (r0 != 0) goto L_0x002b
            androidx.media2.player.subtitle.SubtitleTrack$Run r0 = new androidx.media2.player.subtitle.SubtitleTrack$Run     // Catch:{ all -> 0x00f7 }
            r0.<init>()     // Catch:{ all -> 0x00f7 }
            android.util.LongSparseArray<androidx.media2.player.subtitle.SubtitleTrack$Run> r1 = r11.mRunsByID     // Catch:{ all -> 0x00f7 }
            long r4 = r12.mRunID     // Catch:{ all -> 0x00f7 }
        ...
        L_0x002b:
            ...
            r0.mEndTimeMs = r4     // Catch:{ all -> 0x00f7 }
        L_0x0037:
            androidx.media2.player.subtitle.SubtitleTrack$Cue r1 = r0.mFirstCue     // Catch:{ all -> 0x00f7 }
            r12.mNextInRun = r1     // Catch:{ all -> 0x00f7 }
            r0.mFirstCue = r12     // Catch:{ all -> 0x00f7 }
        L_0x003d:
            r0 = -1
            androidx.media2.player.subtitle.MediaTimeProvider r4 = r11.mTimeProvider     // Catch:{ all -> 0x00f7 }
            r5 = 1
            r6 = 0
            if (r4 == 0) goto L_0x004f
            androidx.media2.player.subtitle.MediaTimeProvider r4 = r11.mTimeProvider     // Catch:{ IllegalStateException -> 0x004f }
            long r7 = r4.getCurrentTimeUs(r6, r5)     // Catch:{ IllegalStateException -> 0x004f }
        ...
        L_0x0091:
            ...
            if (r4 < 0) goto L_0x00d8
            java.lang.Runnable r12 = r11.mRunnable     // Catch:{ all -> 0x00f7 }
            if (r12 == 0) goto L_0x00ae
            android.os.Handler r12 = r11.mHandler     // Catch:{ all -> 0x00f7 }
            java.lang.Runnable r2 = r11.mRunnable     // Catch:{ all -> 0x00f7 }
            r12.removeCallbacks(r2)     // Catch:{ all -> 0x00f7 }
        L_0x00ae:
            androidx.media2.player.subtitle.SubtitleTrack$1 r12 = new androidx.media2.player.subtitle.SubtitleTrack$1     // Catch:{ all -> 0x00f7 }
            r12.<init>(r11, r0)     // Catch:{ all -> 0x00f7 }
            r11.mRunnable = r12     // Catch:{ all -> 0x00f7 }
            android.os.Handler r0 = r11.mHandler     // Catch:{ all -> 0x00f7 }
            r1 = 10
            boolean r12 = r0.postDelayed(r12, r1)     // Catch:{ all -> 0x00f7 }
            if (r12 == 0) goto L_0x00cb
            boolean r12 = r11.DEBUG     // Catch:{ all -> 0x00f7 }
            if (r12 == 0) goto L_0x00d6
            java.lang.String r12 = "SubtitleTrack"
            java.lang.String r0 = "scheduling update"
            android.util.Log.v(r12, r0)     // Catch:{ all -> 0x00f7 }
            goto L_0x00d6
        L_0x00cb:
            boolean r12 = r11.DEBUG     // Catch:{ all -> 0x00f7 }
            if (r12 == 0) goto L_0x00d6
            ...
            android.util.Log.w(r12, r0)     // Catch:{ all -> 0x00f7 }
        L_0x00d6:
            monitor-exit(r11)
            return r5
        L_0x00d8:
            boolean r0 = r11.mVisible     // Catch:{ all -> 0x00f7 }
            if (r0 == 0) goto L_0x00f5
            long r0 = r12.mEndTimeMs     // Catch:{ all -> 0x00f7 }
            long r4 = r11.mLastTimeMs     // Catch:{ all -> 0x00f7 }
            int r7 = (r0 > r4 ? 1 : (r0 == r4 ? 0 : -1))
            if (r7 < 0) goto L_0x00f5
            long r0 = r12.mStartTimeMs     // Catch:{ all -> 0x00f7 }
            long r4 = r11.mNextScheduledTimeMs     // Catch:{ all -> 0x00f7 }
            int r12 = (r0 > r4 ? 1 : (r0 == r4 ? 0 : -1))
            if (r12 < 0) goto L_0x00f2
            long r0 = r11.mNextScheduledTimeMs     // Catch:{ all -> 0x00f7 }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void setTimeProvider(androidx.media2.player.subtitle.MediaTimeProvider r2) {
        /*
            r1 = this;
            monitor-enter(r1)
            androidx.media2.player.subtitle.MediaTimeProvider r0 = r1.mTimeProvider     // Catch:{ all -> 0x0019 }
        ...
        L_0x0019:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media2.player.subtitle.SubtitleTrack.setTimeProvider(androidx.media2.player.subtitle.MediaTimeProvider):void");
    }
    ...
    static class CueList {
        ...
        class EntryIterator implements Iterator<Pair<Long, Cue>> {
            ...
            private void nextKey() {
                ...
                L_0x0000:
                    r0 = 0
                    java.util.SortedMap<java.lang.Long, java.util.ArrayList<androidx.media2.player.subtitle.SubtitleTrack$Cue>> r1 = r6.mRemainingCues     // Catch:{ NoSuchElementException -> 0x004d }
                    if (r1 == 0) goto L_0x0045
                    java.util.SortedMap<java.lang.Long, java.util.ArrayList<androidx.media2.player.subtitle.SubtitleTrack$Cue>> r1 = r6.mRemainingCues     // Catch:{ NoSuchElementException -> 0x004d }
                    java.lang.Object r1 = r1.firstKey()     // Catch:{ NoSuchElementException -> 0x004d }
                    java.lang.Long r1 = (java.lang.Long) r1     // Catch:{ NoSuchElementException -> 0x004d }
                    long r1 = r1.longValue()     // Catch:{ NoSuchElementException -> 0x004d }
                    r6.mCurrentTimeMs = r1     // Catch:{ NoSuchElementException -> 0x004d }
                    java.util.SortedMap<java.lang.Long, java.util.ArrayList<androidx.media2.player.subtitle.SubtitleTrack$Cue>> r3 = r6.mRemainingCues     // Catch:{ NoSuchElementException -> 0x004d }
                    java.lang.Long r1 = java.lang.Long.valueOf(r1)     // Catch:{ NoSuchElementException -> 0x004d }
                    java.lang.Object r1 = r3.get(r1)     // Catch:{ NoSuchElementException -> 0x004d }
                    java.util.ArrayList r1 = (java.util.ArrayList) r1     // Catch:{ NoSuchElementException -> 0x004d }
                    java.util.Iterator r1 = r1.iterator()     // Catch:{ NoSuchElementException -> 0x004d }
                    r6.mListIterator = r1     // Catch:{ NoSuchElementException -> 0x004d }
                    java.util.SortedMap<java.lang.Long, java.util.ArrayList<androidx.media2.player.subtitle.SubtitleTrack$Cue>> r1 = r6.mRemainingCues     // Catch:{ IllegalArgumentException -> 0x0037 }
                    long r2 = r6.mCurrentTimeMs     // Catch:{ IllegalArgumentException -> 0x0037 }
                    r4 = 1
                    long r2 = r2 + r4
                    java.lang.Long r2 = java.lang.Long.valueOf(r2)     // Catch:{ IllegalArgumentException -> 0x0037 }
                    java.util.SortedMap r1 = r1.tailMap(r2)     // Catch:{ IllegalArgumentException -> 0x0037 }
                    r6.mRemainingCues = r1     // Catch:{ IllegalArgumentException -> 0x0037 }
                    goto L_0x0039
                L_0x0037:
                    r6.mRemainingCues = r0     // Catch:{ NoSuchElementException -> 0x004d }
                L_0x0039:
                    r1 = 0
                    r6.mDone = r1     // Catch:{ NoSuchElementException -> 0x004d }
                    java.util.Iterator<androidx.media2.player.subtitle.SubtitleTrack$Cue> r0 = r6.mListIterator
                    boolean r0 = r0.hasNext()
                    if (r0 == 0) goto L_0x0000
                    return
                L_0x0045:
                    java.util.NoSuchElementException r1 = new java.util.NoSuchElementException     // Catch:{ NoSuchElementException -> 0x004d }
                    java.lang.String r2 = ""
                    r1.<init>(r2)     // Catch:{ NoSuchElementException -> 0x004d }
                    throw r1     // Catch:{ NoSuchElementException -> 0x004d }
                L_0x004d:
                    r1 = 1
                    r6.mDone = r1
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.media2.player.subtitle.SubtitleTrack.CueList.EntryIterator.nextKey():void");
            }
        }
