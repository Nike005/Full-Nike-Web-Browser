...
public interface AudioRendererEventListener {
    ...
    public static final class EventDispatcher {
        ...
        public void decoderInitialized(String str, long j, long j2) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(str, j, j2) {
                    ...
                    public final void run() {
                        AudioRendererEventListener.EventDispatcher.this.mo43553xba417f1c(this.f$1, this.f$2, this.f$3);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo43553xba417f1c(String str, long j, long j2) {
        ...
        public void inputFormatChanged(Format format) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(format) {
                    ...
                    public final void run() {
                        AudioRendererEventListener.EventDispatcher.this.mo43556x2eadf638(this.f$1);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo43556x2eadf638(Format format) {
        ...
        public void audioTrackUnderrun(int i, long j, long j2) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(i, j, j2) {
                    ...
                    public final void run() {
                        AudioRendererEventListener.EventDispatcher.this.mo43552xe45e91e2(this.f$1, this.f$2, this.f$3);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo43552xe45e91e2(int i, long j, long j2) {
        ...
        public void audioSessionId(int i) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(i) {
                    ...
                    public final void run() {
                        AudioRendererEventListener.EventDispatcher.this.mo43551xc1c634cd(this.f$1);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo43551xc1c634cd(int i) {
