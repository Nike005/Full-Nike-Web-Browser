...
public final class AudioFocusManager {
    ...
    private static int convertAudioAttributesToFocusGain(AudioAttributes audioAttributes2) {
        ...
        switch (audioAttributes2.usage) {
            case 0:
                Log.m6210w(TAG, "Specify a proper usage in the audio attributes for audio focus handling. Using AUDIOFOCUS_GAIN by default.");
                return 1;
            case 1:
            case 14:
                return 1;
        ...
        public void onAudioFocusChange(int i) {
            if (i != -3) {
                if (i == -2) {
                    ...
                    sb.append(i);
                    Log.m6210w(AudioFocusManager.TAG, sb.toString());
                    return;
                } else {
