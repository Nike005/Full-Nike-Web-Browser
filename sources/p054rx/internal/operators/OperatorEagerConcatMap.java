    ...
    static final class EagerOuterSubscriber<T, R> extends Subscriber<T> {
        ...
        public void onNext(T r4) {
            /*
                ...
                rx.Observable r0 = (p054rx.Observable) r0     // Catch:{ all -> 0x0032 }
            ...
            L_0x0032:
                ...
                p054rx.exceptions.Exceptions.throwOrReport((java.lang.Throwable) r0, (p054rx.Observer<?>) r1, (java.lang.Object) r4)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p054rx.internal.operators.OperatorEagerConcatMap.EagerOuterSubscriber.onNext(java.lang.Object):void");
        }
