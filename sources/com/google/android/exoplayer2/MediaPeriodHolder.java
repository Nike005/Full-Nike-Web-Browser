...
final class MediaPeriodHolder {
    ...
    public MediaPeriodInfo f5150info;
    ...
    public MediaPeriodHolder(RendererCapabilities[] rendererCapabilitiesArr, long j, TrackSelector trackSelector2, Allocator allocator, MediaSource mediaSource2, MediaPeriodInfo mediaPeriodInfo, TrackSelectorResult trackSelectorResult2) {
        ...
        this.uid = mediaPeriodInfo.f5057id.periodUid;
        this.f5150info = mediaPeriodInfo;
        this.trackSelectorResult = trackSelectorResult2;
        this.sampleStreams = new SampleStream[rendererCapabilitiesArr.length];
        this.mayRetainStreamFlags = new boolean[rendererCapabilitiesArr.length];
        this.mediaPeriod = createMediaPeriod(mediaPeriodInfo.f5057id, mediaSource2, allocator, mediaPeriodInfo.startPositionUs, mediaPeriodInfo.endPositionUs);
    }
    ...
    public long getStartPositionRendererTime() {
        return this.f5150info.startPositionUs + this.rendererPositionOffsetUs;
    }
    ...
    public long getBufferedPositionUs() {
        if (!this.prepared) {
            return this.f5150info.startPositionUs;
        }
        long bufferedPositionUs = this.hasEnabledTracks ? this.mediaPeriod.getBufferedPositionUs() : Long.MIN_VALUE;
        return bufferedPositionUs == Long.MIN_VALUE ? this.f5150info.durationUs : bufferedPositionUs;
    }
    ...
    public void handlePrepared(float f, Timeline timeline) throws ExoPlaybackException {
        ...
        long applyTrackSelection = applyTrackSelection(selectTracks(f, timeline), this.f5150info.startPositionUs, false);
        this.rendererPositionOffsetUs += this.f5150info.startPositionUs - applyTrackSelection;
        this.f5150info = this.f5150info.copyWithStartPositionUs(applyTrackSelection);
    }
    ...
    public TrackSelectorResult selectTracks(float f, Timeline timeline) throws ExoPlaybackException {
        TrackSelectorResult selectTracks = this.trackSelector.selectTracks(this.rendererCapabilities, getTrackGroups(), this.f5150info.f5057id, timeline);
    ...
    public void release() {
        disableTrackSelectionsInResult();
        releaseMediaPeriod(this.f5150info.endPositionUs, this.mediaSource, this.mediaPeriod);
    }
    ...
    private static void releaseMediaPeriod(long j, MediaSource mediaSource2, MediaPeriod mediaPeriod2) {
        ...
        try {
            ...
            Log.m6e(TAG, "Period release failed.", e);
        }
    }
}
