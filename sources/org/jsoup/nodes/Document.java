...
public class Document extends Element {
    ...
    public Document normalise() {
        Element findFirstElementByTagName = findFirstElementByTagName(AdType.HTML, this);
        if (findFirstElementByTagName == null) {
            findFirstElementByTagName = appendElement(AdType.HTML);
        }
        if (head() == null) {
        ...
        if (this.updateMetaCharset) {
            ...
            if (syntax == OutputSettings.Syntax.html) {
                ...
                if (node instanceof XmlDeclaration) {
                    ...
                    XmlDeclaration xmlDeclaration2 = new XmlDeclaration(JDOMConstants.NS_PREFIX_XML, this.baseUri, false);
                    xmlDeclaration2.attr("version", "1.0");
                    xmlDeclaration2.attr("encoding", charset().displayName());
                    prependChild(xmlDeclaration2);
                    return;
                }
                XmlDeclaration xmlDeclaration3 = new XmlDeclaration(JDOMConstants.NS_PREFIX_XML, this.baseUri, false);
