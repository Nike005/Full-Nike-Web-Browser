...
public class FacebookAdapterConfiguration extends BaseAdapterConfiguration {
    ...
    public AtomicBoolean isComputingToken = new AtomicBoolean(false);
    /* access modifiers changed from: private */
    public AtomicReference<String> tokenReference = new AtomicReference<>((Object) null);
        ...
        synchronized (FacebookAdapterConfiguration.class) {
            try {
                ...
                if (!AudienceNetworkAds.isInitialized(context)) {
                    AudienceNetworkAds.buildInitSettings(context).withPlacementIds(arrayList).withMediationService("MOPUB_5.13.1:5.10.1.0").initialize();
                }
            } catch (Throwable th) {
