...
public class BeaconService extends Service {
    ...
    public class BeaconBinder extends Binder {
        ...
        public BeaconService getService() {
            LogManager.m6050i(BeaconService.TAG, "getService of BeaconBinder called", new Object[0]);
        ...
        public void handleMessage(Message message) {
            ...
            if (beaconService != null) {
                ...
                if (fromBundle != null) {
                    int i = message.what;
                    if (i == 2) {
                        LogManager.m6050i(BeaconService.TAG, "start ranging received", new Object[0]);
                        ...
                        LogManager.m6050i(BeaconService.TAG, "stop ranging received", new Object[0]);
                        beaconService.stopRangingBeaconsInRegion(fromBundle.getRegionData());
                        beaconService.setScanPeriods(fromBundle.getScanPeriod(), fromBundle.getBetweenScanPeriod(), fromBundle.getBackgroundFlag());
                    } else if (i == 4) {
                        LogManager.m6050i(BeaconService.TAG, "start monitoring received", new Object[0]);
                        beaconService.startMonitoringBeaconsInRegion(fromBundle.getRegionData(), new Callback(fromBundle.getCallbackPackageName()));
                        beaconService.setScanPeriods(fromBundle.getScanPeriod(), fromBundle.getBetweenScanPeriod(), fromBundle.getBackgroundFlag());
                    } else if (i == 5) {
                        LogManager.m6050i(BeaconService.TAG, "stop monitoring received", new Object[0]);
                        beaconService.stopMonitoringBeaconsInRegion(fromBundle.getRegionData());
                        beaconService.setScanPeriods(fromBundle.getScanPeriod(), fromBundle.getBetweenScanPeriod(), fromBundle.getBackgroundFlag());
                    } else if (i != 6) {
                        super.handleMessage(message);
                    } else {
                        LogManager.m6050i(BeaconService.TAG, "set scan intervals received", new Object[0]);
                        beaconService.setScanPeriods(fromBundle.getScanPeriod(), fromBundle.getBetweenScanPeriod(), fromBundle.getBackgroundFlag());
                    }
                } else if (message.what == 7) {
                    LogManager.m6050i(BeaconService.TAG, "Received settings update from other process", new Object[0]);
                    SettingsData fromBundle2 = SettingsData.fromBundle(message.getData());
                    if (fromBundle2 != null) {
                        fromBundle2.apply(beaconService);
                    } else {
                        LogManager.m6054w(BeaconService.TAG, "Settings data missing", new Object[0]);
                    }
                } else {
                    LogManager.m6050i(BeaconService.TAG, "Received unknown message from other process : " + message.what, new Object[0]);
                }
            }
        }
    }
    ...
    public void onCreate() {
        ...
        if (instanceForApplication.isMainProcess()) {
            LogManager.m6050i(TAG, "beaconService version %s is starting up on the main process", BuildConfig.VERSION_NAME);
        } else {
            LogManager.m6050i(TAG, "beaconService version %s is starting up on a separate process", BuildConfig.VERSION_NAME);
            ProcessUtils processUtils = new ProcessUtils(this);
            LogManager.m6050i(TAG, "beaconService PID is " + processUtils.getPid() + " with process name " + processUtils.getProcessName(), new Object[0]);
        }
        try {
            ServiceInfo serviceInfo = getPackageManager().getServiceInfo(new ComponentName(this, BeaconService.class), 128);
            if (!(serviceInfo == null || serviceInfo.metaData == null || serviceInfo.metaData.get("longScanForcingEnabled") == null || !serviceInfo.metaData.get("longScanForcingEnabled").toString().equals(CleanerProperties.BOOL_ATT_TRUE))) {
                LogManager.m6050i(TAG, "longScanForcingEnabled to keep scans going on Android N for > 30 minutes", new Object[0]);
        ...
        try {
            ...
            LogManager.m6046d(TAG, "No org.altbeacon.beacon.SimulatedScanData class exists.", new Object[0]);
        } catch (Exception e) {
            LogManager.m6049e(e, TAG, "Cannot get simulated Scan data.  Make sure your org.altbeacon.beacon.SimulatedScanData class defines a field with the signature 'public static List<Beacon> beacons'", new Object[0]);
        }
    }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        LogManager.m6050i(TAG, str, new Object[0]);
        return super.onStartCommand(intent, i, i2);
    }

    public IBinder onBind(Intent intent) {
        LogManager.m6050i(TAG, "binding", new Object[0]);
        return this.mMessenger.getBinder();
    }

    public boolean onUnbind(Intent intent) {
        LogManager.m6050i(TAG, "unbinding", new Object[0]);
        return false;
    }

    public void onDestroy() {
        LogManager.m6048e(TAG, "onDestroy()", new Object[0]);
        if (Build.VERSION.SDK_INT < 18) {
            LogManager.m6054w(TAG, "Not supported prior to API 18.", new Object[0]);
            return;
        }
        this.bluetoothCrashResolver.stop();
        LogManager.m6050i(TAG, "onDestroy called.  stopping scanning", new Object[0]);
    ...
    public void onTaskRemoved(Intent intent) {
        ...
        LogManager.m6046d(TAG, "task removed", new Object[0]);
        if (Build.VERSION.RELEASE.contains("4.4.1") || Build.VERSION.RELEASE.contains("4.4.2") || Build.VERSION.RELEASE.contains("4.4.3")) {
            ...
            LogManager.m6046d(TAG, "Setting a wakeup alarm to go off due to Android 4.4.2 service restarting bug.", new Object[0]);
        }
    }
    ...
    public void startRangingBeaconsInRegion(Region region, Callback callback) {
        synchronized (this.mScanHelper.getRangedRegionState()) {
            if (this.mScanHelper.getRangedRegionState().containsKey(region)) {
                LogManager.m6050i(TAG, "Already ranging that region -- will replace existing region.", new Object[0]);
            ...
            LogManager.m6046d(TAG, "Currently ranging %s regions.", Integer.valueOf(this.mScanHelper.getRangedRegionState().size()));
        }
    ...
    public void startMonitoringBeaconsInRegion(Region region, Callback callback) {
        LogManager.m6046d(TAG, "startMonitoring called", new Object[0]);
        this.mScanHelper.getMonitoringStatus().addRegion(region, callback);
        LogManager.m6046d(TAG, "Currently monitoring %s regions.", Integer.valueOf(this.mScanHelper.getMonitoringStatus().regionsCount()));
        this.mScanHelper.getCycledScanner().start();
    }

    public void stopMonitoringBeaconsInRegion(Region region) {
        LogManager.m6046d(TAG, "stopMonitoring called", new Object[0]);
