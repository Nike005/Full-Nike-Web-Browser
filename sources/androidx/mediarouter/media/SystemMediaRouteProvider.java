...
abstract class SystemMediaRouteProvider extends MediaRouteProvider {
    ...
    static class LegacyImpl extends SystemMediaRouteProvider {
        ...
        public void publishRoutes() {
            ...
            setDescriptor(new MediaRouteProviderDescriptor.Builder().addRoute(new MediaRouteDescriptor.Builder(SystemMediaRouteProvider.DEFAULT_ROUTE_ID, resources.getString(C4427R.string.mr_system_route_name)).addControlFilters(CONTROL_FILTERS).setPlaybackStream(3).setPlaybackType(0).setVolumeHandling(1).setVolumeMax(streamMaxVolume).setVolume(this.mLastReportedVolume).build()).build());
        }
    ...
    static class JellybeanImpl extends SystemMediaRouteProvider implements MediaRouterJellybean.Callback, MediaRouterJellybean.VolumeCallback {
        ...
        public JellybeanImpl(Context context, SyncCallback syncCallback) {
            ...
            this.mUserRouteCategoryObj = MediaRouterJellybean.createRouteCategory(this.mRouterObj, context.getResources().getString(C4427R.string.mr_user_route_category_name), false);
            updateSystemRoutes();
        }
