            ...
            if (Pattern.matches((String) zzkb.zzik().zzd(zznk.zzbdw), zzr.getUrl())) {
                ...
                if (zzamu.zzbe(this.mContext)) {
                    ...
                    if (zzc != null) {
                        ...
                        zzakb.m43v(valueOf.length() != 0 ? "Got gmscore asset response: ".concat(valueOf) : new String("Got gmscore asset response: "));
                        return zzc;
                    }
                    String valueOf2 = String.valueOf(zzr.getUrl());
                    zzakb.m43v(valueOf2.length() != 0 ? "Failed to get gmscore asset response: ".concat(valueOf2) : new String("Failed to get gmscore asset response: "));
                }
            }
        }
