...
class GenerateNotification {
    ...
    private static void showNotificationAsAlert(final JSONObject jSONObject, final Activity activity, final int i) {
        activity.runOnUiThread(new Runnable() {
            public void run() {
                ...
                C06671 r4 = new DialogInterface.OnClickListener() {
    ...
    private static void addBackgroundImage(JSONObject jSONObject, NotificationCompat.Builder builder) throws Throwable {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            ...
            if (bitmap != null) {
                RemoteViews remoteViews = new RemoteViews(currentContext.getPackageName(), C0770R.layout.onesignal_bgimage_notif_layout);
                remoteViews.setTextViewText(C0770R.C0773id.os_bgimage_notif_title, getTitle(jSONObject));
                remoteViews.setTextViewText(C0770R.C0773id.os_bgimage_notif_body, jSONObject.optString("alert"));
                setTextColor(remoteViews, jSONObject2, C0770R.C0773id.os_bgimage_notif_title, "tc", "onesignal_bgimage_notif_title_color");
                setTextColor(remoteViews, jSONObject2, C0770R.C0773id.os_bgimage_notif_body, "bc", "onesignal_bgimage_notif_body_color");
                ...
                if ("right".equals(str)) {
                    remoteViews.setViewPadding(C0770R.C0773id.os_bgimage_notif_bgimage_align_layout, -5000, 0, 0, 0);
                    remoteViews.setImageViewBitmap(C0770R.C0773id.os_bgimage_notif_bgimage_right_aligned, bitmap);
                    remoteViews.setViewVisibility(C0770R.C0773id.os_bgimage_notif_bgimage_right_aligned, 0);
                    remoteViews.setViewVisibility(C0770R.C0773id.os_bgimage_notif_bgimage, 2);
                } else {
                    remoteViews.setImageViewBitmap(C0770R.C0773id.os_bgimage_notif_bgimage, bitmap);
                }
