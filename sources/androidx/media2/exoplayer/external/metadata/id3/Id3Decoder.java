...
public final class Id3Decoder implements MetadataDecoder {
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        if (parsableByteArray.bytesLeft() < 10) {
            Log.m6210w(TAG, "Data too short to be an ID3 tag");
            return null;
        }
        ...
        if (readUnsignedByte == 2) {
            if ((readUnsignedByte2 & 64) != 0) {
                Log.m6210w(TAG, "Skipped ID3 tag with majorVersion=2 and undefined compression scheme");
                return null;
            }
    ...
    private static androidx.media2.exoplayer.external.metadata.id3.Id3Frame decodeFrame(int r19, androidx.media2.exoplayer.external.util.ParsableByteArray r20, boolean r21, int r22, androidx.media2.exoplayer.external.metadata.id3.Id3Decoder.FramePredicate r23) {
        ...
        L_0x0067:
            ...
            androidx.media2.exoplayer.external.util.Log.m6210w(r4, r0)
            int r0 = r20.limit()
            r7.setPosition(r0)
            return r16
        L_0x0082:
        ...
        L_0x01f2:
            ...
            androidx.media2.exoplayer.external.util.Log.m6210w(r12, r0)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
        L_0x021e:
            r7.setPosition(r14)
            return r1
        L_0x0222:
            java.lang.String r0 = "Unsupported character encoding"
            androidx.media2.exoplayer.external.util.Log.m6210w(r12, r0)     // Catch:{ all -> 0x012e }
            r7.setPosition(r14)
            return r16
        L_0x022b:
            r7.setPosition(r14)
        ...
        L_0x022f:
            ...
            androidx.media2.exoplayer.external.util.Log.m6210w(r12, r0)
            r7.setPosition(r14)
            return r16
        */
    ...
    private static ApicFrame decodeApicFrame(ParsableByteArray parsableByteArray, int i, int i2) throws UnsupportedEncodingException {
        ...
        if (i2 == 2) {
            String valueOf = String.valueOf(Util.toLowerInvariant(new String(bArr, 0, 3, CharEncoding.ISO_8859_1)));
