...
public class MediaControlView extends MediaViewGroup {
    ...
    public MediaControlView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mFullScreenListener = new View.OnClickListener() {
            public void onClick(View view) {
                if (MediaControlView.this.mOnFullScreenListener != null) {
                    ...
                    if (z) {
                        MediaControlView.this.mFullScreenButton.setImageDrawable(MediaControlView.this.mResources.getDrawable(C4412R.C4414drawable.ic_fullscreen_exit));
                        MediaControlView.this.mMinimalFullScreenButton.setImageDrawable(MediaControlView.this.mResources.getDrawable(C4412R.C4414drawable.ic_fullscreen_exit));
                    } else {
                        MediaControlView.this.mFullScreenButton.setImageDrawable(MediaControlView.this.mResources.getDrawable(C4412R.C4414drawable.ic_fullscreen));
                        MediaControlView.this.mMinimalFullScreenButton.setImageDrawable(MediaControlView.this.mResources.getDrawable(C4412R.C4414drawable.ic_fullscreen));
                    }
        ...
        inflate(context, C4412R.layout.media_controller, this);
        initControllerView();
    ...
    public void requestPlayButtonFocus() {
        ImageButton findControlButton = findControlButton(this.mSizeType, C4412R.C4415id.pause);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (i7 == 2) {
            ...
            i5 = (i9 - viewGroup4.getMeasuredHeight()) - this.mResources.getDimensionPixelSize(C4412R.dimen.mcv2_custom_progress_margin_bottom);
        }
    ...
    private void initControllerView() {
        this.mTitleBar = findViewById(C4412R.C4415id.title_bar);
        this.mTitleView = (TextView) findViewById(C4412R.C4415id.title_text);
        this.mAdExternalLink = findViewById(C4412R.C4415id.ad_external_link);
        this.mCenterView = (ViewGroup) findViewById(C4412R.C4415id.center_view);
        this.mCenterViewBackground = findViewById(C4412R.C4415id.center_view_background);
        this.mEmbeddedTransportControls = initTransportControls(C4412R.C4415id.embedded_transport_controls);
        this.mMinimalTransportControls = initTransportControls(C4412R.C4415id.minimal_transport_controls);
        this.mMinimalFullScreenView = (ViewGroup) findViewById(C4412R.C4415id.minimal_fullscreen_view);
        ImageButton imageButton = (ImageButton) findViewById(C4412R.C4415id.minimal_fullscreen);
        this.mMinimalFullScreenButton = imageButton;
        imageButton.setOnClickListener(this.mFullScreenListener);
        this.mProgressBar = (ViewGroup) findViewById(C4412R.C4415id.progress_bar);
        SeekBar seekBar = (SeekBar) findViewById(C4412R.C4415id.progress);
        this.mProgress = seekBar;
        seekBar.setOnSeekBarChangeListener(this.mSeekListener);
        this.mProgress.setMax(1000);
        this.mCurrentSeekPosition = -1;
        this.mNextSeekPosition = -1;
        this.mBottomBarBackground = findViewById(C4412R.C4415id.bottom_bar_background);
        this.mBottomBarLeft = (ViewGroup) findViewById(C4412R.C4415id.bottom_bar_left);
        this.mFullTransportControls = initTransportControls(C4412R.C4415id.full_transport_controls);
        this.mTimeView = (ViewGroup) findViewById(C4412R.C4415id.time);
        this.mEndTime = (TextView) findViewById(C4412R.C4415id.time_end);
        this.mCurrentTime = (TextView) findViewById(C4412R.C4415id.time_current);
        this.mAdSkipView = (TextView) findViewById(C4412R.C4415id.ad_skip_time);
        this.mFormatBuilder = new StringBuilder();
        this.mFormatter = new Formatter(this.mFormatBuilder, Locale.getDefault());
        this.mBasicControls = (ViewGroup) findViewById(C4412R.C4415id.basic_controls);
        this.mExtraControls = (ViewGroup) findViewById(C4412R.C4415id.extra_controls);
        ImageButton imageButton2 = (ImageButton) findViewById(C4412R.C4415id.subtitle);
        this.mSubtitleButton = imageButton2;
        imageButton2.setOnClickListener(this.mSubtitleListener);
        ImageButton imageButton3 = (ImageButton) findViewById(C4412R.C4415id.fullscreen);
        this.mFullScreenButton = imageButton3;
        imageButton3.setOnClickListener(this.mFullScreenListener);
        ((ImageButton) findViewById(C4412R.C4415id.overflow_show)).setOnClickListener(this.mOverflowShowListener);
        ((ImageButton) findViewById(C4412R.C4415id.overflow_hide)).setOnClickListener(this.mOverflowHideListener);
        ((ImageButton) findViewById(C4412R.C4415id.settings)).setOnClickListener(this.mSettingsButtonListener);
        this.mAdRemainingView = (TextView) findViewById(C4412R.C4415id.ad_remaining);
        initializeSettingsLists();
        this.mSettingsListView = (ListView) inflateLayout(getContext(), C4412R.layout.settings_list);
        ...
        this.mEmbeddedSettingsItemWidth = this.mResources.getDimensionPixelSize(C4412R.dimen.mcv2_embedded_settings_width);
        this.mFullSettingsItemWidth = this.mResources.getDimensionPixelSize(C4412R.dimen.mcv2_full_settings_width);
        this.mSettingsItemHeight = this.mResources.getDimensionPixelSize(C4412R.dimen.mcv2_settings_height);
        this.mSettingsWindowMargin = this.mResources.getDimensionPixelSize(C4412R.dimen.mcv2_settings_offset) * -1;
        ...
        float dimension = this.mResources.getDimension(C4412R.dimen.mcv2_title_bar_height);
        float dimension2 = this.mResources.getDimension(C4412R.dimen.mcv2_custom_progress_thumb_size);
        float dimension3 = this.mResources.getDimension(C4412R.dimen.mcv2_bottom_bar_height);
        ...
        this.mOverflowShowAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                ImageButton findFullSizedControlButton = MediaControlView.this.findFullSizedControlButton(C4412R.C4415id.ffwd);
        ...
        if (this.mIsAdvertisement) {
            ...
            if (textView3 != null) {
                if (currentPosition <= 5000) {
                    ...
                    this.mAdSkipView.setText(this.mResources.getString(C4412R.string.MediaControlView_ad_skip_wait_time, new Object[]{Long.valueOf(((5000 - currentPosition) / 1000) + 1)}));
                } else if (textView3.getVisibility() == 0) {
                    this.mAdSkipView.setVisibility(8);
                    findFullSizedControlButton(C4412R.C4415id.next).setEnabled(true);
                    findFullSizedControlButton(C4412R.C4415id.next).clearColorFilter();
                }
            }
            if (this.mAdRemainingView != null) {
                ...
                this.mAdRemainingView.setText(this.mResources.getString(C4412R.string.MediaControlView_ad_remaining_time, new Object[]{stringForTime(j3)}));
            }
        }
    ...
    public void updateTimeViews(MediaItem mediaItem) {
        if (mediaItem == null) {
            ...
            this.mCurrentTime.setText(this.mResources.getString(C4412R.string.MediaControlView_time_placeholder));
            this.mEndTime.setText(this.mResources.getString(C4412R.string.MediaControlView_time_placeholder));
            return;
        }
        ensurePlayerIsNotNull();
    ...
    public void updateTitleView(MediaItem mediaItem) {
        if (mediaItem == null) {
            ...
            if (title == null) {
                title = this.mResources.getString(C4412R.string.mcv2_non_music_title_unknown_text);
            }
            this.mTitleView.setText(title.toString());
        } else {
            CharSequence title2 = this.mPlayer.getTitle();
            if (title2 == null) {
                title2 = this.mResources.getString(C4412R.string.mcv2_music_title_unknown_text);
            }
            CharSequence artistText = this.mPlayer.getArtistText();
            if (artistText == null) {
                artistText = this.mResources.getString(C4412R.string.mcv2_music_artist_unknown_text);
            }
    ...
    public void updateLayoutForAd() {
        ensurePlayerIsNotNull();
        if (this.mIsAdvertisement) {
            findFullSizedControlButton(C4412R.C4415id.rew).setVisibility(8);
            findFullSizedControlButton(C4412R.C4415id.ffwd).setVisibility(8);
            findFullSizedControlButton(C4412R.C4415id.prev).setVisibility(8);
            findFullSizedControlButton(C4412R.C4415id.next).setVisibility(0);
            findFullSizedControlButton(C4412R.C4415id.next).setEnabled(false);
            findFullSizedControlButton(C4412R.C4415id.next).setColorFilter(C4412R.color.gray);
        ...
        findFullSizedControlButton(C4412R.C4415id.rew).setVisibility(this.mPlayer.canSeekBackward() ? 0 : 8);
        findFullSizedControlButton(C4412R.C4415id.ffwd).setVisibility(this.mPlayer.canSeekForward() ? 0 : 8);
        findFullSizedControlButton(C4412R.C4415id.prev).setVisibility(this.mPlayer.canSkipToPrevious() ? 0 : 8);
        findFullSizedControlButton(C4412R.C4415id.next).setVisibility(this.mPlayer.canSkipToNext() ? 0 : 8);
        findFullSizedControlButton(C4412R.C4415id.next).setEnabled(true);
        findFullSizedControlButton(C4412R.C4415id.next).clearColorFilter();
    ...
    private View initTransportControls(int i) {
        ...
        ImageButton imageButton = (ImageButton) findViewById.findViewById(C4412R.C4415id.pause);
        if (imageButton != null) {
            imageButton.setOnClickListener(this.mPlayPauseListener);
        }
        ImageButton imageButton2 = (ImageButton) findViewById.findViewById(C4412R.C4415id.ffwd);
        if (imageButton2 != null) {
            imageButton2.setOnClickListener(this.mFfwdListener);
        }
        ImageButton imageButton3 = (ImageButton) findViewById.findViewById(C4412R.C4415id.rew);
        if (imageButton3 != null) {
            imageButton3.setOnClickListener(this.mRewListener);
        }
        ImageButton imageButton4 = (ImageButton) findViewById.findViewById(C4412R.C4415id.next);
        if (imageButton4 != null) {
            imageButton4.setOnClickListener(this.mNextListener);
        }
        ImageButton imageButton5 = (ImageButton) findViewById.findViewById(C4412R.C4415id.prev);
    ...
    private void initializeSettingsLists() {
        ...
        arrayList.add(this.mResources.getString(C4412R.string.MediaControlView_audio_track_text));
        this.mSettingsMainTextsList.add(this.mResources.getString(C4412R.string.MediaControlView_playback_speed_text));
        ArrayList arrayList2 = new ArrayList();
        this.mSettingsSubTextsList = arrayList2;
        arrayList2.add(this.mResources.getString(C4412R.string.MediaControlView_audio_track_none_text));
        String string = this.mResources.getString(C4412R.string.MediaControlView_playback_speed_normal);
        this.mSettingsSubTextsList.add(string);
        this.mSettingsSubTextsList.add("");
        ArrayList arrayList3 = new ArrayList();
        this.mSettingsIconIdsList = arrayList3;
        arrayList3.add(Integer.valueOf(C4412R.C4414drawable.ic_audiotrack));
        this.mSettingsIconIdsList.add(Integer.valueOf(C4412R.C4414drawable.ic_speed));
        ArrayList arrayList4 = new ArrayList();
        this.mAudioTrackDescriptionList = arrayList4;
        arrayList4.add(this.mResources.getString(C4412R.string.MediaControlView_audio_track_none_text));
        ArrayList arrayList5 = new ArrayList(Arrays.asList(this.mResources.getStringArray(C4412R.array.MediaControlView_playback_speeds)));
        this.mPlaybackSpeedTextList = arrayList5;
        arrayList5.add(3, string);
        this.mSelectedSpeedIndex = 3;
        this.mPlaybackSpeedMultBy100List = new ArrayList();
        int[] intArray = this.mResources.getIntArray(C4412R.array.speed_multiplied_by_100);
    ...
    public void animateOverflow(float f) {
        ...
        this.mFullTransportControls.setTranslationX((float) (((int) (((float) findFullSizedControlButton(C4412R.C4415id.pause).getLeft()) * f)) * -1));
        findFullSizedControlButton(C4412R.C4415id.ffwd).setAlpha(f2);
    }
    ...
    public void updateAllowedCommands() {
        ...
        while (true) {
            ...
            ImageButton findControlButton = findControlButton(keyAt, C4412R.C4415id.pause);
            if (findControlButton != null) {
                findControlButton.setVisibility(canPause ? 0 : 8);
            }
            ImageButton findControlButton2 = findControlButton(keyAt, C4412R.C4415id.rew);
            if (findControlButton2 != null) {
                findControlButton2.setVisibility(canSeekBackward ? 0 : 8);
            }
            ImageButton findControlButton3 = findControlButton(keyAt, C4412R.C4415id.ffwd);
            if (findControlButton3 != null) {
                findControlButton3.setVisibility(canSeekForward ? 0 : 8);
            }
            ImageButton findControlButton4 = findControlButton(keyAt, C4412R.C4415id.prev);
            if (findControlButton4 != null) {
                findControlButton4.setVisibility(canSkipToPrevious ? 0 : 8);
            }
            ImageButton findControlButton5 = findControlButton(keyAt, C4412R.C4415id.next);
    ...
    public void updatePrevNextButtons(int i, int i2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            ImageButton findControlButton = findControlButton(keyAt, C4412R.C4415id.prev);
            if (findControlButton != null) {
                if (i > -1) {
            ...
            ImageButton findControlButton2 = findControlButton(keyAt, C4412R.C4415id.next);
            if (findControlButton2 != null) {
                if (i2 > -1) {
    ...
    public void updateReplayButton(boolean z) {
        ImageButton findControlButton = findControlButton(this.mSizeType, C4412R.C4415id.ffwd);
        if (z) {
    ...
    public void updatePlayButton(int i) {
        ...
        if (findControlButton != null) {
            if (i == 0) {
                drawable = this.mResources.getDrawable(C4412R.C4414drawable.ic_pause_circle_filled);
                str = this.mResources.getString(C4412R.string.mcv2_pause_button_desc);
            } else if (i == 1) {
                drawable = this.mResources.getDrawable(C4412R.C4414drawable.ic_play_circle_filled);
                str = this.mResources.getString(C4412R.string.mcv2_play_button_desc);
            } else if (i == 2) {
                drawable = this.mResources.getDrawable(C4412R.C4414drawable.ic_replay_circle_filled);
                str = this.mResources.getString(C4412R.string.mcv2_replay_button_desc);
            } else {
    ...
    public void updateTracks(PlayerWrapper playerWrapper, List<SessionPlayer.TrackInfo> list) {
        ...
        if (this.mAudioTracks.isEmpty()) {
            this.mAudioTrackDescriptionList.add(this.mResources.getString(C4412R.string.MediaControlView_audio_track_none_text));
        } else {
            int i2 = 0;
            while (i2 < this.mAudioTracks.size()) {
                i2++;
                this.mAudioTrackDescriptionList.add(this.mResources.getString(C4412R.string.MediaControlView_audio_track_number_text, new Object[]{Integer.valueOf(i2)}));
            }
        }
        ...
        if (!this.mSubtitleTracks.isEmpty()) {
            this.mSubtitleDescriptionsList.add(this.mResources.getString(C4412R.string.MediaControlView_subtitle_off_text));
            for (int i3 = 0; i3 < this.mSubtitleTracks.size(); i3++) {
                ...
                if (iSO3Language.equals("und")) {
                    str = this.mResources.getString(C4412R.string.MediaControlView_subtitle_track_number_text, new Object[]{Integer.valueOf(i3 + 1)});
                } else {
                    str = this.mResources.getString(C4412R.string.MediaControlView_subtitle_track_number_and_lang_text, new Object[]{Integer.valueOf(i3 + 1), iSO3Language});
                }
    ...
    private class SettingsAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            View inflateLayout = MediaControlView.inflateLayout(MediaControlView.this.getContext(), C4412R.layout.settings_list_item);
            TextView textView = (TextView) inflateLayout.findViewById(C4412R.C4415id.sub_text);
            ImageView imageView = (ImageView) inflateLayout.findViewById(C4412R.C4415id.icon);
            ((TextView) inflateLayout.findViewById(C4412R.C4415id.main_text)).setText(this.mMainTexts.get(i));
    ...
    private class SubSettingsAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            View inflateLayout = MediaControlView.inflateLayout(MediaControlView.this.getContext(), C4412R.layout.sub_settings_list_item);
            ImageView imageView = (ImageView) inflateLayout.findViewById(C4412R.C4415id.check);
            ((TextView) inflateLayout.findViewById(C4412R.C4415id.text)).setText(this.mTexts.get(i));
    ...
    class PlayerCallback extends PlayerWrapper.PlayerCallback {
            ...
            if (playerWrapper == MediaControlView.this.mPlayer) {
                ...
                if (i == 1) {
                    ...
                    if (MediaControlView.this.getWindowToken() != null) {
                        new AlertDialog.Builder(MediaControlView.this.getContext()).setMessage(C4412R.string.mcv2_playback_error_text).setPositiveButton(C4412R.string.mcv2_error_dialog_button, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
        ...
        public void onPlaybackSpeedChanged(PlayerWrapper playerWrapper, float f) {
            if (playerWrapper == MediaControlView.this.mPlayer) {
                ...
                String string = MediaControlView.this.mResources.getString(C4412R.string.MediaControlView_custom_playback_speed_text, new Object[]{Float.valueOf(((float) round) / 100.0f)});
                while (true) {
                ...
                if (trackInfo.getTrackType() == 4) {
                    for (int i = 0; i < MediaControlView.this.mSubtitleTracks.size(); i++) {
                        if (MediaControlView.this.mSubtitleTracks.get(i).equals(trackInfo)) {
                            ...
                            MediaControlView.this.mSubtitleButton.setImageDrawable(MediaControlView.this.mResources.getDrawable(C4412R.C4414drawable.ic_subtitle_on));
                            MediaControlView.this.mSubtitleButton.setContentDescription(MediaControlView.this.mResources.getString(C4412R.string.mcv2_cc_is_on));
                            return;
                        }
                    }
                ...
                if (trackInfo.getTrackType() == 4) {
                    for (int i = 0; i < MediaControlView.this.mSubtitleTracks.size(); i++) {
                        if (MediaControlView.this.mSubtitleTracks.get(i).equals(trackInfo)) {
                            ...
                            MediaControlView.this.mSubtitleButton.setImageDrawable(MediaControlView.this.mResources.getDrawable(C4412R.C4414drawable.ic_subtitle_off));
                            MediaControlView.this.mSubtitleButton.setContentDescription(MediaControlView.this.mResources.getString(C4412R.string.mcv2_cc_is_off));
                            return;
                        }
                    }
                }
