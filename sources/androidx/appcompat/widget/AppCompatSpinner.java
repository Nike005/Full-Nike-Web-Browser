...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, (AttributeSet) null, C3333R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C3333R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(android.content.Context r8, android.util.AttributeSet r9, int r10, int r11, android.content.res.Resources.Theme r12) {
        /*
            ...
            r0.<init>()
            r7.mTempRect = r0
            int[] r0 = androidx.appcompat.C3333R.styleable.Spinner
            r1 = 0
            ...
            goto L_0x003e
        L_0x0023:
            int r12 = androidx.appcompat.C3333R.styleable.Spinner_popupTheme
        ...
        L_0x0074:
            ...
            r11.<init>(r12, r9, r10)
            android.content.Context r12 = r7.mPopupContext
            int[] r4 = androidx.appcompat.C3333R.styleable.Spinner
            ...
            int r1 = androidx.appcompat.C3333R.styleable.Spinner_android_dropDownWidth
            r4 = -2
            int r1 = r12.getLayoutDimension((int) r1, (int) r4)
            r7.mDropDownWidth = r1
            int r1 = androidx.appcompat.C3333R.styleable.Spinner_android_popupBackground
            android.graphics.drawable.Drawable r1 = r12.getDrawable(r1)
            r11.setBackgroundDrawable(r1)
            int r1 = androidx.appcompat.C3333R.styleable.Spinner_android_prompt
        ...
        L_0x00ac:
            int r11 = androidx.appcompat.C3333R.styleable.Spinner_android_entries
            ...
            r12.<init>(r8, r1, r11)
            int r8 = androidx.appcompat.C3333R.layout.support_simple_spinner_dropdown_item
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        public void show() {
            ...
            if (!isShowing && (viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver()) != null) {
                final C33892 r1 = new ViewTreeObserver.OnGlobalLayoutListener() {
